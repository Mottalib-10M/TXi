...
export const airports: Airport[] = [
  airport(
    ...
    "25 km du centre de Paris", "30-50 min", "56 EUR",
    ...
    "67 millions",
    [
      { name: "Paris centre (rive droite)", price: "56 EUR", time: "30-50 min" },
      { name: "Paris centre (rive gauche)", price: "65 EUR", time: "40-60 min" },
      { name: "La Défense", price: "52 EUR", time: "25-40 min" },
      { name: "Disneyland Paris", price: "65 EUR", time: "35-45 min" },
      { name: "Gare du Nord", price: "45 EUR", time: "25-35 min" },
      { name: "Aéroport d'Orly", price: "75 EUR", time: "45-60 min" },
    ],
    [
    ...
    [
      { question: "Quel est le forfait taxi Paris-CDG ?", answer: "Le forfait réglementé est de 56 EUR vers la rive droite et 65 EUR vers la rive gauche de Paris. Ce prix est fixe, sans supplément bagage ni variation horaire." },
  ...
  airport(
    ...
    "14 km du centre de Paris", "20-40 min", "38 EUR",
    ["Orly 1", "Orly 2", "Orly 3", "Orly 4"],
    ["Air France", "Transavia", "easyJet", "Vueling", "TAP Portugal", "Royal Air Maroc"],
    "33 millions",
    [
      { name: "Paris centre (rive gauche)", price: "38 EUR", time: "20-35 min" },
      { name: "Paris centre (rive droite)", price: "44 EUR", time: "25-40 min" },
      { name: "La Défense", price: "55 EUR", time: "35-50 min" },
      { name: "Versailles", price: "45 EUR", time: "25-35 min" },
      { name: "Gare de Lyon", price: "35 EUR", time: "20-30 min" },
    ],
    [
    ...
    [
      { question: "Quel est le forfait taxi Paris-Orly ?", answer: "Le forfait réglementé est de 38 EUR vers la rive gauche et 44 EUR vers la rive droite. Prix fixe garanti." },
  ...
  airport(
    ...
    "7 km du centre de Nice", "15-25 min", "32 EUR",
    ["Terminal 1", "Terminal 2"],
    ["Air France", "easyJet", "Ryanair", "British Airways", "Lufthansa", "Emirates"],
    "14 millions",
    [
      { name: "Nice centre", price: "32 EUR", time: "15-25 min" },
      { name: "Cannes", price: "85 EUR", time: "30-45 min" },
      { name: "Monaco", price: "90 EUR", time: "30-40 min" },
      { name: "Antibes", price: "55 EUR", time: "20-30 min" },
      { name: "Saint-Tropez", price: "250 EUR", time: "1h30-2h" },
    ],
    [
    ...
    [
      { question: "Combien coûte un taxi Nice Aéroport – Monaco ?", answer: "Le forfait taxi Nice Côte d'Azur – Monaco est d'environ 90 EUR. Trajet de 30-40 minutes selon la circulation." },
  ...
  airport(
    ...
    "25 km du centre de Lyon", "25-40 min", "65 EUR",
    ...
    [
      ...
      { name: "Lyon Confluence", price: "68 EUR", time: "28-38 min" },
      { name: "Grenoble", price: "120 EUR", time: "1h-1h15" },
      { name: "Annecy", price: "150 EUR", time: "1h15-1h30" },
    ],
    [
    ...
    [
      { question: "Combien coûte un taxi Lyon centre – Saint Exupéry ?", answer: "Le forfait taxi Lyon centre – Aéroport Saint Exupéry est de 65-70 EUR selon votre point de départ. Prix fixe garanti." },
      { question: "Le Rhônexpress est-il plus avantageux ?", answer: "Le Rhônexpress coûte 16,90 EUR/personne. Dès 2 passagers, le taxi TaxiNoir devient plus économique, avec l'avantage du porte-à-porte et de l'aide aux bagages." },
    ],
  ...
  airport(
    ...
    "27 km du centre de Marseille", "25-40 min", "55 EUR",
    ["Terminal 1", "Terminal 2"],
    ["Air France", "Ryanair", "easyJet", "Vueling", "Volotea", "Transavia"],
    "10 millions",
    [
      { name: "Marseille Vieux-Port", price: "55 EUR", time: "25-40 min" },
      { name: "Aix-en-Provence", price: "45 EUR", time: "20-30 min" },
      { name: "Cassis", price: "65 EUR", time: "35-45 min" },
      { name: "Toulon", price: "95 EUR", time: "50-65 min" },
      { name: "Avignon", price: "120 EUR", time: "1h-1h15" },
    ],
    [
    ...
    [
      { question: "Combien coûte un taxi Marseille-Provence – Aix ?", answer: "Le forfait taxi aéroport Provence – Aix-en-Provence est d'environ 45 EUR. Trajet de 20-30 minutes." },
    ],
  ...
  airport(
    ...
    "8 km du centre de Toulouse", "15-25 min", "28 EUR",
    ["Hall A", "Hall B", "Hall C", "Hall D"],
    ["Air France", "easyJet", "Ryanair", "Volotea", "Transavia", "Iberia"],
    "10 millions",
    [
      { name: "Toulouse centre (Capitole)", price: "28 EUR", time: "15-25 min" },
      { name: "Airbus Blagnac", price: "15 EUR", time: "5-10 min" },
      { name: "Cité de l'Espace", price: "35 EUR", time: "20-30 min" },
      { name: "Carcassonne", price: "120 EUR", time: "1h-1h15" },
      { name: "Albi", price: "95 EUR", time: "50 min-1h" },
    ],
    [
  ...
  airport(
    ...
    "12 km du centre de Bordeaux", "20-30 min", "35 EUR",
    ["Terminal A", "Terminal B", "Terminal billi"],
    ["Air France", "easyJet", "Ryanair", "Volotea", "Transavia", "KLM"],
    "7,7 millions",
    [
      { name: "Bordeaux centre (Saint-Jean)", price: "35 EUR", time: "20-30 min" },
      { name: "Bordeaux Lac / Parc des Expos", price: "25 EUR", time: "15-20 min" },
      { name: "Saint-Émilion", price: "75 EUR", time: "40-50 min" },
      { name: "Arcachon", price: "80 EUR", time: "45-55 min" },
      { name: "Médoc (Pauillac)", price: "90 EUR", time: "50 min-1h" },
    ],
    [
  ...
  airport(
    ...
    "10 km du centre de Nantes", "15-25 min", "30 EUR",
    ["Terminal unique"],
    ["Air France", "Transavia", "easyJet", "Volotea", "Ryanair", "HOP!"],
    "7,2 millions",
    [
      { name: "Nantes centre", price: "30 EUR", time: "15-25 min" },
      { name: "Île de Nantes", price: "28 EUR", time: "12-20 min" },
      { name: "La Baule", price: "85 EUR", time: "50 min-1h" },
      { name: "Saint-Nazaire", price: "70 EUR", time: "40-50 min" },
      { name: "Pornic", price: "65 EUR", time: "35-45 min" },
    ],
    [
  ...
  airport(
    ...
    "85 km du centre de Paris", "1h15-1h45", "130 EUR",
    ["Terminal 1", "Terminal 2"],
    ["Ryanair", "Wizz Air"],
    "4 millions",
    [
      { name: "Paris centre", price: "130 EUR", time: "1h15-1h45" },
      { name: "Gare du Nord", price: "120 EUR", time: "1h10-1h30" },
      { name: "La Défense", price: "115 EUR", time: "1h-1h20" },
      { name: "Beauvais centre", price: "18 EUR", time: "10-15 min" },
      { name: "Amiens", price: "90 EUR", time: "45 min-1h" },
    ],
    [
  ...
  airport(
    ...
    "25 km de Mulhouse, 8 km de Bâle", "25-35 min", "45 EUR",
    ["Terminal français", "Terminal suisse"],
    ["easyJet", "Air France", "Wizz Air", "Lufthansa", "Turkish Airlines", "Pegasus"],
    "9 millions",
    [
      { name: "Mulhouse centre", price: "45 EUR", time: "25-35 min" },
      { name: "Bâle centre", price: "40 EUR", time: "15-20 min" },
      { name: "Colmar", price: "75 EUR", time: "40-50 min" },
      { name: "Strasbourg", price: "130 EUR", time: "1h15-1h30" },
      { name: "Fribourg (Allemagne)", price: "70 EUR", time: "45-55 min" },
    ],
    [
  ...
  airport(
    ...
    "10 km du centre de Lille", "15-20 min", "25 EUR",
    ["Terminal unique"],
    ["Air France", "easyJet", "Volotea", "Ryanair", "Transavia"],
    "2,2 millions",
    [
      { name: "Lille centre (Flandres)", price: "25 EUR", time: "15-20 min" },
      { name: "Euralille", price: "22 EUR", time: "12-18 min" },
      { name: "Villeneuve-d'Ascq", price: "18 EUR", time: "10-15 min" },
      { name: "Lens", price: "45 EUR", time: "30-40 min" },
      { name: "Arras", price: "55 EUR", time: "35-45 min" },
    ],
    [
  ...
  airport(
    ...
    "12 km du centre de Strasbourg", "15-25 min", "35 EUR",
    ["Terminal unique"],
    ["Air France", "Ryanair", "Volotea", "Transavia", "Lufthansa"],
    "1,3 million",
    [
      { name: "Strasbourg centre", price: "35 EUR", time: "15-25 min" },
      { name: "Parlement européen", price: "30 EUR", time: "12-20 min" },
      { name: "Colmar", price: "70 EUR", time: "40-50 min" },
      { name: "Offenburg (Allemagne)", price: "55 EUR", time: "25-35 min" },
    ],
    [
  ...
  airport(
    ...
    "8 km du centre de Montpellier", "15-20 min", "25 EUR",
    ["Terminal unique"],
    ["Air France", "Transavia", "easyJet", "Ryanair", "Volotea"],
    "2 millions",
    [
      { name: "Montpellier centre (Comédie)", price: "25 EUR", time: "15-20 min" },
      { name: "Palavas-les-Flots", price: "30 EUR", time: "15-20 min" },
      { name: "Sète", price: "45 EUR", time: "30-35 min" },
      { name: "Nîmes", price: "65 EUR", time: "40-50 min" },
    ],
    [
    ...
    [
      { question: "L'aéroport est-il loin de la plage ?", answer: "Non, Palavas-les-Flots est à 15-20 minutes de l'aéroport en taxi (30 EUR)." },
    ],
  ...
  airport(
    ...
    "7 km du centre d'Ajaccio", "10-15 min", "25 EUR",
    ["Terminal unique"],
    ["Air France", "Air Corsica", "easyJet", "Volotea", "Transavia"],
    "1,7 million",
    [
      { name: "Ajaccio centre", price: "25 EUR", time: "10-15 min" },
      { name: "Porticcio", price: "35 EUR", time: "20-25 min" },
      { name: "Propriano", price: "95 EUR", time: "1h-1h15" },
      { name: "Porto", price: "110 EUR", time: "1h15-1h30" },
    ],
    [
  ...
  airport(
    ...
    "20 km du centre de Bastia", "20-30 min", "35 EUR",
    ["Terminal unique"],
    ["Air France", "Air Corsica", "easyJet", "Volotea"],
    "1,3 million",
    [
      { name: "Bastia centre", price: "35 EUR", time: "20-30 min" },
      { name: "Saint-Florent", price: "55 EUR", time: "35-45 min" },
      { name: "Calvi", price: "130 EUR", time: "1h30-2h" },
      { name: "Corte", price: "80 EUR", time: "50 min-1h" },
    ],
    [
    ...
    [
      { question: "Peut-on aller à Calvi depuis Bastia en taxi ?", answer: "Oui, comptez 130 EUR et 1h30-2h de route. Le trajet est magnifique via le col de Teghime ou par la côte." },
    ],
  ...
  airport(
    ...
    "10 km du centre de Brest", "12-18 min", "25 EUR",
    ["Terminal unique"],
    ["Air France", "Transavia", "Volotea", "Ryanair"],
    "1,1 million",
    [
      { name: "Brest centre", price: "25 EUR", time: "12-18 min" },
      { name: "Océanopolis", price: "20 EUR", time: "10-15 min" },
      { name: "Quimper", price: "85 EUR", time: "50 min-1h" },
      { name: "Roscoff (ferry)", price: "65 EUR", time: "40-50 min" },
    ],
    [
    ...
    [
      { question: "Peut-on prendre un taxi Brest-Roscoff pour le ferry ?", answer: "Oui, nous assurons les transferts vers le port de Roscoff (65 EUR, 40-50 min). Réservez à l'avance." },
    ],
  ...
  airport(
    ...
    "3 km du centre de Biarritz", "5-10 min", "15 EUR",
    ["Terminal unique"],
    ["Air France", "easyJet", "Ryanair", "Transavia", "Volotea"],
    "1,2 million",
    [
      { name: "Biarritz centre", price: "15 EUR", time: "5-10 min" },
      { name: "Bayonne", price: "25 EUR", time: "12-18 min" },
      { name: "Saint-Jean-de-Luz", price: "30 EUR", time: "15-25 min" },
      { name: "San Sebastián (Espagne)", price: "85 EUR", time: "40-50 min" },
      { name: "Pau", price: "120 EUR", time: "1h-1h15" },
    ],
    [
    ...
    [
      { question: "Peut-on aller en Espagne depuis Biarritz en taxi ?", answer: "Oui, nos chauffeurs assurent les transferts vers San Sebastián (85 EUR, 40-50 min) et d'autres villes du Pays Basque espagnol." },
    ],
  ...
  airport(
    ...
    "22 km du centre de Toulon", "25-35 min", "45 EUR",
    ["Terminal unique"],
    ["Air France", "Transavia", "Volotea", "easyJet"],
    "700 000",
    [
      { name: "Toulon centre", price: "45 EUR", time: "25-35 min" },
      { name: "Hyères centre", price: "18 EUR", time: "8-12 min" },
      { name: "Saint-Tropez", price: "110 EUR", time: "1h-1h15" },
      { name: "Bandol", price: "50 EUR", time: "30-40 min" },
    ],
    [
  ...
  airport(
    ...
    "7 km du centre de Rennes", "12-18 min", "22 EUR",
    ["Terminal unique"],
    ["Air France", "easyJet", "Volotea", "Ryanair"],
    "800 000",
    [
      { name: "Rennes centre", price: "22 EUR", time: "12-18 min" },
      { name: "Gare de Rennes", price: "20 EUR", time: "10-15 min" },
      { name: "Saint-Malo", price: "85 EUR", time: "50 min-1h" },
      { name: "Dinard", price: "75 EUR", time: "45-55 min" },
    ],
    [
    ...
    [
      { question: "L'aéroport de Rennes dessert-il Saint-Malo ?", answer: "Oui, un taxi TaxiNoir vous conduit de l'aéroport à Saint-Malo en 50 min-1h pour environ 85 EUR." },
    ],
  ...
  airport(
    ...
    "7 km du centre de Clermont-Ferrand", "12-18 min", "22 EUR",
    ["Terminal unique"],
    ["Air France", "Ryanair", "HOP!"],
    "400 000",
    [
      { name: "Clermont centre (Jaude)", price: "22 EUR", time: "12-18 min" },
      { name: "Gare de Clermont", price: "20 EUR", time: "10-15 min" },
      { name: "Vulcania", price: "45 EUR", time: "30-40 min" },
      { name: "Vichy", price: "65 EUR", time: "40-50 min" },
    ],
    [
  ...
  airport(
    ...
    "10 km du centre de Pau", "12-18 min", "25 EUR",
    ["Terminal unique"],
    ["Air France", "Transavia", "Ryanair", "HOP!"],
    "600 000",
    [
      { name: "Pau centre", price: "25 EUR", time: "12-18 min" },
      { name: "Lourdes", price: "55 EUR", time: "35-45 min" },
      { name: "Oloron-Sainte-Marie", price: "45 EUR", time: "30-40 min" },
      { name: "Stations de ski (Gourette)", price: "85 EUR", time: "50 min-1h" },
    ],
    [
    ...
    [
      { question: "Peut-on rejoindre Lourdes depuis l'aéroport de Pau ?", answer: "Oui, le trajet Pau Aéroport – Lourdes dure environ 35-45 minutes pour 55 EUR. Très fréquenté par les pèlerins." },
    ],
  ...
  airport(
    ...
    "7 km du centre de Perpignan", "10-15 min", "20 EUR",
    ["Terminal unique"],
    ["Air France", "Ryanair", "Transavia"],
    "500 000",
    [
      { name: "Perpignan centre", price: "20 EUR", time: "10-15 min" },
      { name: "Collioure", price: "40 EUR", time: "25-30 min" },
      { name: "Canet-en-Roussillon", price: "22 EUR", time: "12-18 min" },
      { name: "Font-Romeu", price: "95 EUR", time: "1h-1h15" },
    ],
    [
    ...
    [
      { question: "L'aéroport est-il proche des plages ?", answer: "Oui, Canet-en-Roussillon est à 12-18 minutes (22 EUR) et Saint-Cyprien à 15-20 minutes." },
    ],
  ...
  airport(
    ...
    "4 km du centre de La Rochelle", "8-12 min", "15 EUR",
    ["Terminal unique"],
    ["easyJet", "Ryanair", "Jet2"],
    "300 000",
    [
      { name: "La Rochelle centre", price: "15 EUR", time: "8-12 min" },
      { name: "Île de Ré", price: "35 EUR", time: "25-35 min" },
      { name: "Rochefort", price: "40 EUR", time: "25-30 min" },
      { name: "Royan", price: "75 EUR", time: "50 min-1h" },
    ],
    [
    ...
    [
      { question: "Peut-on aller à l'Île de Ré depuis l'aéroport ?", answer: "Oui, le trajet Aéroport – Île de Ré (via le pont) dure 25-35 minutes pour environ 35 EUR." },
    ],
  ...
  airport(
    ...
    "25 km de Porto-Vecchio", "25-30 min", "45 EUR",
    ["Terminal unique"],
    ["Air France", "Air Corsica", "easyJet", "Volotea", "Transavia"],
    "700 000",
    [
      { name: "Porto-Vecchio", price: "45 EUR", time: "25-30 min" },
      { name: "Bonifacio", price: "35 EUR", time: "20-25 min" },
      { name: "Propriano", price: "65 EUR", time: "40-50 min" },
      { name: "Sainte-Lucie de Porto-Vecchio", price: "30 EUR", time: "15-20 min" },
    ],
    [
  ...
  airport(
    ...
    "7 km du centre de Calvi", "10-15 min", "20 EUR",
    ["Terminal unique"],
    ["Air France", "Air Corsica", "easyJet"],
    "350 000",
    [
      { name: "Calvi centre", price: "20 EUR", time: "10-15 min" },
      { name: "L'Île-Rousse", price: "35 EUR", time: "20-25 min" },
      { name: "Porto", price: "75 EUR", time: "50 min-1h" },
    ],
    [
  ...
  airport(
    ...
    "10 km du centre de Limoges", "12-18 min", "22 EUR",
    ["Terminal unique"],
    ["Ryanair", "HOP!"],
    "300 000",
    [
      { name: "Limoges centre", price: "22 EUR", time: "12-18 min" },
      { name: "Gare des Bénédictins", price: "20 EUR", time: "10-15 min" },
      { name: "Oradour-sur-Glane", price: "30 EUR", time: "20-25 min" },
    ],
    [
  ...
  airport(
    ...
    "7 km du centre de Caen", "10-15 min", "20 EUR",
    ["Terminal unique"],
    ["Air France", "HOP!", "Volotea"],
    "200 000",
    [
      { name: "Caen centre", price: "20 EUR", time: "10-15 min" },
      { name: "Ouistreham (ferry)", price: "30 EUR", time: "20-25 min" },
      { name: "Plages du Débarquement", price: "55 EUR", time: "30-40 min" },
      { name: "Bayeux", price: "40 EUR", time: "25-30 min" },
    ],
    [
  ...
  airport(
    ...
    "8 km du centre de Tours", "12-18 min", "22 EUR",
    ["Terminal unique"],
    ["Ryanair", "Air France"],
    "200 000",
    [
      { name: "Tours centre", price: "22 EUR", time: "12-18 min" },
      { name: "Amboise", price: "40 EUR", time: "25-30 min" },
      { name: "Chenonceau", price: "50 EUR", time: "30-35 min" },
      { name: "Chambord", price: "75 EUR", time: "45-55 min" },
    ],
    [
  ...
  airport(
    ...
    "40 km du centre de Grenoble", "35-45 min", "65 EUR",
    ["Terminal unique"],
    ["easyJet", "Ryanair", "Transavia"],
    "400 000",
    [
      { name: "Grenoble centre", price: "65 EUR", time: "35-45 min" },
      { name: "Alpe d'Huez", price: "120 EUR", time: "1h15-1h30" },
      { name: "Les Deux Alpes", price: "130 EUR", time: "1h20-1h40" },
      { name: "Chamrousse", price: "80 EUR", time: "50 min-1h" },
    ],
    [
  ...
  airport(
    ...
    "10 km de Lourdes, 12 km de Tarbes", "12-18 min", "22 EUR",
    ["Terminal unique"],
    ["Ryanair", "HOP!", "Volotea"],
    "400 000",
    [
      { name: "Lourdes centre", price: "22 EUR", time: "12-18 min" },
      { name: "Tarbes centre", price: "25 EUR", time: "15-20 min" },
      { name: "Cauterets", price: "55 EUR", time: "35-45 min" },
      { name: "Gavarnie", price: "65 EUR", time: "50 min-1h" },
    ],
    [
  ...
  airport(
    ...
    "3 km du centre de Bergerac", "5-8 min", "12 EUR",
    ["Terminal unique"],
    ["Ryanair"],
    "280 000",
    [
      { name: "Bergerac centre", price: "12 EUR", time: "5-8 min" },
      { name: "Sarlat", price: "65 EUR", time: "45-55 min" },
      { name: "Périgueux", price: "55 EUR", time: "35-45 min" },
      { name: "Lascaux", price: "75 EUR", time: "50 min-1h" },
    ],
    [
  ...
  airport(
    ...
    "3 km du centre de Carcassonne", "5-10 min", "12 EUR",
    ["Terminal unique"],
    ["Ryanair"],
    "400 000",
    [
      { name: "Carcassonne Cité Médiévale", price: "12 EUR", time: "5-10 min" },
      { name: "Narbonne", price: "55 EUR", time: "40-50 min" },
      { name: "Toulouse", price: "95 EUR", time: "1h-1h15" },
      { name: "Canal du Midi", price: "20 EUR", time: "10-15 min" },
    ],
    [
    ...
    [
      { question: "L'aéroport est-il loin de la Cité Médiévale ?", answer: "Non, seulement 3 km ! En taxi, vous êtes à la Cité en 5-10 minutes pour 12 EUR." },
    ],
  ...
  airport(
    ...
    "5 km du centre de Dinard", "8-12 min", "15 EUR",
    ["Terminal unique"],
    ["Ryanair"],
    "150 000",
    [
      { name: "Dinard centre", price: "15 EUR", time: "8-12 min" },
      { name: "Saint-Malo", price: "20 EUR", time: "12-18 min" },
      { name: "Dinan", price: "25 EUR", time: "18-25 min" },
      { name: "Rennes", price: "85 EUR", time: "55 min-1h10" },
    ],
    [
    ...
    [
      { question: "Peut-on aller à Saint-Malo depuis Dinard ?", answer: "Oui, Saint-Malo est à seulement 12-18 minutes en taxi (20 EUR). Plus rapide que le bus ou la vedette." },
    ],
  ...
  airport(
    ...
    "4 km du centre de Poitiers", "8-12 min", "15 EUR",
    ["Terminal unique"],
    ["HOP!", "Air France"],
    "100 000",
    [
      { name: "Poitiers centre", price: "15 EUR", time: "8-12 min" },
      { name: "Futuroscope", price: "22 EUR", time: "12-18 min" },
      { name: "Châtellerault", price: "40 EUR", time: "30-35 min" },
    ],
    [
    ...
    [
      { question: "L'aéroport est-il proche du Futuroscope ?", answer: "Oui, le Futuroscope est à 12-18 minutes de l'aéroport (22 EUR en taxi)." },
    ],
  ...
  airport(
    ...
    "10 km du centre de Rodez", "12-18 min", "22 EUR",
    ["Terminal unique"],
    ["HOP!", "Ryanair"],
    "180 000",
    [
      { name: "Rodez centre", price: "22 EUR", time: "12-18 min" },
      { name: "Conques", price: "45 EUR", time: "30-40 min" },
      { name: "Millau (viaduc)", price: "75 EUR", time: "50 min-1h" },
    ],
    [
    ...
    [
      { question: "Peut-on visiter le viaduc de Millau depuis l'aéroport ?", answer: "Oui, le viaduc est à environ 50 min-1h de l'aéroport (75 EUR). Nos chauffeurs connaissent les meilleurs points de vue." },
    ],
  ...
  airport(
    ...
    "35 km de Metz, 40 km de Nancy", "30-40 min", "55 EUR",
    ["Terminal unique"],
    ["Air France", "Transavia", "easyJet"],
    "300 000",
    [
      { name: "Metz centre", price: "55 EUR", time: "30-40 min" },
      { name: "Nancy centre", price: "60 EUR", time: "35-45 min" },
      { name: "Gare Lorraine TGV", price: "15 EUR", time: "5-8 min" },
      { name: "Luxembourg", price: "110 EUR", time: "1h-1h15" },
    ],
    [
  ...
  airport(
    ...
    "10 km du centre de Chambéry", "12-18 min", "25 EUR",
    ["Terminal unique"],
    ["easyJet", "Jet2", "TUI"],
    "250 000",
    [
      { name: "Chambéry centre", price: "25 EUR", time: "12-18 min" },
      { name: "Courchevel", price: "140 EUR", time: "1h15-1h30" },
      { name: "Méribel", price: "130 EUR", time: "1h10-1h25" },
      { name: "Val Thorens", price: "150 EUR", time: "1h30-1h45" },
      { name: "Aix-les-Bains", price: "30 EUR", time: "15-20 min" },
    ],
    [
  ...
  airport(
    ...
    "5 km du centre d'Annecy", "8-12 min", "18 EUR",
    ["Terminal unique"],
    ["Air France", "easyJet (saisonnier)"],
    "100 000",
    [
      { name: "Annecy centre", price: "18 EUR", time: "8-12 min" },
      { name: "Lac d'Annecy (Talloires)", price: "25 EUR", time: "18-25 min" },
      { name: "La Clusaz", price: "55 EUR", time: "35-45 min" },
      { name: "Genève aéroport", price: "95 EUR", time: "45-55 min" },
    ],
    [
  ...
  airport(
    ...
    "8 km du centre de Lorient", "10-15 min", "18 EUR",
    ["Terminal unique"],
    ["HOP!", "Chalair"],
    "150 000",
    [
      { name: "Lorient centre", price: "18 EUR", time: "10-15 min" },
      { name: "Quiberon", price: "55 EUR", time: "40-50 min" },
      { name: "Carnac", price: "40 EUR", time: "25-35 min" },
      { name: "Vannes", price: "55 EUR", time: "35-45 min" },
    ],
    [
    ...
    [
      { question: "L'aéroport est-il près de Carnac ?", answer: "Carnac est à 25-35 minutes en taxi (40 EUR). Quiberon et l'embarquement pour Belle-Île à 40-50 minutes." },
    ],
  ...
  airport(
    ...
    "8 km du centre d'Avignon", "12-15 min", "20 EUR",
    ["Terminal unique"],
    ["Flybe (saisonnier)"],
    "80 000",
    [
      { name: "Avignon centre (Palais des Papes)", price: "20 EUR", time: "12-15 min" },
      { name: "Gare TGV Avignon", price: "15 EUR", time: "8-10 min" },
      { name: "Lubéron (Gordes)", price: "65 EUR", time: "40-50 min" },
      { name: "Orange", price: "35 EUR", time: "25-30 min" },
    ],
    [
  ...
  airport(
    ...
    "12 km du centre de Nîmes", "15-20 min", "25 EUR",
    ["Terminal unique"],
    ["Ryanair"],
    "200 000",
    [
      { name: "Nîmes centre (Arènes)", price: "25 EUR", time: "15-20 min" },
      { name: "Pont du Gard", price: "35 EUR", time: "25-30 min" },
      { name: "Uzès", price: "40 EUR", time: "30-35 min" },
      { name: "Camargue (Saintes-Maries)", price: "65 EUR", time: "45-55 min" },
    ],
    [
    ...
    [
      { question: "Peut-on visiter le Pont du Gard en taxi ?", answer: "Oui, le Pont du Gard est à 25-30 minutes de l'aéroport (35 EUR). Idéal pour une excursion à la journée." },
    ],
  ...
  airport(
    ...
    "8 km du centre de Deauville", "10-15 min", "20 EUR",
    ["Terminal unique"],
    ["Chalair", "CityJet (saisonnier)"],
    "100 000",
    [
      { name: "Deauville centre", price: "20 EUR", time: "10-15 min" },
      { name: "Trouville", price: "22 EUR", time: "12-18 min" },
      { name: "Honfleur", price: "30 EUR", time: "18-25 min" },
      { name: "Cabourg", price: "35 EUR", time: "20-30 min" },
    ],
    [
    ...
    [
      { question: "Deauville est-il loin de Honfleur ?", answer: "Honfleur est à 18-25 minutes en taxi depuis l'aéroport (30 EUR). Un des plus beaux ports de Normandie." },
    ],
    ["caen-carpiquet"],
  ...
  airport(
    ...
    "Dole", "", 47.0390, 5.4273,
    "5 km du centre de Dole", "8-12 min", "15 EUR",
    ["Terminal unique"],
    ["Ryanair", "TUI"],
    "200 000",
    [
      { name: "Dole centre", price: "15 EUR", time: "8-12 min" },
      { name: "Besançon", price: "55 EUR", time: "35-45 min" },
      { name: "Dijon", price: "55 EUR", time: "40-50 min" },
      { name: "Arc-et-Senans", price: "25 EUR", time: "15-20 min" },
    ],
    [
  ...
  airport(
    ...
    "10 km du centre d'Angoulême", "12-18 min", "22 EUR",
    ["Terminal unique"],
    ["Ryanair (saisonnier)"],
    "50 000",
    [
      { name: "Angoulême centre", price: "22 EUR", time: "12-18 min" },
      { name: "Cognac", price: "35 EUR", time: "25-30 min" },
      { name: "Jarnac", price: "30 EUR", time: "20-25 min" },
    ],
    [
    ...
    [
      { question: "Peut-on visiter les maisons de Cognac en taxi ?", answer: "Oui, Cognac est à 25-30 minutes de l'aéroport (35 EUR). Nos chauffeurs proposent aussi des mises à disposition pour visiter plusieurs maisons." },
    ],
  ...
  airport(
    ...
    "Agen", "", 44.1747, 0.5906,
    "4 km du centre d'Agen", "6-10 min", "12 EUR",
    ["Terminal unique"],
    ["HOP!"],
    "50 000",
    [
      { name: "Agen centre", price: "12 EUR", time: "6-10 min" },
      { name: "Moissac", price: "35 EUR", time: "25-30 min" },
      { name: "Villeneuve-sur-Lot", price: "35 EUR", time: "25-35 min" },
    ],
    [
  ...
  airport(
    ...
    "5 km du centre de Lannion", "8-12 min", "15 EUR",
    ["Terminal unique"],
    ["HOP!", "Chalair"],
    "80 000",
    [
      { name: "Lannion centre", price: "15 EUR", time: "8-12 min" },
      { name: "Perros-Guirec", price: "22 EUR", time: "15-20 min" },
      { name: "Trégastel", price: "25 EUR", time: "18-25 min" },
      { name: "Ploumanac'h", price: "25 EUR", time: "18-22 min" },
    ],
    [
  ...
  airport(
    ...
    "7 km du centre de Quimper", "10-15 min", "18 EUR",
    ["Terminal unique"],
    ["HOP!", "Chalair"],
    "100 000",
    [
      { name: "Quimper centre", price: "18 EUR", time: "10-15 min" },
      { name: "Bénodet", price: "22 EUR", time: "15-20 min" },
      { name: "Concarneau", price: "30 EUR", time: "20-25 min" },
      { name: "Pont-Aven", price: "28 EUR", time: "18-25 min" },
    ],
    [
    ...
    [
      { question: "L'aéroport de Quimper dessert-il Concarneau ?", answer: "Oui, Concarneau est à 20-25 minutes (30 EUR). Pont-Aven, la cité des peintres, à 18-25 minutes." },
    ],
  ...
  airport(
    ...
    "8 km du centre de Castres", "10-15 min", "18 EUR",
    ["Terminal unique"],
    ["HOP!"],
    "50 000",
    [
      { name: "Castres centre", price: "18 EUR", time: "10-15 min" },
      { name: "Mazamet", price: "22 EUR", time: "15-20 min" },
      { name: "Albi", price: "55 EUR", time: "40-50 min" },
      { name: "Toulouse", price: "95 EUR", time: "1h-1h15" },
    ],
    [
    ...
    [
      { question: "L'aéroport de Castres dessert-il Albi ?", answer: "Oui, Albi est à 40-50 minutes (55 EUR). Une bonne alternative à Toulouse pour le Tarn." },
    ],
  ...
  airport(
    ...
    "3 km du centre d'Aurillac", "5-8 min", "12 EUR",
    ["Terminal unique"],
    ["HOP!"],
    "50 000",
    [
      { name: "Aurillac centre", price: "12 EUR", time: "5-8 min" },
      { name: "Salers", price: "45 EUR", time: "35-40 min" },
      { name: "Le Lioran", price: "40 EUR", time: "30-35 min" },
    ],
    [
    ...
    [
      { question: "L'aéroport d'Aurillac est-il proche du centre ?", answer: "Oui, seulement 3 km. En taxi, vous êtes au centre-ville en 5-8 minutes pour 12 EUR." },
    ],
  ...
  airport(
    ...
    "10 km du centre du Puy", "12-18 min", "22 EUR",
    ["Terminal unique"],
    ["HOP!"],
    "30 000",
    [
      { name: "Le Puy-en-Velay centre", price: "22 EUR", time: "12-18 min" },
      { name: "Cathédrale du Puy", price: "20 EUR", time: "10-15 min" },
      { name: "Saint-Jacques départ GR65", price: "22 EUR", time: "12-18 min" },
    ],
    [
