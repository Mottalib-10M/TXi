...
export const airports: Airport[] = [
  ...
  airport(
    "Vichy-Charmeil", "vichy-charmeil", "VHY",
    "Vichy", "vichy", 46.1697, 3.4037,
    "8 km du centre de Vichy", "12-15 min", "18 €",
    ["Terminal unique"],
    ["Aviation générale", "Vols charters"],
    "10 000",
    [
      { name: "Vichy centre (Les Thermes)", price: "18 €", time: "12-15 min" },
      { name: "Gare de Vichy", price: "15 €", time: "10-12 min" },
      { name: "Clermont-Ferrand centre", price: "70 €", time: "40-50 min" },
    ],
    [
      { text: "Petit aérodrome mais taxi ponctuel. Direction les thermes en 12 minutes.", name: "Maurice P.", initials: "MP", role: "Curiste" },
      { text: "Service pratique pour rejoindre Vichy depuis un vol privé.", name: "Laurent K.", initials: "LK", role: "Homme d'affaires" },
      { text: "Transfert rapide vers le centre thermal. Chauffeur local agréable.", name: "Denise V.", initials: "DV", role: "Touriste" },
    ],
    [
      { question: "L'aérodrome de Vichy-Charmeil dessert-il des vols réguliers ?", answer: "Vichy-Charmeil accueille principalement de l'aviation générale, des vols privés et des charters. Pour les vols réguliers, l'aéroport Clermont-Ferrand Auvergne est à 55 km. Nos chauffeurs peuvent organiser un transfert direct vers Clermont-Ferrand via l'autoroute A719 en 40 minutes environ si vous avez une correspondance à prendre." },
      { question: "Comment rejoindre les thermes de Vichy depuis l'aérodrome ?", answer: "Votre chauffeur vous conduit directement de l'aérodrome de Charmeil au quartier thermal de Vichy en 12 minutes par la D6. Les thermes des Dômes, le centre Callou et les Célestins sont tous accessibles en moins de 15 minutes. Le forfait inclut le temps d'attente à l'aérodrome et la prise en charge de vos bagages." },
      { question: "Peut-on réserver un taxi pour un événement au Palais des Congrès de Vichy ?", answer: "Absolument. Le Palais des Congrès de Vichy accueille de nombreux congrès, salons et événements culturels tout au long de l'année. Nos chauffeurs assurent le transfert depuis l'aérodrome de Charmeil en 10 minutes. Vous pouvez aussi réserver un aller-retour avec attente sur place pour les événements de courte durée." },
      { question: "Quels sites patrimoniaux peut-on visiter à Vichy avec un taxi ?", answer: "Vichy regorge de patrimoine Napoléon III : les chalets impériaux, l'opéra Art Nouveau, le parc des Sources, les halles couvertes et l'église Saint-Blaise. Nos chauffeurs locaux connaissent parfaitement la ville et peuvent vous déposer devant chaque site. Un circuit patrimoine en taxi avec mise à disposition est également disponible sur demande." },
      { question: "Quel est le tarif taxi Vichy-Charmeil vers Clermont-Ferrand ?", answer: "Le transfert Vichy-Charmeil vers Clermont-Ferrand centre coûte environ 70 euros au forfait. Le trajet emprunte l'autoroute A719 et dure 40 à 50 minutes selon la circulation. Ce forfait est garanti sans supplément, quels que soient les embouteillages ou les détours éventuels. Idéal pour rejoindre une correspondance aérienne à Clermont." },
      { question: "Le service taxi est-il disponible pour les vols privés arrivant tôt le matin ?", answer: "Oui, notre service fonctionne 24h/24 et 7j/7. Pour les vols privés arrivant avant 6h du matin ou après 22h, il suffit de réserver à l'avance en indiquant l'heure estimée d'atterrissage. Le chauffeur suit votre progression et ajuste son arrivée à l'aérodrome. Aucun supplément de nuit n'est appliqué sur nos forfaits aérodrome." },
    ],
    ["clermont-ferrand-auvergne"],
    ["Proche du centre thermal de Vichy (8 km)", "Accès rapide aux thermes des Dômes en 12 min par la D6", "Porte d'entrée de la station thermale classée UNESCO", "Transfert Clermont-Ferrand en 40 min via A719", "Service 24h/24 adapté aux vols privés et charters", "Prise en charge bagages et accueil personnalisé à l'aérogare"],
  ),

  airport(
    "Montluçon-Guéret", "montlucon-gueret", "MCU",
    "Montluçon", "montlucon", 46.2226, 2.3640,
    "5 km du centre de Montluçon", "10-12 min", "15 €",
    ["Terminal unique"],
    ["Aviation générale", "Vols charters"],
    "5 000",
    [
      { name: "Montluçon centre", price: "15 €", time: "10-12 min" },
      { name: "Gare de Montluçon", price: "12 €", time: "8-10 min" },
      { name: "Clermont-Ferrand centre", price: "90 €", time: "1h-1h15" },
    ],
    [
      { text: "Service utile pour rejoindre le centre de Montluçon depuis l'aérodrome.", name: "René B.", initials: "RB", role: "Voyageur" },
      { text: "Taxi ponctuel pour un vol privé. Très professionnel.", name: "Éric G.", initials: "EG", role: "Chef d'entreprise" },
      { text: "Transfert rapide et sans souci. Le chauffeur connaît bien la région.", name: "Claudine M.", initials: "ClM", role: "Touriste" },
    ],
    [
      { question: "L'aérodrome de Montluçon-Guéret dessert-il des vols commerciaux ?", answer: "Montluçon-Guéret accueille principalement de l'aviation générale, des vols privés et un aéroclub actif. Pour les vols réguliers, l'aéroport Clermont-Ferrand Auvergne se trouve à environ 100 km. Nos chauffeurs peuvent organiser un transfert direct vers Clermont via l'A71 en une heure environ pour vos correspondances." },
      { question: "Comment rejoindre le centre médiéval de Montluçon depuis l'aérodrome ?", answer: "Votre chauffeur vous conduit directement de l'aérodrome de Domérat au quartier médiéval de Montluçon en 10 minutes par la D916. Le château des Ducs de Bourbon, la vieille ville et les ruelles historiques sont accessibles immédiatement. Le forfait inclut le temps d'attente à l'aérodrome et l'aide aux bagages." },
      { question: "Peut-on réserver un taxi pour visiter le MuPop à Montluçon ?", answer: "Bien sûr. Le MuPop (Musée des Musiques Populaires), installé dans deux hôtels particuliers du quartier médiéval, est l'un des musées les plus originaux de France. Nos chauffeurs vous déposent directement devant l'entrée en 10 minutes depuis l'aérodrome. Vous pouvez aussi réserver un aller-retour avec attente sur place pour optimiser votre visite." },
      { question: "Quels sites touristiques peut-on rejoindre en taxi depuis Montluçon-Guéret ?", answer: "Depuis l'aérodrome, nos chauffeurs vous conduisent vers le château des Ducs de Bourbon, le canal de Berry et ses écluses restaurées, les jardins Wilson, la cité médiévale haute et le quartier Saint-Pierre. Pour les amateurs de nature, la forêt de Tronçais, plus grande chênaie d'Europe, est accessible en 40 minutes environ." },
      { question: "Quel est le tarif taxi Montluçon-Guéret vers Clermont-Ferrand ?", answer: "Le transfert Montluçon-Guéret vers Clermont-Ferrand centre coûte environ 90 euros au forfait. Le trajet emprunte l'autoroute A71 et dure 1h à 1h15 selon les conditions de circulation. Ce prix est garanti sans supplément. Idéal pour rejoindre l'aéroport Clermont-Ferrand Auvergne pour un vol régulier ou une correspondance nationale." },
      { question: "Le service taxi fonctionne-t-il le week-end et les jours fériés ?", answer: "Oui, nos chauffeurs sont disponibles 7j/7, y compris les week-ends et jours fériés. Pour les vols privés arrivant en dehors des heures ouvrables, il suffit de réserver à l'avance en précisant l'heure estimée d'atterrissage. Aucun supplément n'est appliqué les dimanches et jours fériés sur nos forfaits aérodrome vers Montluçon centre." },
    ],
    ["clermont-ferrand-auvergne"],
    ["Proche du centre de Montluçon (5 km)", "Accès direct au Bourbonnais et à la Creuse via D916", "Porte d'entrée du Massif central ouest", "Transfert Clermont-Ferrand en 1h via A71", "Service disponible 7j/7 pour vols privés et aviation d'affaires", "Prise en charge bagages et accueil à la sortie de l'aérogare"],
  ),
];
...
const AIRPORT_CONTENT: Record<string, { fr: { intro: string; description: string; metaDescription: string; heroSubtitle: string; whyUs: { title: string; desc: string }[] }; en: { intro: string; description: string; metaDescription: string; heroSubtitle: string; whyUs: { title: string; desc: string }[] } }> = {
  ...
  "nice-cote-d-azur": {
    ...
    en: {
      ...
      metaDescription: "Nice Côte d'Azur taxi: 14M passengers/year, fixed-fare transfers to Cannes, Monaco, Antibes. Terminal 1 & 2 pickup, reserved Promenade lanes. Book 24/7.",
  ...
  "lyon-saint-exupery": {
    fr: {
      ...
      metaDescription: "Taxi Lyon-Saint Exupéry : hub multimodal avec gare TGV intégrée, forfait garanti, moins cher que le Rhônexpress à 2+. Transferts ski Alpes en hiver 24h/24.",
  ...
  "toulouse-blagnac": {
    fr: {
      ...
      metaDescription: "Taxi Toulouse-Blagnac : forfait dès 28 € vers le Capitole, 4 halls desservis, rocade Arc-en-Ciel. Capitale de l'aéronautique, transfert express 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Toulouse-Blagnac taxi: fixed fare from 28 EUR to Capitole, all 4 halls served, Arc-en-Ciel ring road. Europe's aerospace capital, book your transfer 24/7.",
  ...
  "bordeaux-merignac": {
    ...
    en: {
      ...
      metaDescription: "Bordeaux-Mérignac taxi: 7.7M passengers, 3 terminals, fixed-fare transfer to Saint-Émilion, Arcachon and the Médoc. Arrivals meet-and-greet, book 24/7.",
  ...
  "strasbourg-entzheim": {
    ...
    en: {
      ...
      metaDescription: "Strasbourg-Entzheim taxi: European capital, faster than the shuttle train at 15 min. Parliament and Petite France transfer, Wine Route and Colmar. Book 24/7.",
  ...
  "lille-lesquin": {
    fr: {
      ...
      metaDescription: "Taxi Lille-Lesquin : forfait dès 25 € vers le centre, correspondances Eurostar et TGV Bruxelles. 2,2 M passagers, accueil en arrivée, réservation 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Lille-Lesquin taxi: 25 EUR fixed fare to city centre, Eurostar and Brussels TGV connections. 2.2M passengers, meet-and-greet in arrivals, book online 24/7.",
  ...
  "paris-beauvais": {
    fr: {
      ...
      metaDescription: "Taxi Paris-Beauvais : alternative confortable à la navette bus, forfait fixe, 4 M passagers Ryanair/Wizz Air. Transfert porte-à-porte vers Paris 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Paris-Beauvais taxi: the comfortable alternative to the shuttle bus, fixed fare for 4M Ryanair and Wizz Air passengers. Door-to-door Paris transfer, book 24/7.",
  ...
  "montpellier-mediterranee": {
    ...
    en: {
      ...
      metaDescription: "Montpellier-Méditerranée taxi: 2M passengers, just 8 km from the centre, Comédie in 15 min. Palavas and Sète beaches nearby, fixed fare. Book online 24/7.",
  ...
  "ajaccio-napoleon-bonaparte": {
    ...
    en: {
      ...
      metaDescription: "Ajaccio Napoleon Bonaparte taxi: 1.7M passengers, fixed-fare transfers to Porticcio and Calanques de Piana. Corsican driver greeting you in arrivals 24/7.",
  ...
  "bastia-poretta": {
    ...
    en: {
      ...
      metaDescription: "Bastia-Poretta taxi: gateway to Cap Corse, 1.3M passengers, Old Port transfer in just 20 min. Drivers who master Corsican mountain passes, fixed fare 24/7.",
  ...
  "brest-bretagne": {
    ...
    en: {
      ...
      metaDescription: "Brest-Bretagne taxi: Finistère gateway, 1.1M passengers, Roscoff ferry and Océanopolis transfers. Fast RN12 dual carriageway route, fixed fare. Book 24/7.",
  ...
  "biarritz-pays-basque": {
    ...
    en: {
      ...
      metaDescription: "Biarritz-Pays Basque taxi: just 3 km from the Grande Plage, express 5-min transfer. Saint-Jean-de-Luz, San Sebastián and Basque coast. Fixed fare 24/7.",
  ...
  "toulon-hyeres": {
    fr: {
      ...
      metaDescription: "Taxi Toulon-Hyères : accès direct Saint-Tropez et Îles d'Or (Porquerolles), 700 000 passagers. Chauffeur varois, routes côtières, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Toulon-Hyères taxi: your gateway to Saint-Tropez and the Golden Islands (Porquerolles), 700K passengers. Local driver on coastal routes, fixed fare 24/7.",
  ...
  "rennes-bretagne": {
    fr: {
      ...
      metaDescription: "Taxi Rennes-Bretagne : capitale bretonne, 800 000 passagers, correspondances TGV Paris en 1h25. Transfert Saint-Malo et côte d'Émeraude, forfait 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Rennes-Bretagne taxi: capital of Brittany, 800K passengers, TGV to Paris in 1h25. Transfers to Saint-Malo and the Emerald Coast at a fixed fare, book 24/7.",
  ...
  "clermont-ferrand-auvergne": {
    fr: {
      ...
      metaDescription: "Taxi Clermont-Ferrand Auvergne : Chaîne des Puys UNESCO, Vulcania, siège Michelin. Forfait garanti place de Jaude en 12 min, accueil en arrivée 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Clermont-Ferrand Auvergne taxi: UNESCO Chaîne des Puys, Vulcania park, Michelin HQ. Fixed-fare transfer to Place de Jaude in 12 min, arrivals pickup 24/7.",
  ...
  "pau-pyrenees": {
    fr: {
      ...
      metaDescription: "Taxi Pau-Pyrénées : porte des Pyrénées, transfert vers Lourdes 35 min, stations Gourette. Chauffeur béarnais, véhicules montagne, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Pau-Pyrénées taxi: gateway to the Pyrenees, Lourdes transfer in 35 min, Gourette ski resorts. Béarnais driver, mountain vehicles, fixed fare. Book 24/7.",
  ...
  "perpignan-rivesaltes": {
    fr: {
      ...
      metaDescription: "Taxi Perpignan-Rivesaltes : « centre du monde » selon Dalí, Collioure et Font-Romeu ski. 500 000 passagers, chauffeur catalan, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Perpignan-Rivesaltes taxi: the 'centre of the world' per Dalí, Collioure and Font-Romeu ski. 500K passengers, Catalan driver on hand, fixed fare 24/7.",
  ...
  "la-rochelle-ile-de-re": {
    fr: {
      ...
      metaDescription: "Taxi La Rochelle-Île de Ré : à 4 km du Vieux Port, pont de l'Île de Ré inclus dans le forfait. Vols UK easyJet/Ryanair, prise en charge immédiate 24h/24.",
    ...
    en: {
      ...
      metaDescription: "La Rochelle-Île de Ré taxi: just 4 km from the Old Port, Île de Ré bridge toll is included in fare. UK easyJet and Ryanair flights, instant pickup 24/7.",
  ...
  "figari-sud-corse": {
    ...
    en: {
      ...
      metaDescription: "Figari-Sud Corse taxi: Palombaggia, Bonifacio, Porto-Vecchio beaches. 700K summer passengers, local Corsican driver, fixed fare. Book 72h ahead in summer.",
  ...
  "calvi-sainte-catherine": {
    fr: {
      ...
      metaDescription: "Taxi Calvi-Sainte Catherine : piste face à la mer, citadelle génoise et plages de Balagne. 350 000 passagers, chauffeur balanin, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Calvi-Sainte Catherine taxi: runway facing the sea, Genoese citadel and Balagne beaches. 350K passengers, local Balagne driver, book at a fixed fare 24/7.",
  ...
  "limoges-bellegarde": {
    fr: {
      ...
      metaDescription: "Taxi Limoges-Bellegarde : vols Ryanair vers Londres, Gare des Bénédictins en 10 min. 300 000 passagers, porte du Périgord Vert, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Limoges-Bellegarde taxi: Ryanair London flights, historic Gare des Bénédictins in 10 min. 300K passengers, Périgord Vert gateway, fixed fare. Book 24/7.",
  ...
  "caen-carpiquet": {
    fr: {
      ...
      metaDescription: "Taxi Caen-Carpiquet : porte de la Normandie, plages du Débarquement en 30 min, ferry Ouistreham en 20 min. Ancien terrain WWII, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Caen-Carpiquet taxi: Normandy gateway, D-Day beaches in 30 min, Ouistreham ferry port in 20 min. Built on a former WWII airfield, book at a fixed fare 24/7.",
  ...
  "tours-val-de-loire": {
    fr: {
      ...
      metaDescription: "Taxi Tours-Val de Loire : Châteaux d'Amboise, Chenonceau, Chambord. Vols Ryanair Londres/Porto, gare TGV en 15 min. Forfait garanti, circuits châteaux.",
    ...
    en: {
      ...
      metaDescription: "Tours-Val de Loire taxi: Loire Châteaux Amboise, Chenonceau, Chambord. Ryanair London and Porto flights, TGV station in 15 min. Fixed fare, book online 24/7.",
  ...
  "grenoble-isere": {
    fr: {
      ...
      metaDescription: "Taxi Grenoble-Isère : spécialiste des transferts ski, Alpe d'Huez et Les Deux Alpes. Véhicules équipés neige, chauffeurs alpins, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Grenoble-Isère taxi: the ski transfer specialist for Alpe d'Huez and Les Deux Alpes. Snow-equipped vehicles with Alpine drivers, guaranteed fixed fare 24/7.",
  ...
  "tarbes-lourdes-pyrenees": {
    fr: {
      ...
      metaDescription: "Taxi Tarbes-Lourdes-Pyrénées : sanctuaire de Lourdes en 12 min, stations Cauterets et Gavarnie. Seul aéroport de pèlerinage de France, forfait 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Tarbes-Lourdes-Pyrénées taxi: Lourdes sanctuary in 12 min, Cauterets and Gavarnie mountain resorts. France's only pilgrimage airport, fixed fare 24/7.",
  ...
  "bergerac-dordogne-perigord": {
    ...
    en: {
      ...
      metaDescription: "Bergerac Dordogne Périgord taxi: Sarlat, Lascaux caves, Monbazillac vineyards. Just 3 km from centre, UK Ryanair flights. Fixed fare, instant pickup 24/7.",
  ...
  "carcassonne-salvaza": {
    fr: {
      ...
      metaDescription: "Taxi Carcassonne-Salvaza : Cité Médiévale UNESCO à 3 km, transfert 5 min à 12 €. Pays Cathare, Canal du Midi. Forfait garanti, réservation en ligne 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Carcassonne-Salvaza taxi: UNESCO Medieval Citadel just 3 km away, express 5-min transfer at 12 EUR. Cathar Country and Canal du Midi, fixed fare 24/7.",
  ...
  "dinard-bretagne": {
    fr: {
      ...
      metaDescription: "Taxi Dinard-Bretagne : Saint-Malo intra-muros en 12 min, Côte d'Émeraude, Dinan médiéval. Vols Ryanair UK, forfait garanti, seul transport fiable 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Dinard-Bretagne taxi: Saint-Malo intra-muros in just 12 min, Emerald Coast, medieval Dinan. UK Ryanair flights, fixed fare and only reliable transport.",
  ...
  "poitiers-biard": {
    fr: {
      ...
      metaDescription: "Taxi Poitiers-Biard : aéroport le plus proche du Futuroscope en seulement 12 min, gare TGV Paris en 8 min. Terminal ultra-compact, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Poitiers-Biard taxi: nearest airport to Futuroscope theme park in just 12 min, TGV station in 8 min. Ultra-compact terminal, book at a fixed fare 24/7.",
  ...
  "rodez-aveyron": {
    fr: {
      ...
      metaDescription: "Taxi Rodez-Aveyron : musée Soulages, Conques sur le chemin de Compostelle, viaduc de Millau. 180 000 passagers, chauffeur local, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Rodez-Aveyron taxi: Soulages Museum, Conques on the Compostela trail, Millau Viaduct. 180K passengers, local driver for winding roads, fixed fare 24/7.",
  ...
  "metz-nancy-lorraine": {
    fr: {
      ...
      metaDescription: "Taxi Metz-Nancy-Lorraine : Metz, Nancy et Luxembourg desservis, gare TGV adjacente en 5 min. 300 000 passagers, véhicule confortable, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Metz-Nancy-Lorraine taxi: serving Metz, Nancy and Luxembourg, with an adjacent TGV station just 5 min away. 300K passengers, guaranteed fixed fare 24/7.",
  ...
  "chambery-savoie-mont-blanc": {
    fr: {
      ...
      metaDescription: "Taxi Chambéry-Savoie : stations des 3 Vallées (Courchevel, Méribel, Val Thorens). 4x4 équipés neige, chauffeurs savoyards expérimentés, forfait garanti 24h/24.",
  ...
  "annecy-haute-savoie": {
    ...
    en: {
      ...
      metaDescription: "Annecy-Haute-Savoie taxi: stunning Lake Annecy in 8 min, La Clusaz skiing, Geneva alternative. Mountain vehicles, instant pickup, fixed fare. Book 24/7.",
  ...
  "lorient-bretagne-sud": {
    fr: {
      ...
      metaDescription: "Taxi Lorient-Bretagne Sud : Belle-Île-en-Mer, Carnac mégalithes, Festival Interceltique. 150 000 passagers, seul transport fiable, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Lorient-Bretagne Sud taxi: Belle-Île ferry, Carnac megaliths, Interceltique Festival. 150K passengers per year, only reliable transport, fixed fare 24/7.",
  ...
  "avignon-provence": {
    fr: {
      ...
      metaDescription: "Taxi Avignon-Provence : Palais des Papes en 12 min, gare TGV en 8 min, Lubéron et Gordes. Festival d'Avignon et saison lavande. Forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Avignon-Provence taxi: Palais des Papes in 12 min, TGV station in 8 min, Lubéron and Gordes villages. Festival d'Avignon, lavender season, fixed fare 24/7.",
  ...
  "nimes-garons": {
    fr: {
      ...
      metaDescription: "Taxi Nîmes-Garons : Arènes romaines, Pont du Gard, Camargue sauvage. Ancienne base aéronavale, 200 000 passagers, accueil en arrivée, forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Nîmes-Garons taxi: Roman Arena, Pont du Gard aqueduct, wild Camargue. Former naval air base serving 200K passengers. Book your fixed-fare transfer 24/7.",
  ...
  "deauville-normandie": {
    ...
    en: {
      ...
      metaDescription: "Deauville-Normandie taxi: famous boardwalk in 10 min, Honfleur, Côte Fleurie. Film Festival and horse racing. The only comfortable option, fixed fare 24/7.",
  ...
  "dole-jura": {
    fr: {
      ...
      metaDescription: "Taxi Dole-Jura : entre Besançon et Dijon, Salines d'Arc-et-Senans UNESCO, ville de Pasteur. Vols Ryanair/TUI, ski nordique Jura. Forfait garanti 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Dole-Jura taxi: halfway between Besançon and Dijon, UNESCO Saltworks, Pasteur's birthplace. Ryanair and TUI flights, Jura Nordic skiing, fixed fare 24/7.",
  ...
  "agen-la-garenne": {
    fr: {
      ...
      metaDescription: "Taxi Agen-La Garenne : centre-ville en 6 min, l'un des transferts les plus rapides de France. Vols HOP! Paris-CDG, Moissac, rugby SUA. Forfait 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Agen-La Garenne taxi: city centre in just 6 min, one of the fastest airport transfers in France. HOP! Paris-CDG flights, Moissac and SUA rugby, fare 24/7.",
  ...
  "lannion-cote-de-granit-rose": {
    fr: {
      ...
      metaDescription: "Taxi Lannion-Côte de Granit Rose : rochers roses de Ploumanac'h, pôle télécom. Perros-Guirec en 15 min, vols Paris. Forfait garanti, aucun bus 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Lannion-Côte de Granit Rose taxi: stunning pink Ploumanac'h rocks, telecom hub. Perros-Guirec in 15 min, Paris flights. Fixed fare, no bus service 24/7.",
  ...
  "quimper-cornouaille": {
    ...
    en: {
      ...
      metaDescription: "Quimper-Cornouaille taxi: Concarneau, Pont-Aven (Gauguin), Bénodet beaches. Daily Paris-Orly flights, southern Finistère. Instant pickup, fixed fare 24/7.",
  ...
  "castres-mazamet": {
    fr: {
      ...
      metaDescription: "Taxi Castres-Mazamet : siège Pierre Fabre, Albi UNESCO en 40 min, Montagne Noire. Vols HOP! Paris-Orly, granits du Sidobre. Forfait garanti, compact 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Castres-Mazamet taxi: Pierre Fabre HQ, UNESCO Albi in 40 min, Montagne Noire nature. HOP! Paris-Orly flights, Sidobre granite. Fixed fare, compact 24/7.",
  ...
  "aurillac-tronquieres": {
    ...
    en: {
      ...
      metaDescription: "Aurillac-Tronquières taxi: centre in 5 min, Salers village, Puy Mary volcano, Le Lioran skiing. HOP! Paris-Orly flights, mountain vehicles, fixed fare 24/7.",
  ...
  "le-puy-loudes": {
    fr: {
      ...
      metaDescription: "Taxi Le Puy-Loudes : cathédrale et GR65 Compostelle en 12 min, plus petit terminal de France. Pèlerins de la Via Podiensis, HOP! Paris. Forfait 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Le Puy-Loudes taxi: cathedral and GR65 Camino trail in 12 min, France's smallest terminal. Via Podiensis pilgrims, HOP! Paris flights. Fixed fare 24/7.",
  ...
  "vichy-charmeil": {
    fr: {
      intro: "L'aérodrome de Vichy-Charmeil (VHY) occupe une place singulière dans le paysage aéronautique français. Situé à 8 km au nord-est de Vichy, sur la commune de Charmeil, au bord de la plaine de la Limagne bourbonnaise, cet aérodrome d'aviation générale a été créé dans les années 1930 et a connu une histoire mouvementée liée à celle de Vichy elle-même. Pendant la Seconde Guerre mondiale, la proximité du gouvernement de Vichy en fit un site stratégique, avant de retrouver sa vocation civile dans l'après-guerre. Aujourd'hui, Vichy-Charmeil accueille principalement des vols privés, des charters d'affaires, des écoles de pilotage et l'aéroclub local, avec une piste bitumée de 1 600 mètres capable de recevoir des biréacteurs légers. L'aérodrome est la porte d'entrée aérienne naturelle de Vichy, ville thermale inscrite au patrimoine mondial de l'UNESCO depuis 2021 au titre des « Grandes villes d'eaux d'Europe ». Cette distinction internationale a renforcé l'attractivité touristique de la cité, attirant des curistes, des amateurs de patrimoine et des congressistes du monde entier. En arrivant par avion privé à Charmeil, vous évitez les contraintes des grands aéroports et posez le pied à quelques minutes du parc des Sources, des thermes des Dômes et du quartier Napoléon III. Le taxi est le moyen le plus direct et le plus confortable pour rallier le centre thermal depuis l'aérodrome : pas de navette, pas de transport en commun desservant la zone — seul un véhicule privé vous offre un transfert porte-à-porte immédiat. Nos chauffeurs locaux connaissent chaque rue de Vichy et vous accompagnent jusqu'à votre hôtel, votre établissement thermal ou le Palais des Congrès sans détour.",
      description: "À l'aérodrome de Vichy-Charmeil, votre taxi vous attend directement à la sortie de la petite aérogare, moteur éteint, prêt à charger vos bagages. Nos chauffeurs empruntent la départementale D6 puis la D2209 pour rejoindre le cœur de Vichy en 12 à 15 minutes : quartier thermal, thermes des Dômes, thermes Callou ou encore le centre des Célestins. Pour les congressistes, le Palais des Congrès — Opéra de Vichy se trouve à 10 minutes de route, et nos chauffeurs maîtrisent parfaitement les accès à ce bâtiment Art Nouveau classé Monument Historique. Le service fonctionne sur réservation 24h/24 et 7j/7, y compris pour les vols arrivant en soirée ou très tôt le matin — aucun supplément de nuit n'est appliqué sur nos forfaits aérodrome. Pour les passagers ayant besoin de rejoindre Clermont-Ferrand, nos chauffeurs empruntent l'autoroute A719 et vous déposent en centre-ville ou directement à l'aéroport Clermont-Ferrand Auvergne en 40 à 50 minutes. Ce transfert est particulièrement prisé par les voyageurs d'affaires qui combinent un vol privé à Charmeil avec une correspondance commerciale à Clermont. Nos véhicules sont équipés de climatisation, de chargeurs USB et disposent d'un espace bagages généreux. Pour les familles ou les groupes de curistes, des monospaces sont disponibles sur demande. Chaque course est au forfait : le prix annoncé à la réservation est le prix final, sans compteur, sans mauvaise surprise liée à un détour ou un embouteillage imprévu sur la RN209.",
      metaDescription: "Taxi aérodrome Vichy-Charmeil : transfert vers la ville thermale UNESCO en 12 min. Forfait garanti, suivi de vol, accueil personnalisé. Réservez 24h/24.",
      heroSubtitle: "L'aérodrome de Vichy-Charmeil est la porte aérienne de la ville thermale UNESCO de Vichy, à seulement 8 km du quartier thermal. Votre chauffeur vous attend à la sortie de l'aérogare et vous conduit aux thermes des Dômes, au Palais des Congrès ou à votre hôtel en 12 minutes par la D6. Transfert également disponible vers Clermont-Ferrand via l'A719 en 40 minutes — forfait garanti, service 24h/24.",
      whyUs: [
        { title: "Thermes UNESCO en 12 min", desc: "Nos chauffeurs empruntent la D6 puis la D2209 pour rejoindre le quartier thermal de Vichy en 12 minutes chrono. Les thermes des Dômes, les Célestins, le centre Callou et le parc des Sources sont tous accessibles sans détour. Vous passez de la piste d'atterrissage au cœur de la ville thermale UNESCO avec un confort maximal, bagages pris en charge dès la sortie de l'aérogare." },
        { title: "Palais des Congrès et opéra", desc: "Le Palais des Congrès — Opéra de Vichy, joyau Art Nouveau classé Monument Historique, accueille congrès internationaux, festivals et saisons lyriques. Nos chauffeurs assurent un transfert direct depuis Charmeil en 10 minutes et connaissent les accès réservés pour les dépose-minute et les entrées VIP. Réservez un aller-retour avec attente pour vos événements de courte durée." },
        { title: "Connexion Clermont A719", desc: "L'autoroute A719 relie Vichy à Clermont-Ferrand en 40 minutes. Nos chauffeurs vous transfèrent de l'aérodrome de Charmeil au centre de Clermont-Ferrand ou directement à l'aéroport Clermont-Ferrand Auvergne pour vos correspondances sur vols réguliers. Ce trajet est idéal pour les voyageurs d'affaires qui combinent vol privé et vol commercial, sans rupture de charge." },
      ],
    },
    en: {
      intro: "Vichy-Charmeil Aerodrome (VHY) holds a distinctive place in French aviation. Located 8 km north-east of Vichy in the commune of Charmeil, on the edge of the Limagne Bourbonnaise plain, this general aviation airfield was established in the 1930s and has a storied past closely tied to the city of Vichy itself. During the Second World War, the proximity to the Vichy government made it a strategic site, before it reverted to civilian use in the post-war era. Today, Vichy-Charmeil primarily welcomes private flights, business charters, flying schools and the local aero club, with a 1,600-metre paved runway capable of handling light twin-engine jets. The aerodrome is the natural aerial gateway to Vichy, a spa town inscribed on the UNESCO World Heritage List in 2021 as one of the 'Great Spa Towns of Europe'. This international recognition has boosted the city's appeal, drawing spa guests, heritage enthusiasts and conference delegates from across the globe. By arriving by private aircraft at Charmeil, you bypass the constraints of major airports and set foot just minutes from the Parc des Sources, the Thermes des Domes and the Napoleon III quarter. A taxi is the most direct and comfortable way to reach the thermal centre from the aerodrome: there is no shuttle and no public transport serving the site — only a private vehicle provides an immediate door-to-door transfer. Our local drivers know every street in Vichy and will take you to your hotel, spa facility or the Palais des Congres without detour.",
      description: "At Vichy-Charmeil Aerodrome, your taxi waits right outside the compact terminal building, engine off, ready to load your luggage. Our drivers take the D6 departmental road then the D2209 to reach the heart of Vichy in 12 to 15 minutes: the thermal quarter, Thermes des Domes, Thermes Callou or the Celestins centre. For conference attendees, the Palais des Congres — Vichy Opera House is a 10-minute drive, and our drivers know every access point to this Art Nouveau building listed as a Historic Monument. The service runs on reservation 24/7, including for flights arriving in the evening or very early in the morning — no night surcharge is applied on our aerodrome fares. For passengers needing to reach Clermont-Ferrand, our drivers take the A719 motorway and drop you in the city centre or directly at Clermont-Ferrand Auvergne Airport in 40 to 50 minutes. This transfer is especially popular with business travellers combining a private flight at Charmeil with a commercial connection at Clermont. Our vehicles are air-conditioned, fitted with USB chargers and offer generous luggage space. For families or groups of spa guests, people carriers are available on request. Every ride is at a fixed fare: the price quoted at booking is the final price, with no meter, no hidden costs from a detour or unexpected traffic on the RN209.",
      metaDescription: "Vichy-Charmeil airport taxi: UNESCO spa town transfer in 12 min. Napoleon III heritage, Thermes des Dômes. Fixed fare, meet and greet. Book online 24/7.",
      heroSubtitle: "Vichy-Charmeil Aerodrome is the aerial gateway to the UNESCO spa town of Vichy, just 8 km from the thermal quarter. Your driver waits at the terminal exit and takes you to the Thermes des Domes, the Palais des Congres or your hotel in 12 minutes via the D6. Transfers also available to Clermont-Ferrand via the A719 in 40 minutes — guaranteed fixed fare, 24/7 service.",
      whyUs: [
        { title: "UNESCO spa in 12 min", desc: "Our drivers take the D6 then the D2209 to reach Vichy's thermal quarter in 12 minutes flat. The Thermes des Domes, the Celestins, the Callou centre and the Parc des Sources are all reachable without detour. You go from the runway to the heart of the UNESCO spa town in maximum comfort, with luggage handled from the moment you exit the terminal." },
        { title: "Congress Palace & opera house", desc: "The Palais des Congres — Vichy Opera House, an Art Nouveau gem listed as a Historic Monument, hosts international conferences, festivals and opera seasons. Our drivers provide a direct transfer from Charmeil in 10 minutes and know the reserved drop-off areas and VIP entrances. Book a round trip with waiting time for short events." },
        { title: "Clermont A719 connection", desc: "The A719 motorway links Vichy to Clermont-Ferrand in 40 minutes. Our drivers transfer you from Charmeil Aerodrome to central Clermont-Ferrand or directly to Clermont-Ferrand Auvergne Airport for scheduled flight connections. This route is ideal for business travellers combining a private flight with a commercial one, with no break in service." },
      ],
    },
  },
  "montlucon-gueret": {
    fr: {
      intro: "L'aérodrome de Montluçon-Guéret (MCU) est un site aéronautique discret mais essentiel, posé sur le plateau de Domérat à 5 km au sud de Montluçon, dans le département de l'Allier. Créé à l'origine comme terrain militaire auxiliaire, il a évolué au fil des décennies pour devenir un aérodrome civil dédié à l'aviation générale, à l'aviation d'affaires et à un aéroclub dynamique qui forme chaque année de nouveaux pilotes. Sa piste bitumée de 1 350 mètres peut accueillir des monomoteurs, des bimoteurs légers et des petits jets d'affaires, offrant une alternative pratique aux grands aéroports régionaux pour les voyageurs qui souhaitent atterrir au plus près du Bourbonnais et de la Creuse. Montluçon elle-même est une cité de caractère, l'une des plus grandes villes médiévales du centre de la France. Perchée sur un éperon rocheux dominant le Cher, sa vieille ville haute déploie un lacis de ruelles bordées de maisons à pans de bois, dominé par l'imposant château des Ducs de Bourbon, forteresse du XIVe siècle reconvertie en espace culturel. La ville est aussi célèbre pour le MuPop, le Musée des Musiques Populaires, un lieu unique en France qui retrace l'histoire des musiques populaires du XIXe siècle à nos jours dans deux hôtels particuliers magnifiquement restaurés. Le canal de Berry, ouvrage d'art du XIXe siècle en cours de revalorisation, traverse la ville et offre un cadre bucolique pour les promeneurs. Pour les passagers arrivant par avion privé à Domérat, le taxi est le seul moyen de transfert fiable : aucune navette ni transport en commun ne dessert l'aérodrome. Nos chauffeurs locaux, natifs du Bourbonnais, connaissent chaque raccourci et vous conduisent au cœur de la cité médiévale en 10 minutes à peine.",
      description: "À l'aérodrome de Montluçon-Guéret, votre taxi vous attend à la sortie de l'aérogare dès votre atterrissage. Nos chauffeurs empruntent la départementale D916 pour rejoindre le centre de Montluçon en 10 à 12 minutes : quartier médiéval, château des Ducs de Bourbon, MuPop, gare SNCF ou votre hôtel. Le service fonctionne sur réservation 24h/24 et 7j/7, week-ends et jours fériés inclus, sans aucun supplément horaire. Pour les vols privés arrivant en soirée, il suffit de communiquer l'heure estimée d'atterrissage lors de la réservation : votre chauffeur ajuste sa présence en conséquence. Le transfert vers Clermont-Ferrand est l'un de nos trajets les plus demandés : nos chauffeurs empruntent l'autoroute A71 (l'Arverne) et vous déposent au centre-ville ou directement à l'aéroport Clermont-Ferrand Auvergne en 1h à 1h15. Ce trajet est plébiscité par les voyageurs d'affaires qui posent leur avion à Domérat avant de prendre un vol régulier à Clermont, ou inversement. Pour les amateurs de patrimoine naturel, nos chauffeurs assurent également des transferts vers la forêt de Tronçais — la plus grande chênaie d'Europe, à 40 minutes — et vers Néris-les-Bains, station thermale gallo-romaine à 15 minutes seulement. Tous nos tarifs sont au forfait : le prix fixé à la réservation est définitif, sans compteur, sans surcharge en cas d'embouteillage sur la RN145 ou de déviation imprévue.",
      metaDescription: "Taxi aérodrome Montluçon-Guéret : cité médiévale en 10 min, MuPop, château des Ducs de Bourbon, canal de Berry. Forfait fixe garanti, réservez 24h/24.",
      heroSubtitle: "L'aérodrome de Montluçon-Guéret, situé à Domérat, dessert la cité médiévale de Montluçon à seulement 5 km. Votre chauffeur vous attend à la sortie de l'aérogare et rejoint le château des Ducs de Bourbon, le MuPop ou le canal de Berry en 10 minutes par la D916. Transfert vers Clermont-Ferrand via l'A71 en 1 heure — forfait garanti sans supplément, service 24h/24.",
      whyUs: [
        { title: "Cité médiévale en 10 min", desc: "Nos chauffeurs empruntent la D916 depuis Domérat pour atteindre le quartier médiéval de Montluçon en 10 minutes. Vous êtes déposé au pied du château des Ducs de Bourbon, forteresse du XIVe siècle offrant un panorama sur la vallée du Cher. Les ruelles de la vieille ville haute, les maisons à colombages et la place Saint-Pierre sont toutes accessibles à pied depuis le point de dépose." },
        { title: "MuPop et canal de Berry", desc: "Le MuPop (Musée des Musiques Populaires) est installé dans deux hôtels particuliers restaurés du quartier médiéval : un lieu unique en France pour découvrir l'histoire des musiques populaires. Nos chauffeurs vous déposent directement devant l'entrée. Le canal de Berry, ouvrage d'art du XIXe siècle qui traverse la ville, est à quelques minutes de marche. Transfert avec attente disponible pour les groupes culturels." },
        { title: "A71 vers Clermont et Paris", desc: "L'autoroute A71 (l'Arverne) relie Montluçon à Clermont-Ferrand en 1 heure et à Paris en 3 heures. Nos chauffeurs vous transfèrent depuis l'aérodrome de Domérat vers Clermont centre ou directement vers l'aéroport Clermont-Ferrand Auvergne pour vos correspondances nationales et internationales. Forfait garanti quel que soit l'état du trafic sur l'A71." },
      ],
    },
    en: {
      intro: "Montlucon-Gueret Aerodrome (MCU) is a discreet yet essential aviation site set on the Domerat plateau, 5 km south of Montlucon in the Allier department. Originally established as an auxiliary military airfield, it has evolved over the decades into a civilian aerodrome dedicated to general aviation, business aviation and a thriving aero club that trains new pilots every year. Its 1,350-metre paved runway can handle single-engine aircraft, light twins and small business jets, offering a practical alternative to larger regional airports for travellers who want to land as close as possible to the Bourbonnais and Creuse regions. Montlucon itself is a city of character, one of the largest medieval towns in central France. Perched on a rocky spur overlooking the River Cher, its upper old town unfolds a maze of narrow streets lined with half-timbered houses, dominated by the imposing Chateau des Ducs de Bourbon, a 14th-century fortress now repurposed as a cultural venue. The city is also famous for the MuPop, the Museum of Popular Music, a one-of-a-kind institution in France that traces the history of popular music from the 19th century to the present day across two beautifully restored townhouses. The Canal de Berry, a 19th-century engineering feat currently being revitalised, runs through the town and offers a bucolic setting for walkers. For passengers arriving by private aircraft at Domerat, a taxi is the only reliable means of transfer: no shuttle and no public transport serves the aerodrome. Our local drivers, born and raised in the Bourbonnais, know every shortcut and will take you to the heart of the medieval city in barely 10 minutes.",
      description: "At Montlucon-Gueret Aerodrome, your taxi waits at the terminal exit the moment you land. Our drivers take the D916 departmental road to reach central Montlucon in 10 to 12 minutes: the medieval quarter, Chateau des Ducs de Bourbon, MuPop, SNCF station or your hotel. The service runs on reservation 24/7, weekends and public holidays included, with no time-based surcharges whatsoever. For private flights arriving in the evening, simply provide the estimated landing time when booking: your driver adjusts their presence accordingly. The transfer to Clermont-Ferrand is one of our most requested routes: our drivers take the A71 motorway (the Arverne) and drop you in the city centre or directly at Clermont-Ferrand Auvergne Airport in 1h to 1h15. This route is favoured by business travellers who land their aircraft at Domerat before catching a scheduled flight at Clermont, or vice versa. For nature and heritage enthusiasts, our drivers also provide transfers to the Troncais Forest — the largest oak forest in Europe, 40 minutes away — and to Neris-les-Bains, a Gallo-Roman spa town just 15 minutes away. All our fares are fixed: the price set at booking is final, with no meter, no surcharge in case of congestion on the RN145 or an unexpected diversion.",
      metaDescription: "Montluçon-Guéret airport taxi: medieval city transfer in 10 min. MuPop museum, Château des Ducs de Bourbon, Canal de Berry. Fixed fare, book online 24/7.",
      heroSubtitle: "Montlucon-Gueret Aerodrome at Domerat serves the medieval city of Montlucon just 5 km away. Your driver waits at the terminal exit and reaches the Chateau des Ducs de Bourbon, MuPop or Canal de Berry in 10 minutes via the D916. Transfers to Clermont-Ferrand via the A71 in 1 hour — guaranteed fixed fare with no surcharges, 24/7 service.",
      whyUs: [
        { title: "Medieval city in 10 min", desc: "Our drivers take the D916 from Domerat to reach Montlucon's medieval quarter in 10 minutes. You are dropped at the foot of the Chateau des Ducs de Bourbon, a 14th-century fortress offering panoramic views over the Cher valley. The narrow streets of the upper old town, the half-timbered houses and the Place Saint-Pierre are all within walking distance of the drop-off point." },
        { title: "MuPop & Canal de Berry", desc: "The MuPop (Museum of Popular Music) occupies two restored townhouses in the medieval quarter: a one-of-a-kind venue in France exploring the history of popular music. Our drivers drop you right at the entrance. The Canal de Berry, a 19th-century engineering feat running through the town, is just a few minutes' walk away. Transfer with waiting time available for cultural groups." },
        { title: "A71 to Clermont & Paris", desc: "The A71 motorway (the Arverne) links Montlucon to Clermont-Ferrand in 1 hour and to Paris in 3 hours. Our drivers transfer you from Domerat Aerodrome to central Clermont-Ferrand or directly to Clermont-Ferrand Auvergne Airport for domestic and international connections. Guaranteed fixed fare regardless of traffic conditions on the A71." },
      ],
    },
  },
};
