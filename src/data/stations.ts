...
const STATION_CONTENT: Record<string, { fr: { intro: string; description: string; metaDescription: string; heroSubtitle: string; whyUs: { title: string; desc: string }[] }; en: { intro: string; description: string; metaDescription: string; heroSubtitle: string; whyUs: { title: string; desc: string }[] } }> = {
  "paris-gare-du-nord": {
    fr: {
      ...
      metaDescription: "Taxi Gare du Nord : 292 M voyageurs/an, hub Eurostar & Thalys. Forfait garanti, chauffeur à la sortie rue de Dunkerque. Réservez en ligne 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Taxi Gare du Nord: Europe's busiest station, 292M passengers/year. Eurostar & Thalys hub. Fixed fare, driver at exit. Book online 24/7.",
  ...
  "paris-gare-de-lyon": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Lyon : 148 M voyageurs/an, TGV Sud-Est, Suisse & Italie. Forfait fixe, suivi TGV temps réel. Réservation en ligne rapide.",
    ...
    en: {
      ...
      metaDescription: "Taxi Gare de Lyon: 148M passengers/year, TGV to South, Switzerland & Italy. Fixed fare, real-time TGV tracking. Quick online booking.",
  ...
  "paris-saint-lazare": {
    fr: {
      ...
      metaDescription: "Taxi Gare Saint-Lazare : 100 M voyageurs/an, porte de la Normandie. Chauffeur cour de Rome, forfait fixe. Réservez votre transfert 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Taxi Gare Saint-Lazare: 100M passengers/year, gateway to Normandy. Driver at cour de Rome exit, fixed fare. Book your transfer 24/7.",
  ...
  "paris-montparnasse": {
    fr: {
      ...
      metaDescription: "Taxi Gare Montparnasse : 90 M voyageurs/an, TGV Bordeaux 2h04, Rennes 1h27. Forfait fixe, transfert Orly 20 min. Réservez en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Gare Montparnasse: 90M passengers/year, TGV to Bordeaux 2h04, Rennes 1h27. Fixed fare, Orly transfer 20 min. Book online.",
  ...
  "paris-gare-de-l-est": {
    fr: {
      ...
      metaDescription: "Taxi Gare de l'Est : 50 M voyageurs/an, TGV Strasbourg 1h46, ICE Francfort. Prix fixe, correspondance Gare du Nord en 3 min. Réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Gare de l'Est: 50M passengers/year, TGV to Strasbourg 1h46, ICE to Frankfurt. Fixed price, Gare du Nord link in 3 min. Book now.",
  ...
  "paris-gare-d-austerlitz": {
    fr: {
      ...
      metaDescription: "Taxi Gare d'Austerlitz : trains de nuit & Intercités, 30 M voyageurs/an. Prise en charge dès 6h, transfert Orly 20 min. Forfait garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Gare d'Austerlitz: overnight trains & Intercites, 30M passengers/year. Pickup from 6am, Orly transfer 20 min. Guaranteed fare.",
  ...
  "paris-gare-de-bercy": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Bercy : trains de nuit vers l'Italie, 2 M voyageurs/an. Prise en charge tôt le matin, forfait fixe. Réservation rapide en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Gare de Bercy: overnight trains to Italy, 2M passengers/year. Early morning pickup, fixed fare. Quick online booking.",
  ...
  "lyon-part-dieu": {
    fr: {
      ...
      metaDescription: "Taxi Lyon Part-Dieu : plus grande gare TGV de France, 34 M voyageurs/an. Paris en 2h, Marseille en 1h40. Forfait fixe, réservez 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Taxi Lyon Part-Dieu: France's largest TGV hub, 34M passengers/year. Paris in 2h, Marseille in 1h40. Fixed fare, book 24/7.",
  ...
  "lyon-perrache": {
    fr: {
      ...
      metaDescription: "Taxi Lyon-Perrache : gare historique, 10 M voyageurs/an. Quartier Confluence à 3 min. Forfait fixe, chauffeur disponible dès 5h30.",
    ...
    en: {
      ...
      metaDescription: "Taxi Lyon-Perrache: historic station, 10M passengers/year. Confluence district 3 min away. Fixed fare, driver from 5:30am.",
  ...
  "marseille-saint-charles": {
    fr: {
      ...
      metaDescription: "Taxi Marseille Saint-Charles : 14 M voyageurs/an, TGV Paris 3h15. Accueil nominatif, transfert ferry Corse. Forfait fixe, réservez en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Marseille Saint-Charles: 14M passengers/year, TGV to Paris 3h15. Name-board welcome, Corsica ferry link. Fixed fare, book online.",
  ...
  "lille-flandres": {
    fr: {
      ...
      metaDescription: "Taxi Lille Flandres : 22 M voyageurs/an, TGV Paris 1h. Correspondance Lille Europe en 3 min. Forfait fixe, réservation en ligne 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Taxi Lille Flandres: 22M passengers/year, TGV to Paris 1h. Lille Europe connection in 3 min. Fixed fare, book online 24/7.",
  ...
  "lille-europe": {
    fr: {
      ...
      metaDescription: "Taxi Lille Europe : gare Eurostar & Thalys, 7 M voyageurs/an. Londres 1h20, Bruxelles 35 min. Chauffeurs multilingues, forfait garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Lille Europe: Eurostar & Thalys hub, 7M passengers/year. London 1h20, Brussels 35 min. Multilingual drivers, guaranteed fare.",
  ...
  "bordeaux-saint-jean": {
    fr: {
      ...
      metaDescription: "Taxi Bordeaux Saint-Jean : 15 M voyageurs/an, TGV Paris 2h04. Parvis sud, forfait garanti, chauffeur dès 6h. Réservez votre transfert.",
    ...
    en: {
      ...
      metaDescription: "Taxi Bordeaux Saint-Jean: 15M passengers/year, TGV from Paris 2h04. South forecourt, guaranteed fare, driver from 6am. Book now.",
  ...
  "toulouse-matabiau": {
    fr: {
      ...
      metaDescription: "Taxi Toulouse-Matabiau : 12 M voyageurs/an, TGV Paris 4h20. Transfert Airbus Blagnac, forfait garanti. Réservation en ligne rapide.",
    ...
    en: {
      ...
      metaDescription: "Taxi Toulouse-Matabiau: 12M passengers/year, TGV to Paris 4h20. Airbus Blagnac transfer, guaranteed fare. Quick online booking.",
  ...
  "nice-ville": {
    fr: {
      ...
      metaDescription: "Taxi Nice-Ville : 8 M voyageurs/an, Côte d'Azur & Monaco. Transfert aéroport, forfait fixe avenue Thiers. Réservez votre Riviera taxi.",
    ...
    en: {
      ...
      metaDescription: "Taxi Nice-Ville: 8M passengers/year, Cote d'Azur & Monaco. Airport transfer, fixed fare on avenue Thiers. Book your Riviera taxi.",
  ...
  "nantes": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Nantes : 12 M voyageurs/an, TGV Paris 2h15. Transfert aéroport 15 min, La Baule, forfait fixe. Réservez en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Nantes station: 12M passengers/year, TGV to Paris 2h15. Airport transfer 15 min, La Baule, fixed fare. Book online.",
  ...
  "strasbourg": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Strasbourg : 15 M voyageurs/an, TGV Paris 1h46, ICE Francfort. Transfert Parlement européen, forfait fixe. Réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Strasbourg station: 15M passengers/year, TGV to Paris 1h46, ICE to Frankfurt. EU Parliament transfer, fixed fare. Book now.",
  ...
  "montpellier-saint-roch": {
    fr: {
      ...
      metaDescription: "Taxi Montpellier Saint-Roch : 9 M voyageurs/an, TGV Paris 3h20. Aéroport 10 min, plages Palavas 15 min. Forfait fixe, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Montpellier Saint-Roch: 9M passengers/year, TGV to Paris 3h20. Airport 10 min, Palavas beaches 15 min. Fixed fare, book now.",
  ...
  "rennes": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Rennes : 10 M voyageurs/an, TGV Paris 1h27. Transferts Saint-Malo & Mont-Saint-Michel. Forfait fixe, réservez en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Rennes station: 10M passengers/year, TGV to Paris 1h27. Saint-Malo & Mont-Saint-Michel transfers. Fixed fare, book online.",
  ...
  "marne-la-vallee-chessy": {
    fr: {
      ...
      metaDescription: "Taxi Marne-la-Vallée Chessy : Disneyland Paris, 15 M voyageurs/an. Sièges enfants, hôtels Disney en 2 min. Forfait fixe, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Marne-la-Vallee Chessy: Disneyland Paris, 15M passengers/year. Child seats, Disney hotels in 2 min. Fixed fare, book now.",
  ...
  "lyon-saint-exupery-tgv": {
    fr: {
      ...
      metaDescription: "Taxi Lyon Saint-Exupéry TGV : gare-aéroport, 4 M voyageurs/an. Transfert ski Alpes, pneus neige. Forfait fixe, réservez 24h/24.",
    ...
    en: {
      ...
      metaDescription: "Taxi Lyon Saint-Exupery TGV: airport-station, 4M passengers/year. Alpine ski transfers, snow tyres. Fixed fare, book 24/7.",
  ...
  "avignon-tgv": {
    fr: {
      ...
      metaDescription: "Taxi Avignon TGV : 4 M voyageurs/an, Paris 2h40. Transfert Luberon, Gordes, Festival d'Avignon. Centre en 10 min, forfait fixe.",
    ...
    en: {
      ...
      metaDescription: "Taxi Avignon TGV: 4M passengers/year, Paris 2h40. Luberon, Gordes, Festival d'Avignon transfers. Centre in 10 min, fixed fare.",
  ...
  "aix-en-provence-tgv": {
    fr: {
      ...
      metaDescription: "Taxi Aix-en-Provence TGV : 4 M voyageurs/an, Paris 3h. Centre Aix 15 min, aéroport Marseille 10 min. Forfait garanti, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Aix-en-Provence TGV: 4M passengers/year, Paris 3h. Aix centre 15 min, Marseille airport 10 min. Guaranteed fare, book now.",
  ...
  "valence-tgv": {
    fr: {
      ...
      metaDescription: "Taxi Valence TGV : 2 M voyageurs/an, Paris 2h15. Gare isolée, taxi indispensable. Centre en 10 min, Vercors, forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Valence TGV: 2M passengers/year, Paris 2h15. Isolated station, taxi essential. Centre in 10 min, Vercors, guaranteed fare.",
  ...
  "metz": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Metz : 7 M voyageurs/an, TGV Paris 1h24. Transfert Luxembourg 40 min, Pompidou-Metz. Forfait fixe transfrontalier.",
    ...
    en: {
      ...
      metaDescription: "Taxi Metz station: 7M passengers/year, TGV to Paris 1h24. Luxembourg transfer 40 min, Pompidou-Metz. Cross-border fixed fare.",
  ...
  "nancy": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Nancy : 7 M voyageurs/an, TGV Paris 1h30, Place Stanislas UNESCO. Aéroport 25 min, Vosges. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Nancy station: 7M passengers/year, TGV to Paris 1h30, Place Stanislas UNESCO. Airport 25 min, Vosges. Guaranteed fixed fare.",
  ...
  "reims": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Reims : 5 M voyageurs/an, TGV Paris 45 min. Circuits caves Champagne, Épernay. Forfait fixe, réservez votre transfert.",
    ...
    en: {
      ...
      metaDescription: "Taxi Reims station: 5M passengers/year, TGV to Paris 45 min. Champagne cellar circuits, Epernay. Fixed fare, book your transfer.",
  ...
  "dijon-ville": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Dijon : 7 M voyageurs/an, TGV Paris 1h40. Route des Grands Crus, Beaune, vendanges. Forfait fixe, réservez en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Dijon station: 7M passengers/year, TGV to Paris 1h40. Route des Grands Crus, Beaune, harvest season. Fixed fare, book online.",
  ...
  "grenoble": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Grenoble : 5 M voyageurs/an, Alpe d'Huez & Deux Alpes. Pneus neige, transfert ski. Forfait fixe garanti, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Grenoble station: 5M passengers/year, Alpe d'Huez & Les Deux Alpes. Snow tyres, ski transfers. Guaranteed fixed fare, book now.",
  ...
  "tours": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Tours : 7 M voyageurs/an, TGV Paris 1h15. Circuits châteaux de la Loire, Chenonceau, Amboise. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Tours station: 7M passengers/year, TGV to Paris 1h15. Loire chateau circuits, Chenonceau, Amboise. Guaranteed fixed fare.",
  ...
  "le-mans": {
    fr: {
      ...
      metaDescription: "Taxi Gare du Mans : 5 M voyageurs/an, TGV Paris 55 min. Circuit 24 Heures en 8 min, Cité Plantagenêt. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Le Mans station: 5M passengers/year, TGV to Paris 55 min. 24 Hours circuit in 8 min, Cite Plantagenet. Guaranteed fixed fare.",
  ...
  "rouen-rive-droite": {
    fr: {
      ...
      metaDescription: "Taxi Gare Rouen : 8 M voyageurs/an, Paris 1h20. Circuits Honfleur, Étretat, Giverny. Forfait fixe, chauffeur dès 5h30. Réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Rouen station: 8M passengers/year, Paris 1h20. Circuits to Honfleur, Etretat, Giverny. Fixed fare, driver from 5:30am. Book now.",
  ...
  "toulon": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Toulon : 3 M voyageurs/an, port ferry Corse en 5 min. Transfert Porquerolles, Saint-Tropez. Forfait fixe, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Toulon station: 3M passengers/year, Corsica ferry port in 5 min. Porquerolles, Saint-Tropez transfers. Fixed fare, book now.",
  ...
  "clermont-ferrand": {
    fr: {
      ...
      metaDescription: "Taxi Clermont-Ferrand : 4 M voyageurs/an, Intercités Paris 3h30. Vulcania 25 min, Puy de Dôme 20 min. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Clermont-Ferrand: 4M passengers/year, Intercites to Paris 3h30. Vulcania 25 min, Puy de Dome 20 min. Guaranteed fixed fare.",
  ...
  "saint-etienne-chateaucreux": {
    fr: {
      ...
      metaDescription: "Taxi Saint-Étienne Châteaucreux : 4 M voyageurs/an, TER Lyon 50 min. Stade ASSE 5 min, Cité du Design. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Saint-Etienne Chateaucreux: 4M passengers/year, TER to Lyon 50 min. ASSE stadium 5 min, Cite du Design. Guaranteed fare.",
  ...
  "angers-saint-laud": {
    fr: {
      ...
      metaDescription: "Taxi Angers Saint-Laud : 5 M voyageurs/an, TGV Paris 1h30. Saumur 30 min, vignobles Anjou. Forfait fixe, réservation en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Angers Saint-Laud: 5M passengers/year, TGV to Paris 1h30. Saumur 30 min, Anjou vineyards. Fixed fare, book online.",
  ...
  "poitiers": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Poitiers : 4 M voyageurs/an, TGV Paris 1h20. Futuroscope en 10 min, poussettes bienvenues. Forfait fixe, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Poitiers station: 4M passengers/year, TGV to Paris 1h20. Futuroscope in 10 min, family-friendly. Fixed fare, book now.",
  ...
  "perpignan": {
    fr: {
      ...
      metaDescription: "Taxi Perpignan : 2 M voyageurs/an, TGV Barcelone 1h30. Collioure 18 min, Côte Vermeille. Forfait fixe franco-espagnol, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Perpignan: 2M passengers/year, TGV to Barcelona 1h30. Collioure 18 min, Cote Vermeille. Franco-Spanish fixed fare, book now.",
  ...
  "caen": {
    fr: {
      ...
      metaDescription: "Taxi Gare de Caen : 4 M voyageurs/an, Paris 2h. Circuits plages du Débarquement, ferry Ouistreham 12 min. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Caen station: 4M passengers/year, Paris 2h. D-Day beach circuits, Ouistreham ferry 12 min. Guaranteed fixed fare.",
  ...
  "limoges-benedictins": {
    fr: {
      ...
      metaDescription: "Taxi Limoges-Bénédictins : plus belle gare de France, 3 M voyageurs/an. Oradour 20 min, aéroport 8 min. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Limoges-Benedictins: France's most beautiful station, 3M passengers/year. Oradour 20 min, airport 8 min. Guaranteed fare.",
  ...
  "orleans": {
    fr: {
      ...
      metaDescription: "Taxi Gare d'Orléans : 5 M voyageurs/an, Paris 1h10. Chambord en taxi 30 min, Blois, Sologne. Forfait fixe, réservez en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Orleans station: 5M passengers/year, Paris 1h10. Chambord by taxi 30 min, Blois, Sologne. Fixed fare, book online.",
  ...
  "mulhouse-ville": {
    fr: {
      ...
      metaDescription: "Taxi Mulhouse : 4 M voyageurs/an, gare trinationale FR-CH-DE. Bâle 20 min, EuroAirport 20 min. Forfait fixe transfrontalier.",
    ...
    en: {
      ...
      metaDescription: "Taxi Mulhouse: 4M passengers/year, trinational station FR-CH-DE. Basel 20 min, EuroAirport 20 min. Cross-border fixed fare.",
  ...
  "amiens": {
    fr: {
      ...
      metaDescription: "Taxi Gare d'Amiens : 4 M voyageurs/an, Paris 1h10. Baie de Somme 40 min, mémoriaux 14-18. Forfait fixe, réservation en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Amiens station: 4M passengers/year, Paris 1h10. Baie de Somme 40 min, WWI memorials. Fixed fare, book online.",
  ...
  "besancon-viotte": {
    fr: {
      ...
      metaDescription: "Taxi Besançon Viotte : 3 M voyageurs/an, Citadelle Vauban UNESCO. Navette gare TGV 10 min, Jura ski. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Besancon Viotte: 3M passengers/year, UNESCO Vauban Citadel. TGV station shuttle 10 min, Jura skiing. Guaranteed fixed fare.",
  ...
  "la-rochelle-ville": {
    fr: {
      ...
      metaDescription: "Taxi La Rochelle : 2 M voyageurs/an, TGV Paris 3h. Île de Ré 20 min, Aquarium, Francofolies. Forfait fixe garanti, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi La Rochelle: 2M passengers/year, TGV to Paris 3h. Ile de Re 20 min, Aquarium, Francofolies. Guaranteed fixed fare, book now.",
  ...
  "bayonne": {
    fr: {
      ...
      metaDescription: "Taxi Bayonne : 2 M voyageurs/an, Pays Basque. Biarritz 10 min, San Sebastián 45 min. Forfait transfrontalier fixe, réservez.",
    ...
    en: {
      ...
      metaDescription: "Taxi Bayonne: 2M passengers/year, Basque Country. Biarritz 10 min, San Sebastian 45 min. Cross-border fixed fare, book now.",
  ...
  "chambery": {
    fr: {
      ...
      metaDescription: "Taxi Chambéry : 3 M voyageurs/an, porte des 3 Vallées. Courchevel, Méribel, Val Thorens. Véhicules montagne, forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Chambery: 3M passengers/year, gateway to the 3 Valleys. Courchevel, Meribel, Val Thorens. Mountain vehicles, guaranteed fare.",
  ...
  "cannes": {
    fr: {
      ...
      metaDescription: "Taxi Cannes : 3 M voyageurs/an, ville du Festival. Croisette 3 min, aéroport Nice 30 min, Grasse 15 min. Forfait fixe garanti.",
    ...
    en: {
      ...
      metaDescription: "Taxi Cannes: 3M passengers/year, Festival city. Croisette 3 min, Nice airport 30 min, Grasse 15 min. Guaranteed fixed fare.",
  ...
  "versailles-chantiers": {
    fr: {
      ...
      metaDescription: "Taxi Versailles-Chantiers : 15 M voyageurs/an, Château 3 min. Transfert Orly 25 min, CDG 50 min. Forfait fixe, familles bienvenues.",
    ...
    en: {
      ...
      metaDescription: "Taxi Versailles-Chantiers: 15M passengers/year, Palace 3 min. Orly transfer 25 min, CDG 50 min. Fixed fare, families welcome.",
  ...
  "pau": {
    fr: {
      ...
      metaDescription: "Taxi Pau : 1,5 M voyageurs/an, porte des Pyrénées. Lourdes 30 min, aéroport 10 min, ski. Forfait fixe garanti, réservez en ligne.",
    ...
    en: {
      ...
      metaDescription: "Taxi Pau: 1.5M passengers/year, Pyrenees gateway. Lourdes 30 min, airport 10 min, skiing. Guaranteed fixed fare, book online.",
