...
export const stations: Station[] = [
  station(
    ...
    "Centre de Paris (10e)", "5-15 min", "12 EUR",
    ["TGV", "Eurostar", "Thalys", "TER", "RER", "Transilien"],
    "292 millions",
    [
      { name: "Aéroport CDG", price: "56 EUR", time: "30-50 min" },
      { name: "Aéroport d'Orly", price: "45 EUR", time: "35-50 min" },
      { name: "La Défense", price: "35 EUR", time: "20-35 min" },
      { name: "Disneyland Paris", price: "65 EUR", time: "40-55 min" },
      { name: "Paris Gare de Lyon", price: "18 EUR", time: "10-20 min" },
    ],
    [
    ...
    [
      ...
      { question: "Combien coûte un taxi Gare du Nord – CDG ?", answer: "Le forfait taxi Gare du Nord – Aéroport CDG est d'environ 56 EUR. Trajet de 30-50 minutes selon la circulation." },
    ],
  ...
  station(
    ...
    "Centre de Paris (12e)", "5-15 min", "12 EUR",
    ["TGV", "TER", "RER", "Transilien"],
    "148 millions",
    [
      { name: "Aéroport CDG", price: "58 EUR", time: "35-55 min" },
      { name: "Aéroport d'Orly", price: "35 EUR", time: "20-35 min" },
      { name: "La Défense", price: "38 EUR", time: "25-40 min" },
      { name: "Paris Gare du Nord", price: "18 EUR", time: "10-20 min" },
      { name: "Disneyland Paris", price: "60 EUR", time: "35-50 min" },
    ],
    [
    ...
    [
      { question: "Quel est le forfait taxi Gare de Lyon – Orly ?", answer: "Le forfait taxi Gare de Lyon – Aéroport d'Orly est d'environ 35 EUR. Trajet de 20-35 minutes." },
    ],
  ...
  station(
    ...
    "Centre de Paris (8e)", "5-15 min", "12 EUR",
    ["Transilien", "TER", "Intercités"],
    "100 millions",
    [
      { name: "Aéroport CDG", price: "55 EUR", time: "30-50 min" },
      { name: "Aéroport d'Orly", price: "42 EUR", time: "30-45 min" },
      { name: "La Défense", price: "25 EUR", time: "15-25 min" },
      { name: "Versailles", price: "40 EUR", time: "25-35 min" },
      { name: "Paris Gare du Nord", price: "15 EUR", time: "8-15 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Paris (15e)", "5-15 min", "12 EUR",
    ["TGV", "TER", "Intercités"],
    "90 millions",
    [
      { name: "Aéroport CDG", price: "60 EUR", time: "40-60 min" },
      { name: "Aéroport d'Orly", price: "32 EUR", time: "20-30 min" },
      { name: "La Défense", price: "35 EUR", time: "20-35 min" },
      { name: "Paris Gare du Nord", price: "20 EUR", time: "12-22 min" },
      { name: "Versailles", price: "35 EUR", time: "20-30 min" },
    ],
    [
    ...
    [
      { question: "Comment rejoindre Orly depuis Montparnasse ?", answer: "Le forfait taxi Montparnasse – Orly est d'environ 32 EUR, pour un trajet de 20-30 minutes. Plus rapide et confortable que le bus." },
    ],
  ...
  station(
    ...
    [
      ...
      { name: "Aéroport d'Orly", price: "42 EUR", time: "30-45 min" },
      { name: "La Défense", price: "35 EUR", time: "20-35 min" },
      { name: "Paris Gare du Nord", price: "8 EUR", time: "3-5 min" },
      { name: "Disneyland Paris", price: "65 EUR", time: "40-55 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Paris (13e)", "5-15 min", "12 EUR",
    ["Intercités", "TER", "Intercités de nuit"],
    "30 millions",
    [
      { name: "Aéroport CDG", price: "58 EUR", time: "35-55 min" },
      { name: "Aéroport d'Orly", price: "30 EUR", time: "20-30 min" },
      { name: "Paris Gare de Lyon", price: "10 EUR", time: "5-10 min" },
      { name: "La Défense", price: "38 EUR", time: "25-40 min" },
      { name: "Quartier Latin", price: "10 EUR", time: "5-8 min" },
    ],
    [
  ...
  station(
    ...
    [
      { name: "Aéroport CDG", price: "58 EUR", time: "35-55 min" },
      { name: "Aéroport d'Orly", price: "32 EUR", time: "20-35 min" },
      { name: "Paris Gare de Lyon", price: "8 EUR", time: "3-5 min" },
      { name: "Bercy Village", price: "6 EUR", time: "2-3 min" },
      { name: "Paris centre (Châtelet)", price: "15 EUR", time: "10-15 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Lyon", "5-10 min", "12 EUR",
    ["TGV", "TER", "Intercités"],
    "34 millions",
    [
      { name: "Aéroport Lyon Saint-Exupéry", price: "65 EUR", time: "25-35 min" },
      { name: "Lyon Presqu'île (Bellecour)", price: "15 EUR", time: "8-12 min" },
      { name: "Lyon Vieux-Lyon", price: "18 EUR", time: "10-15 min" },
      { name: "Villeurbanne", price: "12 EUR", time: "5-10 min" },
      { name: "Grenoble", price: "120 EUR", time: "1h-1h15" },
    ],
    [
    ...
    [
      { question: "Combien coûte un taxi Part-Dieu – Aéroport Saint-Exupéry ?", answer: "Le forfait taxi Lyon Part-Dieu – Aéroport Saint-Exupéry est d'environ 65 EUR. Trajet de 25-35 minutes." },
    ],
  ...
  station(
    ...
    "Centre de Lyon (2e)", "5-10 min", "12 EUR",
    ["TGV", "TER"],
    "10 millions",
    [
      { name: "Aéroport Lyon Saint-Exupéry", price: "70 EUR", time: "30-40 min" },
      { name: "Lyon Part-Dieu", price: "12 EUR", time: "8-12 min" },
      { name: "Lyon Confluence", price: "8 EUR", time: "3-5 min" },
      { name: "Vieux-Lyon", price: "10 EUR", time: "5-8 min" },
      { name: "Annecy", price: "150 EUR", time: "1h30-1h45" },
    ],
    [
  ...
  station(
    ...
    "Centre de Marseille", "5-10 min", "12 EUR",
    ["TGV", "TER", "Intercités"],
    "14 millions",
    [
      { name: "Aéroport Marseille-Provence", price: "55 EUR", time: "25-40 min" },
      { name: "Vieux-Port", price: "12 EUR", time: "5-10 min" },
      { name: "Calanques (Cassis)", price: "55 EUR", time: "30-40 min" },
      { name: "Aix-en-Provence", price: "55 EUR", time: "25-35 min" },
      { name: "Toulon", price: "80 EUR", time: "45-60 min" },
    ],
    [
    ...
    [
      { question: "Combien coûte un taxi Gare Saint-Charles – Aéroport ?", answer: "Le forfait taxi Marseille Saint-Charles – Aéroport Provence est d'environ 55 EUR. Trajet de 25-40 minutes." },
    ],
  ...
  station(
    ...
    "Centre de Lille", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "22 millions",
    [
      { name: "Lille Europe", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Lille-Lesquin", price: "25 EUR", time: "15-20 min" },
      { name: "Grand Place", price: "6 EUR", time: "2-4 min" },
      { name: "Roubaix", price: "25 EUR", time: "15-20 min" },
      { name: "Villeneuve-d'Ascq", price: "20 EUR", time: "12-18 min" },
    ],
    [
  ...
  station(
    ...
    "7 millions",
    [
      { name: "Lille Flandres", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Lille-Lesquin", price: "25 EUR", time: "15-20 min" },
      { name: "Grand Place", price: "8 EUR", time: "3-5 min" },
      { name: "Euralille (Centre commercial)", price: "5 EUR", time: "2-3 min" },
      { name: "Courtrai (Belgique)", price: "55 EUR", time: "30-40 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Bordeaux", "5-10 min", "12 EUR",
    ["TGV", "TER", "Intercités"],
    "15 millions",
    [
      { name: "Aéroport Bordeaux-Mérignac", price: "35 EUR", time: "20-30 min" },
      { name: "Centre-ville (Place de la Bourse)", price: "12 EUR", time: "5-10 min" },
      { name: "Saint-Émilion", price: "75 EUR", time: "40-50 min" },
      { name: "Arcachon", price: "80 EUR", time: "45-55 min" },
      { name: "Cité du Vin", price: "12 EUR", time: "5-8 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Toulouse", "5-10 min", "10 EUR",
    ["TGV", "TER", "Intercités"],
    "12 millions",
    [
      { name: "Aéroport Toulouse-Blagnac", price: "28 EUR", time: "15-25 min" },
      { name: "Capitole", price: "10 EUR", time: "5-8 min" },
      { name: "Cité de l'Espace", price: "22 EUR", time: "12-18 min" },
      { name: "Airbus Blagnac", price: "25 EUR", time: "15-20 min" },
      { name: "Carcassonne", price: "120 EUR", time: "1h-1h15" },
    ],
    [
  ...
  station(
    ...
    "Centre de Nice", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "8 millions",
    [
      { name: "Aéroport Nice Côte d'Azur", price: "25 EUR", time: "10-20 min" },
      { name: "Promenade des Anglais", price: "10 EUR", time: "5-8 min" },
      { name: "Monaco", price: "65 EUR", time: "25-35 min" },
      { name: "Cannes", price: "70 EUR", time: "30-40 min" },
      { name: "Antibes", price: "45 EUR", time: "20-30 min" },
    ],
    [
    ...
    [
      { question: "Combien coûte un taxi Nice Gare – Aéroport ?", answer: "Le forfait taxi Nice Ville – Aéroport Nice Côte d'Azur est d'environ 25 EUR. Trajet de 10-20 minutes." },
    ],
  ...
  station(
    ...
    "Centre de Nantes", "3-8 min", "10 EUR",
    ["TGV", "TER", "Intercités"],
    "12 millions",
    [
      { name: "Aéroport Nantes Atlantique", price: "30 EUR", time: "15-25 min" },
      { name: "Château des Ducs", price: "8 EUR", time: "3-5 min" },
      { name: "Machines de l'Île", price: "10 EUR", time: "5-8 min" },
      { name: "La Baule", price: "80 EUR", time: "45-55 min" },
      { name: "Saint-Nazaire", price: "70 EUR", time: "40-50 min" },
    ],
    [
    ...
    [
      { question: "Comment rejoindre La Baule depuis la gare de Nantes ?", answer: "Le forfait taxi Nantes – La Baule est d'environ 80 EUR, pour un trajet de 45-55 minutes. Alternative directe au TER." },
    ],
  ...
  station(
    ...
    "Centre de Strasbourg", "3-8 min", "10 EUR",
    ["TGV", "TER", "ICE"],
    "15 millions",
    [
      { name: "Aéroport Strasbourg-Entzheim", price: "25 EUR", time: "10-15 min" },
      { name: "Cathédrale / Petite France", price: "10 EUR", time: "5-8 min" },
      { name: "Parlement européen", price: "15 EUR", time: "8-12 min" },
      { name: "Colmar", price: "75 EUR", time: "40-50 min" },
      { name: "Europa-Park (Allemagne)", price: "65 EUR", time: "35-45 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Montpellier", "3-8 min", "10 EUR",
    ["TGV", "TER", "Intercités"],
    "9 millions",
    [
      { name: "Aéroport Montpellier Méditerranée", price: "25 EUR", time: "10-15 min" },
      { name: "Place de la Comédie", price: "8 EUR", time: "3-5 min" },
      { name: "Plages (Palavas)", price: "25 EUR", time: "15-20 min" },
      { name: "Nîmes", price: "50 EUR", time: "30-40 min" },
      { name: "Sète", price: "40 EUR", time: "25-30 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Rennes", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "10 millions",
    [
      { name: "Aéroport Rennes Bretagne", price: "25 EUR", time: "10-15 min" },
      { name: "Centre historique", price: "8 EUR", time: "3-5 min" },
      { name: "Saint-Malo", price: "80 EUR", time: "50 min-1h" },
      { name: "Mont-Saint-Michel", price: "120 EUR", time: "1h-1h15" },
      { name: "Vitré", price: "45 EUR", time: "25-30 min" },
    ],
    [
  ...
  station(
    ...
    "10 km de Paris (77)", "25-40 min", "55 EUR",
    ["TGV", "RER"],
    "15 millions",
    [
      { name: "Disneyland Paris", price: "8 EUR", time: "2-3 min" },
      { name: "Paris centre (Châtelet)", price: "55 EUR", time: "25-40 min" },
      { name: "Aéroport CDG", price: "45 EUR", time: "20-30 min" },
      { name: "Aéroport d'Orly", price: "65 EUR", time: "35-50 min" },
      { name: "Val d'Europe", price: "10 EUR", time: "3-5 min" },
    ],
    [
  ...
  station(
    ...
    "25 km de Lyon", "25-40 min", "65 EUR",
    ["TGV"],
    "4 millions",
    [
      { name: "Lyon Part-Dieu", price: "65 EUR", time: "25-35 min" },
      { name: "Lyon Perrache", price: "70 EUR", time: "30-40 min" },
      { name: "Grenoble", price: "100 EUR", time: "50 min-1h" },
      { name: "Annecy", price: "130 EUR", time: "1h10-1h25" },
      { name: "Chambéry", price: "90 EUR", time: "40-50 min" },
    ],
    [
  ...
  station(
    ...
    "5 km du centre d'Avignon", "10-15 min", "15 EUR",
    ["TGV"],
    "4 millions",
    [
      { name: "Avignon centre (Palais des Papes)", price: "15 EUR", time: "10-15 min" },
      { name: "Avignon Centre (gare)", price: "12 EUR", time: "8-12 min" },
      { name: "Aix-en-Provence", price: "75 EUR", time: "45-55 min" },
      { name: "Nîmes", price: "45 EUR", time: "25-35 min" },
      { name: "Luberon (Gordes)", price: "75 EUR", time: "40-50 min" },
    ],
    [
  ...
  station(
    ...
    "15 km du centre d'Aix", "15-25 min", "30 EUR",
    ["TGV"],
    "4 millions",
    [
      { name: "Aix-en-Provence centre", price: "30 EUR", time: "15-25 min" },
      { name: "Marseille centre", price: "55 EUR", time: "25-35 min" },
      { name: "Aéroport Marseille-Provence", price: "25 EUR", time: "10-15 min" },
      { name: "Calanques (Cassis)", price: "60 EUR", time: "30-40 min" },
      { name: "Luberon", price: "80 EUR", time: "45-55 min" },
    ],
    [
    ...
    [
      { question: "La gare TGV est-elle loin du centre d'Aix ?", answer: "Oui, la gare Aix-en-Provence TGV est à 15 km du centre. Le taxi met 15-25 minutes et coûte environ 30 EUR." },
    ],
  ...
  station(
    ...
    "10 km du centre de Valence", "10-20 min", "20 EUR",
    ["TGV"],
    "2 millions",
    [
      { name: "Valence centre", price: "20 EUR", time: "10-20 min" },
      { name: "Valence Ville (gare centre)", price: "18 EUR", time: "10-15 min" },
      { name: "Montélimar", price: "45 EUR", time: "25-35 min" },
      { name: "Die (Vercors)", price: "80 EUR", time: "50 min-1h" },
      { name: "Romans-sur-Isère", price: "30 EUR", time: "15-20 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Metz", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "7 millions",
    [
      { name: "Centre Pompidou-Metz", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Metz-Nancy-Lorraine", price: "40 EUR", time: "25-30 min" },
      { name: "Nancy", price: "55 EUR", time: "35-45 min" },
      { name: "Luxembourg", price: "65 EUR", time: "40-50 min" },
      { name: "Thionville", price: "35 EUR", time: "20-25 min" },
    ],
    [
    ...
    [
      { question: "Peut-on prendre un taxi Metz-Luxembourg ?", answer: "Oui, le forfait taxi Metz-Luxembourg est d'environ 65 EUR, pour un trajet de 40-50 minutes." },
    ],
  ...
  station(
    ...
    "Centre de Nancy", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "7 millions",
    [
      { name: "Place Stanislas", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Metz-Nancy-Lorraine", price: "40 EUR", time: "25-35 min" },
      { name: "Metz", price: "55 EUR", time: "35-45 min" },
      { name: "Épinal", price: "65 EUR", time: "40-50 min" },
      { name: "Vittel / Contrexéville", price: "90 EUR", time: "55 min-1h10" },
    ],
    [
  ...
  station(
    ...
    "Centre de Reims", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "5 millions",
    [
      { name: "Cathédrale de Reims", price: "10 EUR", time: "5-8 min" },
      { name: "Caves de Champagne (Pommery)", price: "12 EUR", time: "5-10 min" },
      { name: "Aéroport CDG", price: "120 EUR", time: "1h10-1h30" },
      { name: "Épernay", price: "40 EUR", time: "25-30 min" },
      { name: "Châlons-en-Champagne", price: "55 EUR", time: "30-40 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Dijon", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "7 millions",
    [
      { name: "Palais des Ducs", price: "8 EUR", time: "3-5 min" },
      { name: "Beaune", price: "45 EUR", time: "25-30 min" },
      { name: "Aéroport Dijon-Bourgogne", price: "20 EUR", time: "10-15 min" },
      { name: "Auxerre", price: "110 EUR", time: "1h10-1h25" },
      { name: "Dole", price: "50 EUR", time: "30-35 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Grenoble", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "5 millions",
    [
      { name: "Bastille (Téléphérique)", price: "10 EUR", time: "5-8 min" },
      { name: "Aéroport Lyon Saint-Exupéry", price: "120 EUR", time: "1h-1h15" },
      { name: "Alpe d'Huez", price: "110 EUR", time: "1h-1h15" },
      { name: "Chamrousse", price: "55 EUR", time: "35-45 min" },
      { name: "Voiron", price: "35 EUR", time: "20-25 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Tours", "3-8 min", "10 EUR",
    ["TGV", "TER", "Intercités"],
    "7 millions",
    [
      { name: "Château de Villandry", price: "30 EUR", time: "15-20 min" },
      { name: "Château de Chenonceau", price: "50 EUR", time: "30-35 min" },
      { name: "Amboise", price: "40 EUR", time: "20-25 min" },
      { name: "Aéroport Tours Val de Loire", price: "15 EUR", time: "8-12 min" },
      { name: "Chinon", price: "60 EUR", time: "35-45 min" },
    ],
    [
  ...
  station(
    ...
    "Centre du Mans", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "5 millions",
    [
      { name: "Circuit des 24 Heures", price: "15 EUR", time: "8-12 min" },
      { name: "Cité Plantagenêt", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Le Mans-Arnage", price: "15 EUR", time: "8-12 min" },
      { name: "Laval", price: "75 EUR", time: "45-55 min" },
      { name: "Alençon", price: "70 EUR", time: "40-50 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Rouen", "3-8 min", "10 EUR",
    ["TER", "Intercités"],
    "8 millions",
    [
      { name: "Cathédrale de Rouen", price: "8 EUR", time: "3-5 min" },
      { name: "Le Havre", price: "80 EUR", time: "50 min-1h" },
      { name: "Honfleur", price: "90 EUR", time: "55 min-1h10" },
      { name: "Giverny (Monet)", price: "75 EUR", time: "45-55 min" },
      { name: "Dieppe", price: "60 EUR", time: "35-45 min" },
    ],
    [
    ...
    [
      { question: "Comment aller de Rouen à Honfleur ?", answer: "Le forfait taxi Rouen-Honfleur est d'environ 90 EUR, pour un trajet de 55 min à 1h10. Pas de train direct." },
    ],
  ...
  station(
    ...
    "Centre de Toulon", "3-8 min", "10 EUR",
    ["TGV", "TER", "Intercités"],
    "3 millions",
    [
      { name: "Port de Toulon (ferries Corse)", price: "10 EUR", time: "5-8 min" },
      { name: "Hyères / Porquerolles", price: "35 EUR", time: "20-25 min" },
      { name: "Bandol", price: "30 EUR", time: "15-20 min" },
      { name: "Aéroport Toulon-Hyères", price: "35 EUR", time: "20-25 min" },
      { name: "Saint-Tropez", price: "120 EUR", time: "1h-1h15" },
    ],
    [
  ...
  station(
    ...
    "Centre de Clermont-Ferrand", "3-8 min", "10 EUR",
    ["TER", "Intercités"],
    "4 millions",
    [
      { name: "Place de Jaude", price: "8 EUR", time: "3-5 min" },
      { name: "Vulcania", price: "40 EUR", time: "25-30 min" },
      { name: "Puy de Dôme", price: "35 EUR", time: "20-25 min" },
      { name: "Vichy", price: "50 EUR", time: "30-35 min" },
      { name: "Aéroport Clermont-Ferrand Auvergne", price: "20 EUR", time: "10-15 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Saint-Étienne", "3-8 min", "10 EUR",
    ["TER"],
    "4 millions",
    [
      { name: "Centre-ville (Place Jean Jaurès)", price: "8 EUR", time: "3-5 min" },
      { name: "Lyon Part-Dieu", price: "55 EUR", time: "35-45 min" },
      { name: "Aéroport Lyon Saint-Exupéry", price: "90 EUR", time: "50 min-1h" },
      { name: "Stade Geoffroy-Guichard", price: "10 EUR", time: "5-8 min" },
      { name: "Firminy (Le Corbusier)", price: "20 EUR", time: "12-15 min" },
    ],
    [
    ...
    [
      { question: "Comment aller de Saint-Étienne à Lyon ?", answer: "Le TER Saint-Étienne – Lyon met environ 50 minutes. En taxi, comptez 55 EUR et 35-45 minutes." },
    ],
  ...
  station(
    ...
    "Centre d'Angers", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "5 millions",
    [
      { name: "Château d'Angers", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Angers-Marcé", price: "30 EUR", time: "15-20 min" },
      { name: "Saumur", price: "55 EUR", time: "30-40 min" },
      { name: "Nantes", price: "70 EUR", time: "40-50 min" },
      { name: "Le Mans", price: "75 EUR", time: "45-55 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Poitiers", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "4 millions",
    [
      { name: "Centre-ville (Notre-Dame-la-Grande)", price: "8 EUR", time: "3-5 min" },
      { name: "Futuroscope", price: "18 EUR", time: "10-15 min" },
      { name: "Aéroport Poitiers-Biard", price: "15 EUR", time: "8-12 min" },
      { name: "Châtellerault", price: "40 EUR", time: "25-30 min" },
      { name: "Niort", price: "70 EUR", time: "45-55 min" },
    ],
    [
    ...
    [
      { question: "Comment rejoindre le Futuroscope depuis la gare ?", answer: "Le Futuroscope est à 12 km de la gare de Poitiers, soit 10-15 minutes en taxi pour environ 18 EUR." },
    ],
  ...
  station(
    ...
    "Centre de Perpignan", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "2 millions",
    [
      { name: "Centre-ville (Castillet)", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Perpignan-Rivesaltes", price: "15 EUR", time: "8-10 min" },
      { name: "Collioure", price: "30 EUR", time: "18-25 min" },
      { name: "Canet-en-Roussillon (plage)", price: "18 EUR", time: "10-15 min" },
      { name: "Barcelone (Espagne)", price: "250 EUR", time: "2h-2h30" },
    ],
    [
  ...
  station(
    ...
    "Centre de Caen", "3-8 min", "10 EUR",
    ["TER", "Intercités"],
    "4 millions",
    [
      { name: "Mémorial de Caen", price: "15 EUR", time: "8-12 min" },
      { name: "Plages du Débarquement", price: "65 EUR", time: "35-45 min" },
      { name: "Ouistreham (ferry)", price: "22 EUR", time: "12-18 min" },
      { name: "Deauville / Trouville", price: "80 EUR", time: "50 min-1h" },
      { name: "Bayeux", price: "40 EUR", time: "20-25 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Limoges", "3-8 min", "10 EUR",
    ["TER", "Intercités"],
    "3 millions",
    [
      { name: "Centre-ville", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Limoges-Bellegarde", price: "15 EUR", time: "8-12 min" },
      { name: "Oradour-sur-Glane", price: "35 EUR", time: "20-25 min" },
      { name: "Musée de la Porcelaine", price: "10 EUR", time: "5-8 min" },
      { name: "Brive-la-Gaillarde", price: "85 EUR", time: "55 min-1h05" },
    ],
    [
  ...
  station(
    ...
    "Centre d'Orléans", "3-8 min", "10 EUR",
    ["TER", "Intercités"],
    "5 millions",
    [
      { name: "Cathédrale Sainte-Croix", price: "8 EUR", time: "3-5 min" },
      { name: "Château de Chambord", price: "55 EUR", time: "30-40 min" },
      { name: "Blois", price: "55 EUR", time: "35-45 min" },
      { name: "Paris (Austerlitz)", price: "120 EUR", time: "1h10-1h30" },
      { name: "Aéroport CDG", price: "180 EUR", time: "1h30-2h" },
    ],
    [
    ...
    [
      { question: "Comment rejoindre Chambord depuis Orléans ?", answer: "Le forfait taxi Orléans-Chambord est d'environ 55 EUR, pour un trajet de 30-40 minutes." },
    ],
  ...
  station(
    ...
    "Centre de Mulhouse", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "4 millions",
    [
      { name: "Cité de l'Automobile", price: "10 EUR", time: "5-8 min" },
      { name: "EuroAirport Bâle-Mulhouse", price: "30 EUR", time: "20-25 min" },
      { name: "Colmar", price: "40 EUR", time: "25-30 min" },
      { name: "Bâle (Suisse)", price: "35 EUR", time: "20-25 min" },
      { name: "Fribourg (Allemagne)", price: "55 EUR", time: "35-45 min" },
    ],
    [
    ...
    [
      { question: "Peut-on prendre un taxi vers la Suisse ?", answer: "Oui, nos chauffeurs proposent des transferts vers Bâle (20-25 min, ~35 EUR) et l'EuroAirport (20-25 min, ~30 EUR)." },
    ],
  ...
  station(
    ...
    "Centre d'Amiens", "3-8 min", "10 EUR",
    ["TER", "Intercités"],
    "4 millions",
    [
      { name: "Cathédrale d'Amiens", price: "8 EUR", time: "3-5 min" },
      { name: "Hortillonnages", price: "10 EUR", time: "5-8 min" },
      { name: "Aéroport Beauvais-Tillé", price: "70 EUR", time: "45-55 min" },
      { name: "Baie de Somme", price: "60 EUR", time: "40-50 min" },
      { name: "Albert (Mémorial 14-18)", price: "35 EUR", time: "20-25 min" },
    ],
    [
    ...
    [
      { question: "Comment visiter la Baie de Somme ?", answer: "Le forfait taxi Amiens – Baie de Somme est d'environ 60 EUR, trajet de 40-50 minutes. Idéal pour voir les phoques." },
    ],
  ...
  station(
    ...
    "Centre de Besançon", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "3 millions",
    [
      { name: "Citadelle Vauban", price: "10 EUR", time: "5-8 min" },
      { name: "Besançon Franche-Comté TGV", price: "20 EUR", time: "10-15 min" },
      { name: "Pontarlier (frontière suisse)", price: "60 EUR", time: "40-50 min" },
      { name: "Belfort", price: "70 EUR", time: "45-55 min" },
      { name: "Dole", price: "50 EUR", time: "30-35 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de La Rochelle", "3-8 min", "10 EUR",
    ["TGV", "TER", "Intercités"],
    "2 millions",
    [
      { name: "Vieux-Port", price: "8 EUR", time: "3-5 min" },
      { name: "Aquarium de La Rochelle", price: "10 EUR", time: "5-8 min" },
      { name: "Île de Ré (pont)", price: "30 EUR", time: "20-25 min" },
      { name: "Aéroport La Rochelle-Laleu", price: "15 EUR", time: "8-12 min" },
      { name: "Royan", price: "80 EUR", time: "50 min-1h" },
    ],
    [
    ...
    [
      { question: "Comment rejoindre l'Île de Ré ?", answer: "Le forfait taxi La Rochelle – Île de Ré est d'environ 30 EUR (+ péage pont). Trajet de 20-25 minutes." },
    ],
  ...
  station(
    ...
    "Centre de Bayonne", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "2 millions",
    [
      { name: "Centre-ville (Cathédrale)", price: "8 EUR", time: "3-5 min" },
      { name: "Biarritz", price: "20 EUR", time: "10-15 min" },
      { name: "Aéroport Biarritz-Pays Basque", price: "22 EUR", time: "12-18 min" },
      { name: "Saint-Jean-de-Luz", price: "30 EUR", time: "18-25 min" },
      { name: "San Sebastián (Espagne)", price: "80 EUR", time: "45-55 min" },
    ],
    [
    ...
    [
      { question: "Peut-on prendre un taxi vers l'Espagne ?", answer: "Oui, le forfait taxi Bayonne – San Sebastián est d'environ 80 EUR, pour un trajet de 45-55 minutes." },
    ],
  ...
  station(
    ...
    "Centre de Chambéry", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "3 millions",
    [
      { name: "Centre-ville (Château)", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Chambéry-Savoie", price: "15 EUR", time: "8-12 min" },
      { name: "Courchevel", price: "120 EUR", time: "1h-1h15" },
      { name: "Val Thorens", price: "140 EUR", time: "1h15-1h30" },
      { name: "Lac du Bourget (Aix-les-Bains)", price: "25 EUR", time: "15-20 min" },
    ],
    [
    ...
    [
      { question: "Comment rejoindre les stations de ski depuis Chambéry ?", answer: "Nos chauffeurs proposent des transferts vers Courchevel (~120 EUR, 1h), Val Thorens (~140 EUR, 1h15), Méribel et les 3 Vallées. Véhicules équipés hiver." },
    ],
  ...
  station(
    ...
    "Centre de Cannes", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "3 millions",
    [
      { name: "La Croisette / Palais des Festivals", price: "10 EUR", time: "3-5 min" },
      { name: "Aéroport Nice Côte d'Azur", price: "85 EUR", time: "30-45 min" },
      { name: "Nice centre", price: "70 EUR", time: "30-40 min" },
      { name: "Monaco", price: "120 EUR", time: "50 min-1h" },
      { name: "Grasse (parfumeries)", price: "25 EUR", time: "15-20 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Versailles", "3-8 min", "10 EUR",
    ["TER", "RER", "Transilien"],
    "15 millions",
    [
      { name: "Château de Versailles", price: "10 EUR", time: "3-5 min" },
      { name: "Paris centre (Châtelet)", price: "40 EUR", time: "25-40 min" },
      { name: "Aéroport CDG", price: "75 EUR", time: "50 min-1h10" },
      { name: "Aéroport d'Orly", price: "40 EUR", time: "25-35 min" },
      { name: "La Défense", price: "30 EUR", time: "20-30 min" },
    ],
    [
  ...
  station(
    ...
    "Centre de Pau", "3-8 min", "10 EUR",
    ["TGV", "TER"],
    "1,5 million",
    [
      { name: "Boulevard des Pyrénées", price: "8 EUR", time: "3-5 min" },
      { name: "Aéroport Pau-Pyrénées", price: "18 EUR", time: "10-15 min" },
      { name: "Lourdes", price: "45 EUR", time: "30-35 min" },
      { name: "Biarritz", price: "90 EUR", time: "55 min-1h10" },
      { name: "Gave de Pau (rafting)", price: "20 EUR", time: "10-15 min" },
    ],
    [
    ...
    [
      { question: "Comment rejoindre Lourdes depuis Pau ?", answer: "Le forfait taxi Pau – Lourdes est d'environ 45 EUR, pour un trajet de 30-35 minutes." },
    ],
