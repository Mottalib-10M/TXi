...
export const predefinedLocations: PredefinedLocation[] = [
  {
    ...
    meetingPoint: {
      description:
        "Rendez-vous au parking principal de l'INSEAD, zone visiteurs près de l'entrée principale du campus (Boulevard de Constance). Le chauffeur vous attend devant le bâtiment d'accueil.",
