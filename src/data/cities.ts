...
export const cities: City[] = [
  ...
  city("Fontainebleau", "fontainebleau", 48.4010, 2.7024, 15000, [
    ...
    { text: "Always reliable for my airport transfers. Drivers speak English and know the area perfectly.", name: "J. K.", initials: "JK", role: "INSEAD" },
...
const cityContent: Record<string, { introFr: string; introEn: string; descriptionFr: string; descriptionEn: string; metaDescriptionFr: string; metaDescriptionEn: string; heroSubtitleFr: string; heroSubtitleEn: string; whyUsFr: { title: string; desc: string }[]; whyUsEn: { title: string; desc: string }[] }> = {
  ...
  "saint-cloud": {
    ...
    metaDescriptionFr: "Taxi à Saint-Cloud : Orly dès 40 €, CDG dès 70 €. Parc Le Nôtre, hippodrome, Garches et Boulogne. Prix fixe annoncé avant la réservation, chauffeurs 24h/24.",
  ...
  "ville-d-avray": {
    ...
    metaDescriptionFr: "Taxi à Châtillon : transfert Orly dès 25 €, CDG dès 60 €. Métro 13, Fort historique, Montrouge et Clamart. Tarif fixe annoncé avant la réservation, 24h/24.",
