...
export const cities: City[] = [
  ...
  ], ["saint-etienne", "lyon", "limoges", "dijon", "valence", "la-bourboule", "le-mont-dore", "murol", "chambon-sur-lac", "aydat", "orcival"], [
  ...
  // ── Villes touristiques Auvergne ─────────────────────────────
  city("La Bourboule", "la-bourboule", 45.5883, 2.7381, 1900, [
    "Thermes de La Bourboule", "Parc Fenestre", "Charlannes (ski)", "Casino de La Bourboule",
    "Musée de la Toinette", "Plateau de Charlannes", "Roche Vendeix",
  ], [
    "Centre-ville", "Les Thermes", "Charlannes", "Vendeix",
  ], [
    { from: "La Bourboule", to: "Le Mont-Dore", price: "15-20 €" },
    { from: "La Bourboule", to: "Clermont-Ferrand", price: "70-90 €" },
    { from: "La Bourboule", to: "Super Besse", price: "25-35 €" },
  ], ["clermont-ferrand", "le-mont-dore", "murol", "chambon-sur-lac", "aydat", "orcival"], [
    { text: "Taxi fiable pour rejoindre les thermes depuis la gare. Chauffeur très aimable.", name: "Monique L.", initials: "ML", role: "Curiste" },
    { text: "Transfert parfait depuis Clermont pour notre week-end ski à Charlannes.", name: "Julien P.", initials: "JP", role: "Skieur" },
    { text: "Service ponctuel en pleine montagne. Très appréciable.", name: "Catherine R.", initials: "CR", role: "Touriste" },
  ], [
    { question: "Y a-t-il des taxis disponibles à La Bourboule ?", answer: "Oui, TaxiNeo dessert La Bourboule avec des chauffeurs locaux connaissant parfaitement les routes de montagne. Nos véhicules circulent toute l'année, y compris en hiver lorsque les conditions routières sont difficiles. Réservation en ligne 24h/24 pour tous vos déplacements dans la station." },
    { question: "Combien coûte le taxi La Bourboule – Le Mont-Dore ?", answer: "Le trajet entre les deux stations thermales coûte entre 15 et 20 €, pour environ 10 km par la D130. La route est rapide et panoramique, longeant la Haute Dordogne. Nos chauffeurs effectuent ce trajet plusieurs fois par jour et connaissent chaque virage." },
    { question: "La Bourboule est-elle adaptée aux cures thermales pour enfants ?", answer: "Absolument, La Bourboule est la première station thermale de France pour les enfants. Les thermes Choussy-Lépine proposent des cures de trois semaines spécialisées dans les affections respiratoires et dermatologiques pédiatriques. Nos taxis sont équipés pour transporter familles avec poussettes et matériel médical entre hébergement et thermes." },
    { question: "Peut-on visiter le casino Belle Époque de La Bourboule ?", answer: "Le casino de La Bourboule, construit en 1891, est un joyau architectural Belle Époque ouvert au public. Il abrite des salles de jeux, un théâtre et des salons ornés. Nos chauffeurs vous y déposent en soirée et assurent le retour, même tard. Un incontournable pour les amateurs d'architecture du XIXe siècle." },
    { question: "Comment accéder à la station de ski de Charlannes depuis La Bourboule ?", answer: "Le plateau de Charlannes se trouve à 5 minutes en voiture du centre de La Bourboule. La route monte rapidement en altitude et peut être verglacée en hiver. Nos taxis équipés de pneus neige et chaînes vous y conduisent en toute sécurité, avec vos skis et équipements. Station familiale idéale avec pistes de ski alpin et de fond." },
    { question: "Quelle est la meilleure randonnée accessible en taxi depuis La Bourboule ?", answer: "La randonnée vers la Roche Vendeix est un incontournable : nos chauffeurs vous déposent au départ du sentier et vous rejoignent au retour. Le sommet offre un panorama spectaculaire sur la vallée de la Dordogne et le massif du Sancy. Comptez 2h30 aller-retour pour cette boucle de difficulté moyenne, parfaite en été." },
  ], 12, "15 min"),

  city("Le Mont-Dore", "le-mont-dore", 45.5736, 2.8097, 1300, [
    "Puy de Sancy", "Station de ski du Mont-Dore", "Thermes du Mont-Dore", "Salon du Capucin",
    "Funiculaire du Capucin", "Cascade de la Dore", "Grande Cascade",
  ], [
    "Centre-ville", "Les Thermes", "Sancy", "Le Capucin",
  ], [
    { from: "Le Mont-Dore", to: "Clermont-Ferrand", price: "65-85 €" },
    { from: "Le Mont-Dore", to: "La Bourboule", price: "15-20 €" },
    { from: "Le Mont-Dore", to: "Super Besse", price: "20-30 €" },
  ], ["clermont-ferrand", "la-bourboule", "murol", "chambon-sur-lac", "aydat", "orcival"], [
    { text: "Transfert parfait pour notre cure thermale au Mont-Dore. Le chauffeur connaît les routes de montagne.", name: "Bernard G.", initials: "BG", role: "Curiste" },
    { text: "Taxi idéal pour monter au Sancy. Pas besoin de se soucier du verglas.", name: "Stéphanie V.", initials: "SV", role: "Randonneuse" },
    { text: "Service fiable même en plein hiver pour rejoindre la station de ski.", name: "Nicolas T.", initials: "NT", role: "Skieur" },
  ], [
    { question: "Le taxi monte-t-il au Puy de Sancy ?", answer: "Le taxi vous dépose au pied du téléphérique du Sancy, à la station intermédiaire. De là, le sommet (1 886 m) est accessible en 4 minutes de téléphérique puis 20 minutes de marche. Nos chauffeurs vous attendent au parking pendant votre ascension et vous récupèrent à l'heure convenue pour le retour." },
    { question: "Y a-t-il des taxis en hiver au Mont-Dore ?", answer: "Oui, nos chauffeurs circulent toute l'année au Mont-Dore, y compris par temps de neige. Chaque véhicule est équipé de pneus neige homologués et de chaînes, indispensables sur la D996 et les accès aux pistes. Nous surveillons les bulletins météo du Sancy en permanence pour adapter nos itinéraires et garantir votre sécurité." },
    { question: "Peut-on visiter les thermes historiques du Mont-Dore ?", answer: "Les thermes du Mont-Dore sont un édifice néo-byzantin de 1891, ornés de fresques, mosaïques et colonnes de marbre. Des visites guidées sont proposées en été en dehors des heures de soins. Nos chauffeurs connaissent les horaires et vous déposent directement devant l'entrée monumentale. Un chef-d'œuvre architectural à ne pas manquer." },
    { question: "Le funiculaire du Capucin fonctionne-t-il toute l'année ?", answer: "Le funiculaire du Capucin, construit en 1898, fonctionne principalement en été et pendant les vacances scolaires. Il transporte les visiteurs sur 500 mètres jusqu'au Salon du Capucin, un belvédère panoramique exceptionnel. Nos taxis vous déposent à la gare de départ en bas et peuvent vous récupérer en haut ou en bas selon votre préférence." },
    { question: "Quelles cascades peut-on visiter en taxi depuis Le Mont-Dore ?", answer: "Le Mont-Dore compte plusieurs cascades remarquables : la Grande Cascade (32 m de haut), la Cascade de la Dore et la Cascade du Queureuilh. Nos chauffeurs proposent un circuit cascades d'une demi-journée avec dépose à chaque sentier d'accès. La Grande Cascade est la plus spectaculaire, surtout au printemps lors de la fonte des neiges." },
    { question: "Combien coûte un taxi Le Mont-Dore – Super Besse ?", answer: "Le trajet Le Mont-Dore – Super Besse coûte entre 20 et 30 € pour environ 20 km par la D36. La route offre des panoramas splendides sur le massif du Sancy. En hiver, ce trajet permet de combiner les deux domaines skiables. Nos chauffeurs équipés montagne assurent cette liaison quotidiennement, même par temps de neige." },
  ], 10, "15 min"),

  city("Murol", "murol", 45.5714, 2.9397, 550, [
    "Château de Murol", "Lac Chambon", "Plage du Lac Chambon", "Église Saint-Ferréol",
  ], [
    "Centre-village", "Lac Chambon", "Beaune-le-Froid",
  ], [
    { from: "Murol", to: "Clermont-Ferrand", price: "45-60 €" },
    { from: "Murol", to: "Le Mont-Dore", price: "20-30 €" },
    { from: "Murol", to: "Super Besse", price: "15-20 €" },
  ], ["clermont-ferrand", "la-bourboule", "le-mont-dore", "chambon-sur-lac", "aydat", "orcival"], [
    { text: "Taxi rapide depuis Clermont pour visiter le château de Murol avec les enfants.", name: "Sandrine D.", initials: "SD", role: "Maman en vacances" },
    { text: "Transfert vers le lac Chambon très pratique en été.", name: "Pierre M.", initials: "PM", role: "Vacancier" },
    { text: "Chauffeur ponctuel pour nous ramener à Clermont après la visite.", name: "Anne-Marie F.", initials: "AMF", role: "Touriste" },
  ], [
    { question: "Le château de Murol vaut-il le détour ?", answer: "Le château de Murol est l'un des châteaux médiévaux les mieux conservés d'Auvergne, classé Monument Historique. Il domine le village depuis un piton basaltique et offre un panorama exceptionnel. En été, des troupes de comédiens en armure animent des spectacles de chevalerie vivante : joutes, combats à l'épée et banquets médiévaux." },
    { question: "Quels sont les horaires des spectacles de chevaliers à Murol ?", answer: "Les spectacles de chevalerie au château de Murol se déroulent en juillet et août, généralement à 11h et 15h. Les représentations durent environ 45 minutes et sont accessibles à tous les âges. Nos chauffeurs connaissent les horaires précis et vous déposent au pied du château 30 minutes avant le début pour avoir les meilleures places." },
    { question: "Peut-on se baigner au lac Chambon près de Murol ?", answer: "Oui, le lac Chambon dispose de trois plages aménagées avec baignade surveillée de mi-juin à fin août. L'eau du lac, d'origine volcanique, atteint 22-24°C en été. Pédalos, canoës et stand-up paddles sont disponibles à la location. Nos taxis vous déposent directement à la plage de votre choix, évitant les parkings souvent saturés." },
    { question: "Y a-t-il du stationnement facile à Murol en été ?", answer: "Le stationnement à Murol est très difficile en été : le parking du château est limité à 80 places, complet dès le matin en haute saison. Les plages du lac Chambon connaissent le même problème. Le taxi TaxiNeo élimine totalement ce souci en vous déposant directement à destination et en revenant vous chercher à l'heure convenue." },
    { question: "Peut-on goûter le Saint-Nectaire fermier près de Murol ?", answer: "Oui, le hameau de Beaune-le-Froid, à 5 minutes de Murol, est l'un des berceaux du Saint-Nectaire fermier. Plusieurs fermes proposent des dégustations et de la vente directe. Nos chauffeurs vous y conduisent pour une halte gourmande entre la visite du château et la plage. Un complément gastronomique parfait à votre journée touristique." },
  ], 10, "15 min"),

  city("Chambon-sur-Lac", "chambon-sur-lac", 45.5736, 2.9222, 350, [
    "Lac Chambon", "Plage du Lac Chambon", "Église romane de Chambon",
    "Randonnées Vallée de Chaudefour",
  ], [
    "Centre-village", "Les Rives du Lac",
  ], [
    { from: "Chambon-sur-Lac", to: "Clermont-Ferrand", price: "50-65 €" },
    { from: "Chambon-sur-Lac", to: "Murol", price: "8-12 €" },
    { from: "Chambon-sur-Lac", to: "Le Mont-Dore", price: "20-28 €" },
  ], ["clermont-ferrand", "la-bourboule", "le-mont-dore", "murol", "aydat", "orcival"], [
    { text: "Transfert idéal pour rejoindre les rives du lac Chambon en famille.", name: "Valérie B.", initials: "VB", role: "Vacancière" },
    { text: "Service fiable pour la randonnée dans la Vallée de Chaudefour.", name: "Gilles R.", initials: "GR", role: "Randonneur" },
    { text: "Chauffeur serviable et connaissance parfaite des routes locales.", name: "Isabelle C.", initials: "IC", role: "Touriste" },
  ], [
    { question: "Le lac Chambon est-il accessible en taxi ?", answer: "Oui, le taxi vous dépose directement aux plages du lac Chambon sur la rive de Chambon-sur-Lac, plus calme et préservée que la rive de Murol. Baignade surveillée de mi-juin à fin août dans une eau agréablement tempérée par le sol volcanique. Nos chauffeurs connaissent les criques tranquilles accessibles à pied depuis le village." },
    { question: "Comment accéder à la réserve naturelle de Chaudefour en taxi ?", answer: "La réserve naturelle de la Vallée de Chaudefour est à 5 minutes en taxi depuis Chambon-sur-Lac. Son parking étant complet dès 9h en été, le taxi vous évite ce problème : nos chauffeurs vous déposent à l'entrée et reviennent vous chercher après votre randonnée. Le cirque glaciaire abrite chamois, mouflons et faucons pèlerins dans un cadre grandiose." },
    { question: "Quelles randonnées faire depuis Chambon-sur-Lac ?", answer: "Chambon-sur-Lac est un point de départ idéal pour la Vallée de Chaudefour (boucle de 3h), le Puy de Cacadogne (1 783 m, 4h aller-retour) et la Crête de Coq (1 785 m). Nos chauffeurs proposent un service unique de dépose et récupération à des points différents, vous évitant les boucles de retour. Ils connaissent les temps de marche et s'adaptent à votre rythme." },
    { question: "Chambon-sur-Lac est-il plus calme que Murol ?", answer: "Oui, Chambon-sur-Lac est la face sereine du lac Chambon. Alors que la rive de Murol concentre les activités touristiques et les familles, la rive de Chambon offre une ambiance paisible et contemplative. Le village compte 350 habitants et conserve une authenticité rurale. Idéal pour les visiteurs recherchant le calme, la nature préservée et les randonnées au cœur du Parc des Volcans." },
    { question: "Y a-t-il des transports en commun pour Chambon-sur-Lac ?", answer: "Non, Chambon-sur-Lac n'est desservi par aucune ligne de bus régulière. Le taxi est le seul moyen de transport pratique pour les visiteurs sans voiture. Nos chauffeurs TaxiNeo assurent des transferts quotidiens depuis Clermont-Ferrand (42 min), Murol (5 min) et Le Mont-Dore (20 min). Réservation en ligne disponible 24h/24 pour planifier sereinement vos déplacements." },
  ], 10, "15 min"),

  city("Aydat", "aydat", 45.6597, 2.9744, 2200, [
    "Lac d'Aydat", "Plage du Lac d'Aydat", "Base nautique d'Aydat",
    "Église romane d'Aydat", "Puy de la Vache",
  ], [
    "Centre-village", "Les Rives du Lac", "Fohet",
  ], [
    { from: "Aydat", to: "Clermont-Ferrand", price: "30-40 €" },
    { from: "Aydat", to: "Le Mont-Dore", price: "40-55 €" },
    { from: "Aydat", to: "Murol", price: "20-28 €" },
  ], ["clermont-ferrand", "la-bourboule", "le-mont-dore", "murol", "chambon-sur-lac", "orcival"], [
    { text: "Taxi pratique pour une journée au lac d'Aydat depuis Clermont. Le plus grand lac naturel d'Auvergne !", name: "François H.", initials: "FH", role: "Clermontois" },
    { text: "Transfert rapide et économique pour la base nautique.", name: "Laurence D.", initials: "LD", role: "Sportive" },
    { text: "Chauffeur agréable, bon conseil sur les activités du lac.", name: "Michel P.", initials: "MiP", role: "Touriste" },
  ], [
    { question: "Le lac d'Aydat est-il le plus grand lac d'Auvergne ?", answer: "Oui, le lac d'Aydat est le plus grand lac naturel d'Auvergne avec 65 hectares de surface. Formé il y a 8 600 ans par une coulée de lave du Puy de la Vache, il offre baignade surveillée, kayak, pédalo, stand-up paddle et pêche en été. La base nautique labellisée France Station Nautique propose des cours pour tous les niveaux." },
    { question: "Comment se rendre au Puy de la Vache depuis Aydat ?", answer: "Le Puy de la Vache se trouve au sud d'Aydat, accessible en 10 minutes de taxi jusqu'au parking de départ. La randonnée jusqu'aux cratères jumeaux (Puy de la Vache et Puy de Lassolas) est facile, environ 45 minutes aller. Le panorama à 360° embrasse toute la Chaîne des Puys UNESCO. Nos chauffeurs vous attendent au parking pendant la randonnée." },
    { question: "Peut-on faire du kayak et du paddle au lac d'Aydat ?", answer: "Oui, la base nautique d'Aydat propose la location de kayaks, pédalos, stand-up paddles et canoës de juin à septembre. Des cours d'initiation sont disponibles pour enfants et adultes. Nos taxis vous déposent directement à la base nautique, sur la rive sud du lac. Le retour en fin de journée est assuré à l'heure de votre choix." },
    { question: "Le lac d'Aydat est-il loin de Clermont-Ferrand ?", answer: "Aydat est le lac le plus proche de Clermont-Ferrand : seulement 25 km, soit 25 minutes en taxi par la D2089. Cette proximité en fait la destination nature préférée des Clermontois. Les week-ends d'été, la route est souvent embouteillée et les parkings saturés. Le taxi TaxiNeo vous évite ces désagréments avec une dépose directe à la plage." },
    { question: "Y a-t-il des événements au lac d'Aydat en été ?", answer: "Oui, le lac d'Aydat accueille des concerts en plein air, des marchés nocturnes et un spectaculaire feu d'artifice le 14 juillet. Ces événements attirent des milliers de visiteurs. Nos chauffeurs assurent les transferts aller-retour, y compris les retours tardifs après minuit. Réservation à l'avance recommandée pour le soir du 14 juillet et les concerts." },
    { question: "La pêche est-elle autorisée au lac d'Aydat ?", answer: "Oui, le lac d'Aydat est un site de pêche réputé pour le brochet, la perche, le sandre et la carpe. La pêche est possible avec un permis, en dehors des zones de baignade. Nos chauffeurs proposent des transferts matinaux dès 5h vers les rives les plus poissonneuses, loin des plages, pour les pêcheurs souhaitant profiter du calme de l'aube." },
  ], 12, "15 min"),

  city("Orcival", "orcival", 45.6822, 2.8450, 250, [
    "Basilique Notre-Dame d'Orcival", "Château de Cordès", "Randonnées Puy de Dôme",
    "Lac de Servières",
  ], [
    "Centre-village", "Le Bourg",
  ], [
    { from: "Orcival", to: "Clermont-Ferrand", price: "35-45 €" },
    { from: "Orcival", to: "Le Mont-Dore", price: "20-30 €" },
    { from: "Orcival", to: "La Bourboule", price: "20-30 €" },
  ], ["clermont-ferrand", "la-bourboule", "le-mont-dore", "murol", "chambon-sur-lac", "aydat"], [
    { text: "Taxi depuis Clermont pour visiter la basilique d'Orcival. Un joyau roman !", name: "Thérèse N.", initials: "TN", role: "Touriste" },
    { text: "Transfert vers le lac de Servières en été. Cadre magnifique.", name: "Alain S.", initials: "AS", role: "Randonneur" },
    { text: "Chauffeur ponctuel pour notre excursion dans le Parc des Volcans.", name: "Dominique J.", initials: "DJ", role: "Vacancier" },
  ], [
    { question: "La basilique d'Orcival est-elle remarquable ?", answer: "La basilique Notre-Dame d'Orcival est considérée comme l'un des cinq chefs-d'œuvre majeurs de l'art roman auvergnat. Sa Vierge en majesté, statue reliquaire en bois recouvert d'argent du XIIe siècle, attire des pèlerins depuis huit siècles. L'architecture extérieure avec son chevet à chapelles rayonnantes est un modèle d'harmonie romane." },
    { question: "Quand a lieu le pèlerinage d'Orcival ?", answer: "Le principal pèlerinage à Orcival se déroule le jeudi de l'Ascension, avec une procession aux flambeaux qui rassemble des milliers de fidèles dans les ruelles du village. Le 15 août attire également de nombreux pèlerins. Nos chauffeurs connaissent ces dates et assurent des transferts spéciaux depuis Clermont-Ferrand. Réservation à l'avance indispensable pour ces journées." },
    { question: "Peut-on visiter le château de Cordès à Orcival ?", answer: "Le château de Cordès, à 1 km de la basilique, ouvre ses portes au printemps et en été, certains jours seulement (généralement les week-ends et jours fériés). Ses jardins à la française dessinés par Le Nôtre sont surprenants en pleine montagne auvergnate. Nos chauffeurs connaissent le calendrier précis et organisent votre visite en conséquence." },
    { question: "Le lac de Servières est-il accessible en taxi ?", answer: "Oui, nos chauffeurs vous conduisent au lac de Servières par une route étroite et sinueuse que beaucoup de visiteurs hésitent à emprunter en voiture personnelle. Ce lac de cratère à 1 200 m d'altitude est interdit à la baignade pour préserver son écosystème. Le tour du lac à pied prend environ 1 heure. Nos chauffeurs patientent au parking pendant votre promenade." },
    { question: "Existe-t-il un circuit des églises romanes d'Auvergne en taxi ?", answer: "Oui, nos chauffeurs proposent un circuit d'une journée reliant les cinq églises romanes majeures d'Auvergne : départ d'Orcival, puis Saint-Nectaire, Issoire (Saint-Austremoine), Saint-Saturnin et Notre-Dame-du-Port à Clermont-Ferrand. Mise à disposition avec temps d'arrêt à chaque site. Une immersion exceptionnelle dans huit siècles d'architecture sacrée en pierre volcanique." },
    { question: "Orcival est-il desservi par les transports en commun ?", answer: "Non, aucun bus ne dessert Orcival. Le village est accessible uniquement en voiture ou en taxi. La D941 depuis Clermont-Ferrand traverse de magnifiques forêts de hêtres et de sapins sur 30 km. Nos chauffeurs TaxiNeo assurent des transferts quotidiens et des excursions combinées avec le Puy de Dôme (20 min), La Bourboule (20 min) et le lac de Guéry (15 min)." },
  ], 10, "15 min"),
  ...
  city("Fontainebleau", "fontainebleau", 48.4010, 2.7024, 15000, [
    "Château de Fontainebleau", "Forêt domaniale (25 000 ha)", "Éditeur de calculateurs et de guides pratiques",
    ...
    { text: "Always reliable for my airport transfers. Drivers speak English and know the area perfectly.", name: "J. K.", initials: "JK", role: "Éditeur de calculateurs et de guides pratiques" },
    ...
    { question: "Transfert Éditeur de calculateurs et de guides pratiques ?", answer: "Oui, campus principal et campus town, service anglophone. Nos chauffeurs connaissent les horaires des sessions MBA." },
  ...
  city("Avon", "avon", 48.4033, 2.7206, 12000, [
    ...
    "Marché d'Avon", "Éditeur de calculateurs et de guides pratiques (commune voisine)", "Rochers d'Avon",
  ], [
    ...
    { text: "Service fiable pour mes déplacements Éditeur de calculateurs et de guides pratiques. Chauffeurs anglophones, véhicules propres.", name: "A. S.", initials: "AS", role: "Cadre Éditeur de calculateurs et de guides pratiques" },
  ], [
  ...
  city("Saint-Denis", "saint-denis", 48.9362, 2.3574, 113000, ["Stade de France", "Basilique cathédrale de Saint-Denis", "Gare de Saint-Denis", "Université Paris 8", "Hôpital Delafontaine", "Théâtre Gérard-Philipe CDN", "Marché de Saint-Denis", "Cité du Cinéma", "Canal Saint-Denis", "Piscine olympique", "Mairie de Saint-Denis", "Musée d'Art et d'Histoire", "Parc de la Légion d'honneur", "Gare RER D Saint-Denis", "Médiathèque Centre-ville"], ["Centre-ville", "Pleyel", "Franc-Moisin", "La Plaine Saint-Denis", "Floréal", "Cosmonautes", "Basilique", "Mutualité", "Joliot-Curie", "Sémard", "Allende", "Porte de Paris"], [{ from: "Saint-Denis", to: "Paris", price: "20-30 €" }, { from: "Saint-Denis", to: "CDG", price: "35-50 €" }, { from: "Saint-Denis", to: "Orly", price: "45-60 €" }, { from: "Saint-Denis", to: "Stade de France", price: "8-12 €" }, { from: "Saint-Denis", to: "La Défense", price: "30-40 €" }], ["aubervilliers", "epinay-sur-seine", "saint-ouen-sur-seine", "pantin", "paris"], [{ text: "Taxi rapide après le match au Stade de France. Chauffeur efficace, pas d'attente.", name: "Mehdi B.", initials: "MB", role: "Résident" }, { text: "Transfert CDG impeccable depuis Pleyel, 25 min porte-à-porte.", name: "Corinne L.", initials: "CL", role: "Résidente" }, { text: "Service fiable pour mes trajets quotidiens vers Paris.", name: "Amadou D.", initials: "AD", role: "Résident" }], [{ question: "Stade de France ?", answer: "Le Stade de France (80 000 places) est desservi par nos taxis. Prise en charge et dépose aux portes du stade." }, { question: "Basilique de Saint-Denis ?", answer: "Nécropole des rois de France, chef-d'œuvre gothique. Nos chauffeurs vous y déposent directement." }, { question: "Accès CDG depuis Saint-Denis ?", answer: "Saint-Denis est à 20 min de CDG via l'A1. Tarif fixe garanti avec TaxiNeo." }], 35, "8 min"),

  city("Montreuil", "montreuil", 48.8638, 2.4433, 109000, ["Mairie de Montreuil", "Théâtre de la Girandole", "Hôpital André Grégoire", "Murs à pêches", "Parc des Beaumonts", "Marché de Montreuil", "Studios de cinéma de Montreuil", "Centre commercial Croix de Chavaux", "Église Saint-Pierre-Saint-Paul", "La Parole Errante", "Parc Montreau", "Bibliothèque Robert Desnos", "Nouveau Théâtre de Montreuil CDN", "Quartier de la Mairie", "Conservatoire de musique"], ["Croix de Chavaux", "La Noue", "Signac", "Villiers-Barbusse", "Ramenas", "Bel-Air", "Étienne-Marcel", "Boissière", "Solidarité-Carnot", "Centre-ville", "Bas-Montreuil", "Haut-Montreuil"], [{ from: "Montreuil", to: "Paris", price: "18-28 €" }, { from: "Montreuil", to: "CDG", price: "45-60 €" }, { from: "Montreuil", to: "Orly", price: "40-55 €" }, { from: "Montreuil", to: "Vincennes", price: "10-15 €" }, { from: "Montreuil", to: "Noisy-le-Grand", price: "18-25 €" }], ["pantin", "bobigny", "bondy", "noisy-le-grand", "paris"], [{ text: "Transfert CDG fiable depuis le Bas-Montreuil. Chauffeur sympa et ponctuel.", name: "Julien R.", initials: "JR", role: "Résident" }, { text: "Taxi pris après un spectacle au CDN, retour rapide à la maison.", name: "Fatou S.", initials: "FS", role: "Résidente" }, { text: "Service parfait pour mes déplacements professionnels.", name: "Grégoire P.", initials: "GP", role: "Résident" }], [{ question: "Murs à pêches ?", answer: "Site patrimonial unique : anciens murs de culture de pêches du XVIIe siècle, aujourd'hui espace culturel et jardins partagés." }, { question: "Accès métro ?", answer: "Montreuil est desservie par les lignes 1 (Saint-Mandé), 9 (Croix de Chavaux, Mairie de Montreuil, Robespierre) et le futur métro 11." }], 33, "8 min"),

  city("Aubervilliers", "aubervilliers", 48.9146, 2.3828, 87000, ["Campus Condorcet", "Fort d'Aubervilliers", "Canal Saint-Denis", "Théâtre de la Commune CDN", "Métro 12 Front Populaire", "Magasins Généraux", "Stade nautique Maurice Thorez", "Marché des Quatre-Chemins", "Parc Stalingrad", "Église Notre-Dame-des-Vertus", "Piscine de la Villette", "ZAC du Fort", "Mairie d'Aubervilliers", "Entrepôts et Magasins généraux", "Cité Émile-Dubois"], ["Centre-ville", "Quatre-Chemins", "Villette", "Landy", "Fort d'Aubervilliers", "Robespierre", "Émile-Dubois", "Maladrerie", "Pont-Blanc", "Canal"], [{ from: "Aubervilliers", to: "Paris", price: "18-28 €" }, { from: "Aubervilliers", to: "CDG", price: "35-50 €" }, { from: "Aubervilliers", to: "Orly", price: "45-60 €" }, { from: "Aubervilliers", to: "La Défense", price: "35-45 €" }, { from: "Aubervilliers", to: "Saint-Denis", price: "10-15 €" }], ["saint-denis", "pantin", "drancy", "bobigny", "paris"], [{ text: "Depuis le Campus Condorcet, taxi vers CDG en 25 min. Très pratique !", name: "Sophie T.", initials: "ST", role: "Universitaire" }, { text: "Prise en charge rapide aux Quatre-Chemins, chauffeur courtois.", name: "Ibrahim K.", initials: "IK", role: "Résident" }, { text: "Service fiable, je recommande pour les aéroports.", name: "Marie-Claire D.", initials: "MD", role: "Résidente" }], [{ question: "Campus Condorcet ?", answer: "Nouveau campus de sciences humaines (Paris 1, EHESS, EPHE...) ouvert en 2019, desservi par le métro 12." }, { question: "Fort d'Aubervilliers ?", answer: "Ancien fort militaire en cours de reconversion en parc urbain de 7 ha avec la future gare du Grand Paris Express." }], 25, "9 min"),

  city("Aulnay-sous-Bois", "aulnay-sous-bois", 48.9387, 2.4946, 86000, ["Gare RER B Aulnay-sous-Bois", "Parc Robert Ballanger", "Centre commercial O'Parinor", "Église Saint-Sulpice", "Parc Dumont", "Hôpital Robert Ballanger", "Canal de l'Ourcq", "Rosarium", "Vélodrome", "Mairie d'Aulnay-sous-Bois", "Zone industrielle PSA (ex)", "Piscine Dumont", "Médiathèque Dumont", "Gare du Vert-Galant", "Stade de la Motte"], ["Centre-ville", "Rose des Vents", "Merisiers", "Gros Saule", "Balagny", "Vieux Pays", "Ambourget", "Nonneville", "Chanteloup", "Mitry", "Savigny", "Europe"], [{ from: "Aulnay-sous-Bois", to: "Paris", price: "35-50 €" }, { from: "Aulnay-sous-Bois", to: "CDG", price: "20-30 €" }, { from: "Aulnay-sous-Bois", to: "Orly", price: "55-75 €" }, { from: "Aulnay-sous-Bois", to: "Le Bourget", price: "12-18 €" }, { from: "Aulnay-sous-Bois", to: "Villepinte Parc Expo", price: "10-15 €" }], ["sevran", "le-blanc-mesnil", "drancy", "bondy", "paris"], [{ text: "CDG en 15 min depuis Aulnay, imbattable !", name: "Hassan M.", initials: "HM", role: "Résident" }, { text: "Taxi fiable pour mon trajet quotidien vers Paris.", name: "Véronique C.", initials: "VC", role: "Résidente" }, { text: "Service ponctuel, chauffeur agréable.", name: "Thierry N.", initials: "TN", role: "Résident" }], [{ question: "Proximité CDG ?", answer: "Aulnay-sous-Bois est à seulement 10 km de l'aéroport CDG. Nos taxis y accèdent en 15 min via l'A3/A1." }, { question: "O'Parinor ?", answer: "Centre commercial de 200 boutiques situé à la limite nord d'Aulnay, accessible en taxi en 5 min." }], 25, "9 min"),

  city("Drancy", "drancy", 48.9275, 2.4497, 72000, ["Mémorial de la Shoah – Drancy", "Gare RER B Le Bourget-Drancy", "Cité de la Muette", "Parc de Ladoucette", "Mairie de Drancy", "Aéroport du Bourget", "Hôpital Avicenne", "Marché du centre", "Église Saint-Germain-l'Auxerrois", "Stade Charles Sage", "Groupe scolaire Joliot-Curie", "Parc du château de Ladoucette", "Canal de l'Ourcq", "Musée de l'Air proche", "Cinéma Le Select"], ["Centre-ville", "La Muette", "Paris-Campagne", "Village Parisien", "Économie-Gaston Roulaud", "Marcel Cachin", "Bobigny-Drancy", "Les Oiseaux", "La Mare", "Le Petit Drancy"], [{ from: "Drancy", to: "Paris", price: "30-40 €" }, { from: "Drancy", to: "CDG", price: "25-35 €" }, { from: "Drancy", to: "Orly", price: "50-65 €" }, { from: "Drancy", to: "Le Bourget Aéroport", price: "8-12 €" }, { from: "Drancy", to: "Bobigny Préfecture", price: "8-12 €" }], ["bobigny", "le-blanc-mesnil", "aulnay-sous-bois", "aubervilliers", "bondy"], [{ text: "CDG en 20 min, prix fixe respecté. Très satisfait.", name: "Olivier G.", initials: "OG", role: "Résident" }, { text: "Taxi réservé pour Le Bourget aviation, chauffeur ponctuel.", name: "Nadia F.", initials: "NF", role: "Résidente" }, { text: "Service rapide et fiable, je recommande.", name: "Patrick V.", initials: "PV", role: "Résident" }], [{ question: "Mémorial de la Shoah ?", answer: "Le Mémorial de la Shoah de Drancy, face à la Cité de la Muette, retrace l'histoire du camp d'internement. Entrée libre." }, { question: "Aéroport du Bourget ?", answer: "L'aéroport du Bourget (aviation d'affaires, Musée de l'Air) est à 5 min de Drancy. Nos taxis assurent les transferts." }], 20, "10 min"),

  city("Noisy-le-Grand", "noisy-le-grand", 48.8489, 2.5528, 69000, ["Les Arènes de Picasso", "Palacio d'Abraxas", "Centre commercial Les Arcades", "Gare RER A Noisy-le-Grand Mont d'Est", "Université Gustave Eiffel", "Lac de la Butte Verte", "Pavé de Moulins", "Mairie de Noisy-le-Grand", "Espace Michel Simon", "Parc de la Butte Verte", "Hôpital de Marne-la-Vallée proche", "Gare RER A Noisy-Champs", "Centre commercial Le Champy", "ZAC du Clos aux Biches", "Église Saint-Sulpice"], ["Mont d'Est", "Champy", "Hauts Bâtons", "Pavé Neuf", "Les Richardets", "Centre-ville", "Maille Nord", "Butte Verte", "Clos aux Biches", "Le Perreux proche", "Victor Hugo", "Noisy-Champs"], [{ from: "Noisy-le-Grand", to: "Paris", price: "35-50 €" }, { from: "Noisy-le-Grand", to: "CDG", price: "45-60 €" }, { from: "Noisy-le-Grand", to: "Orly", price: "45-60 €" }, { from: "Noisy-le-Grand", to: "Marne-la-Vallée", price: "15-22 €" }, { from: "Noisy-le-Grand", to: "Chelles", price: "15-22 €" }], ["montreuil", "bondy", "chelles", "paris", "creteil"], [{ text: "Taxi depuis Mont d'Est vers CDG, rapide et confortable.", name: "Anne-Sophie M.", initials: "AM", role: "Résidente" }, { text: "Service impeccable pour mes trajets vers Paris depuis le Champy.", name: "Rachid H.", initials: "RH", role: "Résident" }, { text: "Chauffeur ponctuel, véhicule propre. Je recommande.", name: "Élodie B.", initials: "EB", role: "Résidente" }], [{ question: "Arènes de Picasso ?", answer: "Ensemble architectural post-moderne de Manolo Nuñez-Yanowsky (1985), disques monumentaux emblématiques de Noisy-le-Grand." }, { question: "Palacio d'Abraxas ?", answer: "Ensemble monumental de Ricardo Bofill (1983), décor du film Brazil et de Hunger Games." }], 18, "10 min"),

  city("Le Blanc-Mesnil", "le-blanc-mesnil", 48.9437, 2.4614, 56000, ["Aéroport du Bourget", "Musée de l'Air et de l'Espace", "Parc Jacques Duclos", "Stade de France proche", "Gare RER B Le Blanc-Mesnil", "Parc Fontaine-Cypierre", "Centre culturel Pablo-Neruda", "Mairie du Blanc-Mesnil", "Marché du centre", "Parc des Expositions du Bourget", "Canal de l'Ourcq", "Hôpital Avicenne proche", "Gymnase Jesse Owens", "Stade Nelson Mandela", "Zone d'activités des Merisiers"], ["Centre-ville", "Pont-Yblon", "Les Tilleuls", "Gagarine", "Les Hautes Mardelles", "Quartier du Nord", "Terres-Saint-Blaise", "Lallier", "Aviation", "Étoile-Molière"], [{ from: "Le Blanc-Mesnil", to: "Paris", price: "30-45 €" }, { from: "Le Blanc-Mesnil", to: "CDG", price: "20-30 €" }, { from: "Le Blanc-Mesnil", to: "Orly", price: "50-70 €" }, { from: "Le Blanc-Mesnil", to: "Le Bourget Musée", price: "5-10 €" }, { from: "Le Blanc-Mesnil", to: "Villepinte Parc Expo", price: "12-18 €" }], ["drancy", "aulnay-sous-bois", "bobigny", "bondy", "sevran"], [{ text: "CDG en 15 min, parfait pour les vols tôt le matin.", name: "Moussa T.", initials: "MT", role: "Résident" }, { text: "Taxi pris après le salon du Bourget, retour rapide.", name: "Florence D.", initials: "FD", role: "Résidente" }, { text: "Chauffeur aimable, prix respecté.", name: "Bruno P.", initials: "BP", role: "Résident" }], [{ question: "Musée de l'Air ?", answer: "Le Musée de l'Air et de l'Espace au Bourget est à 5 min du Blanc-Mesnil. Entrée gratuite, avions mythiques exposés." }, { question: "Proximité CDG ?", answer: "Le Blanc-Mesnil est à 12 km de CDG. Nos taxis font le trajet en 15-20 min via l'A1." }], 14, "10 min"),

  city("Pantin", "pantin", 48.8937, 2.4042, 56000, ["Canal de l'Ourcq", "Centre national de la Danse (CND)", "Grands Moulins de Pantin", "Magasins Généraux (BETC)", "Gare RER E Pantin", "Métro 5 Hoche / Église de Pantin", "Cité Descartes proche", "Philharmonie de Paris proche", "Parc de la Villette proche", "Cimetière parisien de Pantin", "Mairie de Pantin", "Église Saint-Germain", "Centre commercial Bréguet", "Les Docks de Pantin", "Studio d'Aubervilliers proche"], ["Centre-ville", "Quatre-Chemins", "Hoche", "Courtillières", "Les Grands Moulins", "Petit Pantin", "Docks", "Village", "Mairie", "Canal"], [{ from: "Pantin", to: "Paris", price: "15-25 €" }, { from: "Pantin", to: "CDG", price: "40-55 €" }, { from: "Pantin", to: "Orly", price: "40-55 €" }, { from: "Pantin", to: "Gare du Nord", price: "12-18 €" }, { from: "Pantin", to: "La Villette", price: "8-12 €" }], ["aubervilliers", "bobigny", "montreuil", "bondy", "paris"], [{ text: "Transfert CDG depuis les Grands Moulins, rapide et pro.", name: "Lucas V.", initials: "LV", role: "Résident" }, { text: "Taxi fiable après un spectacle au CND, chauffeur très ponctuel.", name: "Amandine R.", initials: "AR", role: "Résidente" }, { text: "Service parfait pour rejoindre la Gare du Nord.", name: "Karim E.", initials: "KE", role: "Résident" }], [{ question: "Centre national de la Danse ?", answer: "Le CND, installé dans l'ancien centre administratif de Pantin, est un lieu de création et diffusion de la danse contemporaine." }, { question: "Canal de l'Ourcq ?", answer: "Le canal traverse Pantin et offre des promenades, péniches, restaurants et pistes cyclables." }], 14, "9 min"),

  city("Épinay-sur-Seine", "epinay-sur-seine", 48.9536, 2.3078, 55000, ["Bords de Seine", "Île de la Jatte Nord", "Gare d'Épinay-sur-Seine (Transilien H)", "Gare d'Épinay-Villetaneuse (RER C)", "Marché d'Épinay", "Mairie d'Épinay-sur-Seine", "Parc Lacépède", "Cinéma L'Écran", "Stade municipal", "Centre commercial", "Église Notre-Dame-des-Missions", "Quartier Orgemont", "Tramway T8", "Centre nautique", "Parc des Beatus"], ["Centre-ville", "Orgemont", "La Source", "Les Presles", "Lacépède", "Pont de Bezons", "Gros Buisson", "Cygne d'Enghien", "Blumenthal", "Quétigny"], [{ from: "Épinay-sur-Seine", to: "Paris", price: "28-38 €" }, { from: "Épinay-sur-Seine", to: "CDG", price: "30-45 €" }, { from: "Épinay-sur-Seine", to: "Orly", price: "50-65 €" }, { from: "Épinay-sur-Seine", to: "Saint-Denis", price: "10-15 €" }, { from: "Épinay-sur-Seine", to: "Argenteuil", price: "10-15 €" }], ["saint-denis", "saint-ouen-sur-seine", "argenteuil", "gennevilliers", "aubervilliers"], [{ text: "Taxi rapide pour CDG depuis Orgemont. Prix fixe respecté.", name: "Christelle M.", initials: "CM", role: "Résidente" }, { text: "Prise en charge à la gare, transfert Paris impeccable.", name: "Jean-Paul B.", initials: "JB", role: "Résident" }, { text: "Service fiable pour mes trajets vers CDG.", name: "Samira K.", initials: "SK", role: "Résidente" }], [{ question: "Accès CDG ?", answer: "Épinay est à 20 km de CDG. Nos taxis empruntent l'A86 puis l'A1 pour un trajet de 25 min environ." }, { question: "Bords de Seine ?", answer: "Épinay offre des promenades agréables le long de la Seine, avec vue sur l'Île de la Jatte." }], 14, "10 min"),

  city("Bobigny", "bobigny", 48.9096, 2.4401, 54000, ["Préfecture de Seine-Saint-Denis", "MC93 (Maison de la Culture)", "Tribunal judiciaire de Bobigny", "Canal de l'Ourcq", "Tramway T1", "Hôpital Avicenne", "Gare RER E Bobigny", "Parc départemental de la Bergère", "Bourse départementale du Travail", "Église Saint-André", "Stade Géo André", "Médiathèque", "Parc de la Fosse aux Aulnes", "Centre commercial Bobigny 2", "Mairie de Bobigny"], ["Centre-ville", "Pont de Pierre", "Karl Marx", "Grémillon", "Paul Éluard", "Jean Rostand", "Chemin Vert", "L'Abreuvoir", "Canal", "Auguste Delaune"], [{ from: "Bobigny", to: "Paris", price: "25-35 €" }, { from: "Bobigny", to: "CDG", price: "30-45 €" }, { from: "Bobigny", to: "Orly", price: "45-60 €" }, { from: "Bobigny", to: "Tribunal", price: "5-10 €" }, { from: "Bobigny", to: "Le Bourget", price: "10-15 €" }], ["drancy", "pantin", "aubervilliers", "bondy", "montreuil"], [{ text: "Taxi vers le tribunal de Bobigny, ponctuel et professionnel.", name: "Maître Dupont A.", initials: "DA", role: "Avocat" }, { text: "Transfert CDG depuis la préfecture, rapide via l'A3.", name: "Stéphanie R.", initials: "SR", role: "Résidente" }, { text: "Service fiable pour mes déplacements depuis Avicenne.", name: "Dr. Martin L.", initials: "ML", role: "Médecin" }], [{ question: "Préfecture 93 ?", answer: "Bobigny est le chef-lieu de la Seine-Saint-Denis. La préfecture et le tribunal judiciaire y siègent." }, { question: "MC93 ?", answer: "La MC93 est un théâtre national de référence pour la création contemporaine, salle de 900 places." }], 14, "10 min"),

  city("Bondy", "bondy", 48.9020, 2.4832, 53000, ["Forêt de Bondy", "Gare RER E Bondy", "Canal de l'Ourcq", "Église Saint-Pierre", "Parc de la Mairie", "Centre commercial", "Stade Léo Lagrange", "Mairie de Bondy", "Médiathèque", "Piscine municipale", "Parc Mainguy", "Marché de Bondy", "Groupe scolaire Pasteur", "Centre culturel André Malraux", "Passerelle du canal"], ["Centre-ville", "Terre Saint-Blaise", "Quartier Nord", "Mainguy", "Le Pont de Bondy", "Les Ruffins", "Bobillot", "La Sablière", "Vert-Galant", "Les Coutures", "Blancs-Vilains"], [{ from: "Bondy", to: "Paris", price: "30-42 €" }, { from: "Bondy", to: "CDG", price: "30-42 €" }, { from: "Bondy", to: "Orly", price: "50-65 €" }, { from: "Bondy", to: "Aulnay-sous-Bois", price: "12-18 €" }, { from: "Bondy", to: "Bobigny", price: "8-12 €" }], ["bobigny", "drancy", "aulnay-sous-bois", "noisy-le-grand", "montreuil"], [{ text: "CDG en 20 min depuis Bondy, chauffeur ponctuel.", name: "Yannick S.", initials: "YS", role: "Résident" }, { text: "Transfert Paris rapide via l'A3, prix fixe.", name: "Fatima A.", initials: "FA", role: "Résidente" }, { text: "Bon service, chauffeur courtois et véhicule propre.", name: "Dominique L.", initials: "DL", role: "Résident" }], [{ question: "Forêt de Bondy ?", answer: "Vestige de l'ancienne forêt royale, la forêt régionale de Bondy offre 170 ha de promenades boisées." }, { question: "Canal de l'Ourcq ?", answer: "Le canal traverse Bondy et offre un chemin de halage agréable pour les promenades et le vélo." }], 13, "10 min"),

  city("Sevran", "sevran", 48.9448, 2.5285, 52000, ["Gare RER B Sevran-Beaudottes", "Gare RER B Sevran-Livry", "Parc forestier de la Poudrerie", "Canal de l'Ourcq", "Fort de Vaujours proche", "Mairie de Sevran", "Centre commercial Beau Sevran", "Marché de Sevran", "Piscine Olivier Girault", "Église Sainte-Marie-Madeleine", "Parc Dumont", "Stade Léo Lagrange", "Médiathèque", "Centre de santé municipal", "Zone d'activités de Montceleux"], ["Centre-ville", "Beaudottes", "Pont-Blanc", "Montceleux", "Rougemont", "Les Sablons", "Freinville", "La Poudrerie", "Les Trèfles", "Livry-Gargan proche"], [{ from: "Sevran", to: "Paris", price: "40-55 €" }, { from: "Sevran", to: "CDG", price: "18-28 €" }, { from: "Sevran", to: "Orly", price: "60-80 €" }, { from: "Sevran", to: "Le Bourget", price: "12-18 €" }, { from: "Sevran", to: "Aulnay-sous-Bois", price: "8-12 €" }], ["aulnay-sous-bois", "le-blanc-mesnil", "drancy", "bondy", "villeparisis"], [{ text: "CDG en 12 min depuis Sevran, parfait pour les vols matinaux.", name: "Abdelkader N.", initials: "AN", role: "Résident" }, { text: "Taxi fiable malgré l'heure tardive. Merci TaxiNeo.", name: "Caroline J.", initials: "CJ", role: "Résidente" }, { text: "Service ponctuel et prix raisonnable.", name: "Michel G.", initials: "MG", role: "Résident" }], [{ question: "Parc de la Poudrerie ?", answer: "Ancien site de fabrication de poudre, aujourd'hui parc forestier de 137 ha classé Natura 2000. Promenades, faune et flore remarquables." }, { question: "Proximité CDG ?", answer: "Sevran est à 10 km de CDG. Nos taxis y accèdent en 12-15 min via la Francilienne/A104." }], 13, "10 min"),

  city("Saint-Ouen-sur-Seine", "saint-ouen-sur-seine", 48.9115, 2.3331, 52000, ["Marché aux Puces de Saint-Ouen", "Docks de Saint-Ouen", "Stade Bauer (Red Star FC)", "Métro 14 Mairie de Saint-Ouen", "Seine", "Hôpital Bichat proche", "Mairie de Saint-Ouen", "Parc François Mitterrand", "Cimetière parisien de Saint-Ouen", "Gare RER C Saint-Ouen", "Rue des Rosiers (Puces)", "Centre commercial", "Île des Vannes", "Théâtre de Saint-Ouen", "Médiathèque Persépolis"], ["Centre-ville", "Vieux Saint-Ouen", "Marché aux Puces", "Les Docks", "Michelet", "Victor Hugo", "Debain", "Rosiers", "Arago-Zola", "Cordon"], [{ from: "Saint-Ouen-sur-Seine", to: "Paris", price: "15-25 €" }, { from: "Saint-Ouen-sur-Seine", to: "CDG", price: "38-52 €" }, { from: "Saint-Ouen-sur-Seine", to: "Orly", price: "45-60 €" }, { from: "Saint-Ouen-sur-Seine", to: "Saint-Denis", price: "8-12 €" }, { from: "Saint-Ouen-sur-Seine", to: "Clichy", price: "8-12 €" }], ["saint-denis", "epinay-sur-seine", "clichy", "paris", "aubervilliers"], [{ text: "Taxi après les Puces avec mes achats, chauffeur patient et serviable.", name: "Isabelle P.", initials: "IP", role: "Chineuse" }, { text: "Transfert CDG depuis les Docks, rapide via l'A86/A1.", name: "Thomas B.", initials: "TB", role: "Résident" }, { text: "Service professionnel, véhicule spacieux pour mes meubles chinés.", name: "André F.", initials: "AF", role: "Antiquaire" }], [{ question: "Marché aux Puces ?", answer: "Plus grand marché d'antiquités au monde (7 ha, 1 700 marchands). Nos taxis vous y déposent et récupèrent avec vos achats." }, { question: "Métro 14 ?", answer: "Le prolongement de la ligne 14 dessert Mairie de Saint-Ouen, offrant un accès rapide à Paris. Le taxi reste idéal pour les aéroports." }], 13, "9 min"),

  // ─── 94 – Val-de-Marne ──────────────────────────────

  city("Vitry-sur-Seine", "vitry-sur-seine", 48.7875, 2.3928, 94000, ["Gare de Vitry-sur-Seine", "MAC VAL (Musée d'Art Contemporain)", "Hôpital Paul-Brousse", "Port à l'Anglais", "Parc des Lilas", "Centre commercial Grand Vitry", "Théâtre Jean-Vilar", "Église Saint-Germain", "Marché du dimanche", "Exploradôme", "Centrale EDF", "Stade Lénine", "Parc du Coteau", "Médiathèque Nelson-Mandela", "ZAC Gare Ardoines"], ["Centre-ville", "Port à l'Anglais", "Le Plateau", "Les Ardoines", "Moulin Vert", "Les Malassis", "Coteau", "Commune de Paris", "Paul Vaillant-Couturier", "Balzac", "Stalingrad", "Petit Ivry"], [{ from: "Vitry-sur-Seine", to: "Paris", price: "25-35 €" }, { from: "Vitry-sur-Seine", to: "Orly", price: "20-30 €" }, { from: "Vitry-sur-Seine", to: "CDG", price: "60-80 €" }, { from: "Vitry-sur-Seine", to: "Créteil", price: "15-20 €" }, { from: "Vitry-sur-Seine", to: "Villejuif", price: "12-18 €" }], ["ivry-sur-seine", "villejuif", "creteil", "maisons-alfort", "paris"], [{ text: "Transfert Orly rapide depuis Vitry, 20 minutes porte à porte.", name: "Rachid B.", initials: "RB", role: "Résident" }, { text: "Taxi réservé pour le MAC VAL, chauffeur ponctuel et aimable.", name: "Catherine L.", initials: "CL", role: "Résidente" }, { text: "Service fiable pour mes allers-retours à l'hôpital Paul-Brousse.", name: "André M.", initials: "AM", role: "Patient régulier" }], [{ question: "MAC VAL ?", answer: "Le Musée d'Art Contemporain du Val-de-Marne est le premier musée dédié à la scène artistique française depuis 1950. Entrée libre." }, { question: "Gare des Ardoines ?", answer: "Future gare du Grand Paris Express (ligne 15 Sud), elle transformera le quartier en pôle multimodal majeur." }, { question: "Taxi Vitry-Orly ?", answer: "Orly est à 15-20 min via la D7 ou l'A86. Comptez 20-30 € en taxi." }], 18, "10 min"),

  city("Créteil", "creteil", 48.7905, 2.4559, 92000, ["Préfecture du Val-de-Marne", "Université Paris-Est Créteil (UPEC)", "Hôpital Henri-Mondor", "Centre commercial Créteil Soleil", "Lac de Créteil", "Cathédrale Notre-Dame de Créteil", "MJC Mont-Mesly", "Palais de Justice", "Stade Dominique-Duvauchelle", "Base nautique de Créteil", "Maison des Arts", "Métro ligne 8 terminus", "Parc de la Brèche", "Marché du centre", "Hôtel de Ville de Créteil"], ["Centre Ancien", "Mont-Mesly", "L'Échat", "Lac", "Université", "Bords de Marne", "La Habette", "Les Bleuets", "Lévrière", "La Brèche", "Palais", "Buttes-Halage"], [{ from: "Créteil", to: "Paris", price: "30-40 €" }, { from: "Créteil", to: "Orly", price: "25-35 €" }, { from: "Créteil", to: "CDG", price: "55-75 €" }, { from: "Créteil", to: "Saint-Maur-des-Fossés", price: "12-18 €" }, { from: "Créteil", to: "Maisons-Alfort", price: "10-15 €" }], ["maisons-alfort", "saint-maur-des-fosses", "vitry-sur-seine", "champigny-sur-marne", "ivry-sur-seine"], [{ text: "Transfert Créteil Soleil → CDG impeccable pour notre vol de 6h. Chauffeur très professionnel.", name: "Fatima E.", initials: "FE", role: "Résidente" }, { text: "Taxi régulier pour l'UPEC, toujours ponctuel.", name: "Nicolas P.", initials: "NP", role: "Étudiant" }, { text: "Hôpital Mondor → domicile après intervention, service attentionné.", name: "Monique D.", initials: "MD", role: "Patiente" }], [{ question: "Métro à Créteil ?", answer: "Créteil est desservi par la ligne 8 du métro (stations Créteil - L'Échat, Créteil - Université, Créteil - Préfecture). Nos taxis complètent la desserte vers les quartiers excentrés." }, { question: "Lac de Créteil ?", answer: "Plan d'eau de 42 hectares au cœur de la ville, avec base nautique, voile et aviron. Accessible en taxi en 5 min depuis le centre." }, { question: "Créteil Soleil ?", answer: "Deuxième plus grand centre commercial d'Île-de-France avec 220 boutiques. Prise en charge devant l'entrée principale." }], 20, "9 min"),

  city("Champigny-sur-Marne", "champigny-sur-marne", 48.8175, 2.5156, 77000, ["Gare de Champigny", "Bords de Marne", "Musée de la Résistance nationale", "Parc du Tremblay", "Centre commercial Pince-Vent", "Stade Gustave-Maillot", "Guinguette de Champigny", "Île de loisirs du Tremblay", "Église Saint-Saturnin", "Marché de Champigny-Centre", "Base nautique de la Marne", "Pont de Champigny", "Hôpital privé Paul d'Égine", "Médiathèque Jean-Jacques Rousseau", "Gare RER A de Champigny"], ["Centre-ville", "Le Plant", "Cœuilly", "Les Mordacs", "Tremblay", "Bords de Marne", "Le Maroc", "Les Boullereaux", "Musselburgh", "Les Quatre Cités", "Le Plateau"], [{ from: "Champigny-sur-Marne", to: "Paris", price: "35-45 €" }, { from: "Champigny-sur-Marne", to: "Orly", price: "40-55 €" }, { from: "Champigny-sur-Marne", to: "CDG", price: "45-60 €" }, { from: "Champigny-sur-Marne", to: "Saint-Maur-des-Fossés", price: "10-15 €" }, { from: "Champigny-sur-Marne", to: "Noisy-le-Grand", price: "12-18 €" }], ["saint-maur-des-fosses", "noisy-le-grand", "fontenay-sous-bois", "vincennes", "creteil"], [{ text: "Guinguettes des bords de Marne en été, taxi parfait pour le retour.", name: "Laurent F.", initials: "LF", role: "Résident" }, { text: "Transfert CDG fiable depuis Champigny, A4 directe.", name: "Sophie V.", initials: "SV", role: "Voyageuse fréquente" }, { text: "Parc du Tremblay le week-end, taxi ponctuel pour y aller avec les enfants.", name: "Karim A.", initials: "KA", role: "Résident" }], [{ question: "Guinguettes ?", answer: "Les guinguettes des bords de Marne à Champigny perpétuent la tradition des impressionnistes. Ouvertes d'avril à septembre." }, { question: "Musée de la Résistance ?", answer: "Le Musée de la Résistance nationale retrace l'histoire de la Résistance française. Entrée gratuite, ouvert du mercredi au dimanche." }], 16, "10 min"),

  city("Saint-Maur-des-Fossés", "saint-maur-des-fosses", 48.7994, 2.4916, 75000, ["Boucle de la Marne", "Parc de Saint-Maur", "Gare RER A Saint-Maur-Créteil", "Gare RER A Le Parc de Saint-Maur", "Abbaye de Saint-Maur", "Île d'Amour", "Villa Médicis du Val-de-Marne", "Marché de La Varenne", "Stade nautique", "Passerelle de Bonneuil", "Centre commercial Saint-Maur 2", "Église Notre-Dame-du-Rosaire", "Parc Lefèvre", "Conservatoire de musique", "Hôpital Esquirol"], ["La Varenne-Saint-Hilaire", "Le Parc", "Adamville", "Centre-ville", "La Pie", "Les Mûriers", "Champignol", "Le Vieux Saint-Maur", "Les Remises", "La Maréchale", "Le Pont de Créteil"], [{ from: "Saint-Maur-des-Fossés", to: "Paris", price: "30-40 €" }, { from: "Saint-Maur-des-Fossés", to: "Orly", price: "30-45 €" }, { from: "Saint-Maur-des-Fossés", to: "CDG", price: "50-70 €" }, { from: "Saint-Maur-des-Fossés", to: "Créteil", price: "10-15 €" }, { from: "Saint-Maur-des-Fossés", to: "Champigny-sur-Marne", price: "10-15 €" }], ["creteil", "champigny-sur-marne", "maisons-alfort", "fontenay-sous-bois", "vincennes"], [{ text: "Bords de Marne magnifiques, taxi parfait pour une soirée à La Varenne.", name: "Isabelle C.", initials: "IC", role: "Résidente" }, { text: "CDG en 45 min, chauffeur connaissant bien les raccourcis par l'A4.", name: "Philippe R.", initials: "PR", role: "Cadre" }, { text: "Service régulier pour ma mère âgée, chauffeurs toujours patients.", name: "Éric T.", initials: "ET", role: "Résident" }], [{ question: "Boucle de la Marne ?", answer: "Saint-Maur est entourée par la Marne sur trois côtés, formant une presqu'île. Cadre exceptionnel avec guinguettes et promenades." }, { question: "RER A ?", answer: "Deux gares RER A (Saint-Maur-Créteil et Le Parc de Saint-Maur) desservent la ville. Paris-Nation en 15 min." }, { question: "La Varenne ?", answer: "Quartier résidentiel prisé en bord de Marne avec restaurants, guinguettes et le marché du dimanche." }], 15, "10 min"),

  city("Ivry-sur-Seine", "ivry-sur-seine", 48.8113, 2.3847, 64000, ["Gare RER C Ivry-sur-Seine", "Centre Jeanne-Hachette", "Manufacture des Œillets", "Parc des Cormailles", "Cité Internationale des Arts", "Centre commercial Ivry Grand Ciel", "Usine Babcock", "Hôpital Charles-Foix", "Théâtre Antoine-Vitez", "Médiathèque", "Marché d'Ivry", "Quartier Ivry Confluences", "Bords de Seine", "MoCA Ivry", "Cimetière parisien d'Ivry"], ["Centre-ville", "Ivry-Port", "Parmentier", "Petit Ivry", "Plateau", "Gagarine-Truillot", "Marat", "Vérollot", "Ivry Confluences", "Lénine", "Pierre et Marie Curie"], [{ from: "Ivry-sur-Seine", to: "Paris", price: "18-25 €" }, { from: "Ivry-sur-Seine", to: "Orly", price: "22-30 €" }, { from: "Ivry-sur-Seine", to: "CDG", price: "55-75 €" }, { from: "Ivry-sur-Seine", to: "Vitry-sur-Seine", price: "10-15 €" }, { from: "Ivry-sur-Seine", to: "Villejuif", price: "10-15 €" }], ["vitry-sur-seine", "villejuif", "paris", "maisons-alfort", "creteil"], [{ text: "Ivry → Orly en 20 minutes, prix raisonnable et chauffeur agréable.", name: "Youssef K.", initials: "YK", role: "Résident" }, { text: "Parfait pour mes trajets vers Paris 13e, rapide et ponctuel.", name: "Nathalie G.", initials: "NG", role: "Résidente" }, { text: "Transfert CDG tôt le matin, chauffeur fiable comme toujours.", name: "Olivier S.", initials: "OS", role: "Voyageur" }], [{ question: "Ivry Confluences ?", answer: "Nouveau quartier à la confluence Seine-Marne : 2 500 logements, bureaux, commerces. Projet urbain majeur livré progressivement jusqu'en 2030." }, { question: "Taxi Ivry-Orly ?", answer: "Orly est très accessible depuis Ivry via la D7 ou le périphérique. Comptez 15-20 min et 22-30 €." }], 12, "10 min"),

  city("Maisons-Alfort", "maisons-alfort", 48.8076, 2.4378, 56000, ["École Nationale Vétérinaire d'Alfort (EnvA)", "Musée Fragonard", "Confluence Seine-Marne", "Gare RER D Maisons-Alfort-Alfortville", "Gare RER D Le Vert de Maisons", "Stade nautique", "Parc du Moulin Brûlé", "Centre commercial Les Juilliottes", "Marché de Maisons-Alfort", "Église Sainte-Agnès", "Île de Charentonneau", "Passerelle de l'Écluse", "Charentonneau", "Complexe sportif Duvauchelle", "Médiathèque André-Malraux"], ["Centre-ville", "Charentonneau", "Le Vert de Maisons", "Les Juilliottes", "Les Planètes", "Alfort", "Le Moulin Brûlé", "La Briqueterie", "Les Pâquerettes", "Liberté"], [{ from: "Maisons-Alfort", to: "Paris", price: "25-35 €" }, { from: "Maisons-Alfort", to: "Orly", price: "25-35 €" }, { from: "Maisons-Alfort", to: "CDG", price: "55-75 €" }, { from: "Maisons-Alfort", to: "Créteil", price: "10-15 €" }, { from: "Maisons-Alfort", to: "Vincennes", price: "12-18 €" }], ["creteil", "ivry-sur-seine", "vincennes", "saint-maur-des-fosses", "vitry-sur-seine"], [{ text: "Musée Fragonard fascinant, taxi au rendez-vous pour le retour.", name: "Claire B.", initials: "CB", role: "Résidente" }, { text: "Confluences Seine-Marne, balade et taxi pour rentrer, parfait.", name: "Damien L.", initials: "DL", role: "Résident" }, { text: "Service régulier pour le RER D, fiable malgré les grèves.", name: "Sylvie M.", initials: "SM", role: "Résidente" }], [{ question: "École Vétérinaire d'Alfort ?", answer: "Fondée en 1766, c'est la plus ancienne école vétérinaire du monde. Le musée Fragonard abrite une collection anatomique unique." }, { question: "Confluences ?", answer: "Maisons-Alfort est au confluent de la Seine et de la Marne. Promenades aménagées le long des berges." }], 10, "11 min"),

  city("Villejuif", "villejuif", 48.7919, 2.3628, 55000, ["Institut Gustave-Roussy (1er centre anticancer d'Europe)", "Hôpital Paul-Brousse", "Gare future Grand Paris Express", "Métro ligne 7", "Parc départemental des Hautes-Bruyères", "Église Saint-Cyr-Sainte-Julitte", "ZAC Campus Grand Parc", "Université Paris-Saclay Cancer Campus", "Marché de Villejuif", "Redoute de Hautes-Bruyères 1870", "Centre-ville historique", "Médiathèque municipale", "Conservatoire", "Parc Pablo-Neruda", "Stade Karl-Marx"], ["Centre-ville", "Les Hautes-Bruyères", "Gustave-Roussy", "Louis Aragon", "Pasteur", "Lamartine", "Stalingrad", "Groupe Aragon-Triolet", "Les Esselières", "Le Plateau"], [{ from: "Villejuif", to: "Paris", price: "20-30 €" }, { from: "Villejuif", to: "Orly", price: "15-25 €" }, { from: "Villejuif", to: "CDG", price: "60-80 €" }, { from: "Villejuif", to: "Vitry-sur-Seine", price: "10-15 €" }, { from: "Villejuif", to: "Antony", price: "18-25 €" }], ["vitry-sur-seine", "ivry-sur-seine", "antony", "montrouge", "paris"], [{ text: "Taxi régulier pour Gustave-Roussy, chauffeurs toujours respectueux et ponctuels.", name: "Marie-France D.", initials: "MD", role: "Patiente" }, { text: "Villejuif → Orly en 15 min, idéal avant un vol.", name: "Sébastien P.", initials: "SP", role: "Résident" }, { text: "Parc des Hautes-Bruyères superbe, taxi fiable pour y aller.", name: "Amina R.", initials: "AR", role: "Résidente" }], [{ question: "Gustave-Roussy ?", answer: "Premier centre de lutte contre le cancer en Europe, avec 3 200 professionnels. Nos taxis assurent le transport des patients et familles quotidiennement." }, { question: "Grand Paris Express ?", answer: "La future gare Villejuif - Institut Gustave-Roussy (lignes 14 et 15) sera un pôle de transport majeur du sud parisien." }, { question: "Taxi Villejuif-Orly ?", answer: "Orly est à 10-15 min via la N7 ou l'A6. Comptez 15-25 € en taxi." }], 10, "11 min"),

  city("Fontenay-sous-Bois", "fontenay-sous-bois", 48.8520, 2.4781, 53000, ["Gare RER A Val de Fontenay", "Gare RER A Fontenay-sous-Bois", "Bois de Vincennes (partie Est)", "Parc des Carrières", "Château de Fontenay", "Centre commercial Val de Fontenay", "Aqueduc de la Dhuis", "Église Saint-Germain-l'Auxerrois", "Stade municipal", "Marché de Fontenay", "Médiathèque Louis-Aragon", "Salle Jacques-Brel", "Parc Mauconseil", "ZAC des Alouettes", "Hôpital de jour"], ["Centre-ville", "Val de Fontenay", "Les Alouettes", "Bois Cadet", "Les Larris", "Dalayrac", "La Redoute", "Carrières", "Rigollots", "Rougeau", "Les Murs à Pêches"], [{ from: "Fontenay-sous-Bois", to: "Paris", price: "28-38 €" }, { from: "Fontenay-sous-Bois", to: "Orly", price: "35-50 €" }, { from: "Fontenay-sous-Bois", to: "CDG", price: "45-60 €" }, { from: "Fontenay-sous-Bois", to: "Vincennes", price: "8-12 €" }, { from: "Fontenay-sous-Bois", to: "Noisy-le-Grand", price: "12-18 €" }], ["vincennes", "champigny-sur-marne", "noisy-le-grand", "montreuil", "saint-maur-des-fosses"], [{ text: "RER A en grève, taxi Fontenay → Paris en 25 min. Sauvé !", name: "Thomas H.", initials: "TH", role: "Résident" }, { text: "Bois de Vincennes à pied, taxi au retour, parfait avec les enfants.", name: "Céline M.", initials: "CM", role: "Résidente" }, { text: "Val de Fontenay → CDG rapide par l'A4.", name: "Arnaud J.", initials: "AJ", role: "Voyageur" }], [{ question: "Val de Fontenay ?", answer: "Pôle multimodal majeur (RER A + E + bus). Future gare ligne 15 du Grand Paris Express. Quartier en pleine transformation." }, { question: "Bois de Vincennes ?", answer: "La partie est du Bois de Vincennes borde Fontenay. Accès direct au lac des Minimes et à l'hippodrome de Vincennes." }], 9, "11 min"),

  city("Vincennes", "vincennes", 48.8474, 2.4392, 50000, ["Château de Vincennes", "Bois de Vincennes", "Parc Floral de Paris", "Zoo de Vincennes (Parc Zoologique de Paris)", "Hippodrome de Vincennes", "Gare RER A Vincennes", "Métro ligne 1 Château de Vincennes", "Cours Marigny", "Théâtre de l'Ouest Parisien", "Marché de Vincennes", "Église Saint-Louis", "Aquarium tropical du Palais de la Porte Dorée", "Temple bouddhiste du Bois de Vincennes", "Fort de Vincennes", "Cartoucherie (Théâtre du Soleil)"], ["Centre-ville", "Nord", "Sud", "Est", "Ouest", "Le Parc", "Daumesnil", "Les Vignerons", "Montreuil", "République"], [{ from: "Vincennes", to: "Paris", price: "18-25 €" }, { from: "Vincennes", to: "Orly", price: "35-50 €" }, { from: "Vincennes", to: "CDG", price: "45-65 €" }, { from: "Vincennes", to: "Fontenay-sous-Bois", price: "8-12 €" }, { from: "Vincennes", to: "Montreuil", price: "10-15 €" }], ["fontenay-sous-bois", "montreuil", "saint-maur-des-fosses", "maisons-alfort", "paris"], [{ text: "Château de Vincennes sublime, taxi impeccable pour le retour à Paris.", name: "Jean-Pierre V.", initials: "JV", role: "Touriste" }, { text: "Zoo de Vincennes avec les enfants, taxi confortable et rapide.", name: "Émilie R.", initials: "ER", role: "Résidente" }, { text: "Hippodrome le dimanche, taxi fiable pour y aller et en revenir.", name: "Gérard N.", initials: "GN", role: "Turfiste" }], [{ question: "Château de Vincennes ?", answer: "Forteresse royale médiévale avec le plus haut donjon d'Europe (52 m). Ouvert tous les jours, plein tarif 9,50 €." }, { question: "Parc Floral ?", answer: "Jardin botanique de 31 hectares dans le Bois de Vincennes. Concerts gratuits en été (Paris Jazz Festival)." }, { question: "Métro ?", answer: "Vincennes est le terminus de la ligne 1 du métro (station Château de Vincennes) et dispose du RER A. Paris-Nation en 5 min." }], 8, "12 min"),

  // ─── 91 – Essonne ──────────────────────────────

  city("Évry-Courcouronnes", "evry-courcouronnes", 48.6249, 2.4295, 69000, ["Cathédrale de la Résurrection", "Université d'Évry-Val-d'Essonne", "Génopole", "Centre commercial Évry 2", "Gare d'Évry-Courcouronnes", "Hôpital Sud Francilien", "Médiathèque départementale", "Parc des Coquibus", "Mosquée d'Évry-Courcouronnes", "Centre nautique Nymphéa", "Théâtre de l'Agora", "Place des Droits de l'Homme", "Stade Robert Bobin", "Parc Henri Fabre", "Chambre de Commerce et d'Industrie de l'Essonne"], ["Centre-ville", "Courcouronnes", "Les Pyramides", "Le Canal", "Les Épinettes", "Bois Sauvage", "Le Parc aux Lièvres", "Les Aunettes", "Champtier du Coq", "Le Village"], [{ from: "Évry-Courcouronnes", to: "Paris", price: "45-65 €" }, { from: "Évry-Courcouronnes", to: "Orly", price: "30-45 €" }, { from: "Évry-Courcouronnes", to: "CDG", price: "70-90 €" }, { from: "Évry-Courcouronnes", to: "Corbeil-Essonnes", price: "15-25 €" }, { from: "Évry-Courcouronnes", to: "Massy", price: "30-40 €" }], ["corbeil-essonnes", "massy", "savigny-le-temple", "combs-la-ville", "antony"], [{ text: "Chauffeur très professionnel pour l'hôpital Sud Francilien.", name: "Fatima B.", initials: "FB", role: "Patiente" }, { text: "Réservation facile pour aller à Paris depuis Évry.", name: "Thomas R.", initials: "TR", role: "Résident" }, { text: "Toujours ponctuel pour mes trajets vers Orly.", name: "Sylvie D.", initials: "SD", role: "Résidente" }], [{ question: "Accès gare RER D ?", answer: "Desserte directe de la gare d'Évry-Courcouronnes sur le RER D." }, { question: "Génopole ?", answer: "Premier biocluster français, accessible en 5 minutes depuis le centre." }, { question: "Centre commercial Évry 2 ?", answer: "Plus grand centre commercial de l'Essonne, 200 boutiques." }], 14, "12 min"),

  city("Corbeil-Essonnes", "corbeil-essonnes", 48.6131, 2.4826, 52000, ["Cathédrale Saint-Spire", "Gare de Corbeil-Essonnes", "Hôpital Sud Francilien", "Théâtre de Corbeil-Essonnes", "Musée Robert Dubois-Corneau", "Parc de la Nacelle", "Bords de Seine", "Marché couvert des Tarterêts", "Médiathèque Chantemerle", "Stade Jean Moynet", "Église Saint-Germain-lès-Corbeil", "Centre commercial La Croix Blanche", "Zone d'activité du Coudray", "Espace Jean Monnet", "Port aux Cerises"], ["Centre-ville", "Les Tarterêts", "Montconseil", "La Nacelle", "Robinson", "L'Ermitage", "Les Ayaux", "Le Coudray", "Villabé-Lisses", "Moulin Galant", "Essonne"], [{ from: "Corbeil-Essonnes", to: "Paris", price: "50-70 €" }, { from: "Corbeil-Essonnes", to: "Orly", price: "35-50 €" }, { from: "Corbeil-Essonnes", to: "CDG", price: "75-95 €" }, { from: "Corbeil-Essonnes", to: "Évry-Courcouronnes", price: "15-25 €" }, { from: "Corbeil-Essonnes", to: "Massy", price: "35-45 €" }], ["evry-courcouronnes", "massy", "savigny-le-temple", "combs-la-ville", "pontault-combault"], [{ text: "Très bon service pour rejoindre la gare.", name: "Laurent P.", initials: "LP", role: "Résident" }, { text: "Chauffeur agréable, véhicule propre.", name: "Amina H.", initials: "AH", role: "Résidente" }, { text: "Parfait pour mes déplacements professionnels.", name: "Pierre G.", initials: "PG", role: "Cadre" }], [{ question: "Gare de Corbeil ?", answer: "Gare RER D avec liaisons directes vers Paris-Gare de Lyon." }, { question: "Hôpital Sud Francilien ?", answer: "Principal hôpital du sud de l'Essonne, accessible en 10 minutes." }], 10, "14 min"),

  city("Massy", "massy", 48.7309, 2.2710, 50000, ["Gare TGV Massy", "Gare Massy-Palaiseau (RER B/C)", "Opéra de Massy", "Centre commercial Massy Place", "Université Paris-Saclay", "Parc Georges Brassens", "Piscine du Tout-y-Faut", "Hôpital privé Jacques Cartier", "Zone d'activité Atlantis", "Stade Jules Ladoumègue", "Médiathèque Albert Camus", "Marché de Massy-Villaine", "Quartier Atlantis-Saclay", "Parc de la Blondinette", "Centre culturel Paul-Bailliart"], ["Centre-ville", "Massy-Opéra", "Villaine", "Atlantis", "Le Pileu", "Massy-Verrières", "La Bonde", "Grand Ensemble", "Carnot", "Franciades", "Paris-Saclay"], [{ from: "Massy", to: "Paris", price: "35-50 €" }, { from: "Massy", to: "Orly", price: "20-30 €" }, { from: "Massy", to: "CDG", price: "65-85 €" }, { from: "Massy", to: "Versailles", price: "25-35 €" }, { from: "Massy", to: "Évry-Courcouronnes", price: "30-40 €" }], ["antony", "versailles", "evry-courcouronnes", "corbeil-essonnes", "paris"], [{ text: "Indispensable pour mes correspondances TGV.", name: "Catherine L.", initials: "CL", role: "Voyageuse régulière" }, { text: "Transfert rapide vers Orly, très pratique.", name: "Jean-Marc V.", initials: "JV", role: "Homme d'affaires" }, { text: "Service impeccable depuis Massy-Palaiseau.", name: "Sophie N.", initials: "SN", role: "Chercheuse Paris-Saclay" }], [{ question: "Gare TGV Massy ?", answer: "Hub TGV majeur desservant Lyon, Bordeaux, Nantes sans passer par Paris." }, { question: "Accès Paris-Saclay ?", answer: "Le plateau de Saclay et ses grandes écoles sont à 10 minutes en voiture." }, { question: "Opéra de Massy ?", answer: "Salle de 800 places, programmation lyrique et ballet toute l'année." }], 10, "11 min"),

  // ─── 95 – Val-d'Oise ──────────────────────────────

  city("Cergy", "cergy", 49.0363, 2.0630, 67000, ["Axe Majeur", "Port Cergy", "Université CY Cergy Paris", "Base de loisirs de Cergy-Pontoise", "Gare de Cergy-Préfecture (RER A)", "Gare de Cergy-Le Haut", "Centre commercial Les 3 Fontaines", "Préfecture du Val-d'Oise", "Théâtre 95", "ESSEC Business School", "Parc François Mitterrand", "Médiathèque de l'Horloge", "Stade Léo Lagrange", "Centre hospitalier René Dubos", "MJC de Cergy"], ["Cergy-Préfecture", "Cergy-Le Haut", "Cergy-Saint-Christophe", "Cergy-Village", "Les Linandes", "Les Touleuses", "Axe Majeur-Horloge", "Hauts de Cergy", "Grand Centre", "Puiseux-Pontoise", "Les Essarts", "Bords d'Oise"], [{ from: "Cergy", to: "Paris", price: "55-75 €" }, { from: "Cergy", to: "CDG", price: "60-80 €" }, { from: "Cergy", to: "Orly", price: "70-90 €" }, { from: "Cergy", to: "Sartrouville", price: "30-40 €" }, { from: "Cergy", to: "Argenteuil", price: "35-50 €" }], ["sartrouville", "argenteuil", "sarcelles", "colombes", "nanterre"], [{ text: "Très pratique pour la gare RER le matin.", name: "Olivier C.", initials: "OC", role: "Étudiant CY" }, { text: "Chauffeur ponctuel pour mes réunions à La Défense.", name: "Isabelle M.", initials: "IM", role: "Cadre" }, { text: "Service parfait pour aller à CDG tôt le matin.", name: "Rachid A.", initials: "RA", role: "Résident" }], [{ question: "Port Cergy ?", answer: "Marina sur l'Oise avec restaurants et promenades, 5 minutes du centre." }, { question: "Axe Majeur ?", answer: "Œuvre monumentale de Dani Karavan, 3 km, emblème de la ville nouvelle." }, { question: "Accès RER A ?", answer: "Deux gares RER A (Préfecture et Le Haut) pour Paris en 35-40 min." }], 14, "12 min"),

  city("Sarcelles", "sarcelles", 48.9953, 2.3795, 58000, ["Gare de Garges-Sarcelles (RER D)", "Centre commercial Les Flanades", "Grand Ensemble de Sarcelles", "Église Saint-Pierre-et-Saint-Paul", "Parc Kennedy", "Hôpital privé Nord Parisien", "Stade Nelson Mandela", "Médiathèque Anna Langfus", "Marché de Lochères", "Synagogue de Sarcelles", "Parc des Music'halles", "Centre culturel Lochères", "Place de France", "Conservatoire de musique", "Zone d'activité des Chardonnerettes"], ["Lochères", "Les Chardonnerettes", "Village", "Le Prainet", "Les Rosiers", "Les Sablons", "Les Vignes Blanches", "Centre-ville", "Watteau", "La Tête de Cerf", "Le Grand Ensemble"], [{ from: "Sarcelles", to: "Paris", price: "30-45 €" }, { from: "Sarcelles", to: "CDG", price: "25-35 €" }, { from: "Sarcelles", to: "Orly", price: "55-70 €" }, { from: "Sarcelles", to: "Saint-Denis", price: "15-25 €" }, { from: "Sarcelles", to: "Épinay-sur-Seine", price: "12-20 €" }], ["saint-denis", "epinay-sur-seine", "argenteuil", "gennevilliers", "paris"], [{ text: "Rapide pour la gare RER D.", name: "Moussa D.", initials: "MD", role: "Résident" }, { text: "Toujours à l'heure pour CDG.", name: "Esther C.", initials: "EC", role: "Résidente" }, { text: "Bon rapport qualité-prix.", name: "Karim B.", initials: "KB", role: "Commerçant" }], [{ question: "Gare Garges-Sarcelles ?", answer: "Gare RER D avec accès direct Paris-Nord en 20 min." }, { question: "Centre Les Flanades ?", answer: "Centre commercial de 100 boutiques au cœur de la ville." }], 12, "13 min"),

  // ─── 78 – Yvelines ──────────────────────────────

  city("Sartrouville", "sartrouville", 48.9372, 2.1597, 52000, ["Gare de Sartrouville (Transilien J/L)", "Église Saint-Martin", "Parc du Dispensaire", "Centre commercial des Indes", "Stade municipal Yves-du-Manoir", "Bords de Seine", "Médiathèque Colette", "Marché de Sartrouville", "Espace Vauban", "Parc Yves Cariou", "Hippodrome de Maisons-Laffitte", "Centre aquatique Le Marnois", "Zone d'activité des Quatre Chemins", "Place nationale", "Groupe scolaire Jean Macé"], ["Centre-ville", "Les Indes", "Le Vieux Pays", "Le Plateau", "Les Quatre Chemins", "Le Réveil Matin", "Les Trembleaux", "La Marinière", "Le Cottages", "Richard Mique", "Maison Rouge"], [{ from: "Sartrouville", to: "Paris", price: "35-50 €" }, { from: "Sartrouville", to: "CDG", price: "50-65 €" }, { from: "Sartrouville", to: "Orly", price: "55-70 €" }, { from: "Sartrouville", to: "Cergy", price: "30-40 €" }, { from: "Sartrouville", to: "La Défense", price: "20-30 €" }], ["argenteuil", "colombes", "nanterre", "gennevilliers", "cergy"], [{ text: "Très bien pour la gare chaque matin.", name: "François L.", initials: "FL", role: "Résident" }, { text: "Pratique pour rejoindre La Défense.", name: "Valérie S.", initials: "VS", role: "Cadre" }, { text: "Chauffeur sympathique et ponctuel.", name: "Antoine R.", initials: "AR", role: "Résident" }], [{ question: "Gare Transilien ?", answer: "Gare Transilien J et L avec Paris-Saint-Lazare en 15 min." }, { question: "Hippodrome Maisons-Laffitte ?", answer: "À 5 minutes, l'un des plus beaux hippodromes d'Île-de-France." }], 10, "13 min"),

  // ─── 77 – Seine-et-Marne ──────────────────────────────

  city("Meaux", "meaux", 48.9604, 2.8788, 55000, ["Cathédrale Saint-Étienne", "Musée de la Grande Guerre", "Gare de Meaux (Transilien P)", "Centre hospitalier de Meaux", "Marché couvert de Meaux", "Jardin Bossuet", "Palais épiscopal", "Centre commercial Les Saisons de Meaux", "Stade de la Ménardière", "Médiathèque Luxembourg", "Théâtre Le Rex", "Fromage de Meaux (Brie)", "Zone d'activité du Pays de Meaux", "Parc Pâtis", "Bords de Marne"], ["Centre-ville", "Beauval", "La Pierre Collinet", "Cornillon", "Faubourg Saint-Nicolas", "Le Marché", "Luxembourg", "Dunant", "La Villeparc", "Poincy", "Boutigny", "Les Allobroges"], [{ from: "Meaux", to: "Paris", price: "55-75 €" }, { from: "Meaux", to: "CDG", price: "35-50 €" }, { from: "Meaux", to: "Orly", price: "80-100 €" }, { from: "Meaux", to: "Chelles", price: "30-40 €" }, { from: "Meaux", to: "Disneyland Paris", price: "35-50 €" }], ["chelles", "villeparisis", "mitry-mory", "claye-souilly", "bussy-saint-georges"], [{ text: "Indispensable pour la gare Transilien le matin.", name: "Philippe D.", initials: "PD", role: "Résident" }, { text: "Parfait pour aller à CDG sans stress.", name: "Marie-Claire F.", initials: "MF", role: "Voyageuse" }, { text: "Service fiable pour l'hôpital.", name: "Gérard T.", initials: "GT", role: "Patient" }], [{ question: "Gare de Meaux ?", answer: "Transilien P vers Paris-Est en 25 min, départs fréquents." }, { question: "Musée Grande Guerre ?", answer: "Plus grand musée européen sur 14-18, 70 000 objets." }, { question: "Cathédrale Saint-Étienne ?", answer: "Chef-d'œuvre gothique du XIIe siècle, classée Monument Historique." }], 11, "14 min"),

  // ─── Rhône (AURA) ──────────────────────────────

  city("Vénissieux", "venissieux", 45.6973, 4.8871, 66000, [
    "Métro D Vénissieux", "Gare de Vénissieux", "Centre hospitalier Lyon-Sud",
    "MIN de Lyon", "Parc de Parilly", "Stade Laurent-Gerin", "Médiathèque Lucie-Aubrac",
    "Quartier des Minguettes", "Mosquée de Vénissieux", "Cinéma Gérard-Philipe",
    "Centre commercial Vénissy", "Maison de la Danse (proche)", "Fort de Bron (proche)",
    "Piscine Auguste-Delaune", "École nationale de musique",
  ], [
    "Centre-ville", "Les Minguettes", "Parilly", "Moulin à Vent", "Max Barel",
    "Charréard", "Les Grandes Terres", "Joliot-Curie", "Saint-Fons (limitrophe)",
    "Le Moulin à Vent", "Pyramide",
  ], [
    { from: "Vénissieux", to: "Lyon Part-Dieu", price: "18-25 €" },
    { from: "Vénissieux", to: "Aéroport Lyon Saint-Exupéry", price: "40-55 €" },
    { from: "Centre", to: "Centre hospitalier Lyon-Sud", price: "8-12 €" },
    { from: "Vénissieux", to: "Gare de Lyon-Perrache", price: "15-22 €" },
    { from: "Centre", to: "MIN de Lyon", price: "6-10 €" },
  ], ["lyon", "villeurbanne", "saint-etienne", "grenoble", "vaulx-en-velin"], [
    { text: "Taxi rapide jusqu'à Part-Dieu pour mes rendez-vous professionnels. Toujours ponctuel.", name: "Karim B.", initials: "KB", role: "Commercial, Vénissieux" },
    { text: "Trajet vers l'hôpital Lyon-Sud très confortable. Chauffeur attentionné.", name: "Martine G.", initials: "MG", role: "Patiente, Vénissieux" },
    { text: "Service fiable pour mes allers-retours à l'aéroport Saint-Exupéry.", name: "David R.", initials: "DR", role: "Entrepreneur, Vénissieux" },
  ], [
    { question: "Comment rejoindre Lyon centre depuis Vénissieux en taxi ?", answer: "Le trajet Vénissieux – Lyon Part-Dieu dure environ 15 minutes et coûte 18-25 €. Nos chauffeurs empruntent les voies rapides." },
    { question: "Combien coûte un taxi Vénissieux – Aéroport Saint-Exupéry ?", answer: "Comptez 40-55 € pour rejoindre l'aéroport, soit environ 30-40 minutes de trajet selon la circulation." },
    { question: "Y a-t-il des taxis disponibles au métro Vénissieux ?", answer: "Oui, nos chauffeurs desservent la station Métro D de Vénissieux. Réservez en avance ou commandez en temps réel." },
  ], 14, "9 min"),

  city("Vaulx-en-Velin", "vaulx-en-velin", 45.7769, 4.9247, 52000, [
    "Planétarium de Vaulx-en-Velin", "ENTPE", "Centre commercial Carré de Soie",
    "Hippodrome de Parilly", "Médiathèque", "Campus de La Doua (proche)",
    "Parc de la Rize", "Centre nautique Etienne-Gagnaire", "Stade Municipal",
    "Hôtel de Ville de Vaulx-en-Velin", "INP Lyon (proche)", "Cinéma Pathé Carré de Soie",
    "Marché du centre-ville", "Pôle Pixel", "École nationale d'architecture",
  ], [
    "Centre-ville", "Le Mas du Taureau", "La Grappinière", "Le Village",
    "La Côte", "Vaulx Village", "Le Pont des Planches", "Carré de Soie",
    "Les Noirettes", "Ecoin-Thibaude", "Sud",
  ], [
    { from: "Vaulx-en-Velin", to: "Lyon Part-Dieu", price: "15-22 €" },
    { from: "Vaulx-en-Velin", to: "Aéroport Lyon Saint-Exupéry", price: "35-50 €" },
    { from: "Centre", to: "Carré de Soie", price: "6-10 €" },
    { from: "Vaulx-en-Velin", to: "Villeurbanne Campus", price: "10-15 €" },
    { from: "Centre", to: "Planétarium", price: "5-8 €" },
  ], ["lyon", "villeurbanne", "venissieux", "grenoble", "saint-etienne"], [
    { text: "Taxi parfait pour rejoindre Part-Dieu rapidement. Pratique au quotidien.", name: "Nadia H.", initials: "NH", role: "Étudiante, Vaulx-en-Velin" },
    { text: "Course jusqu'à l'aéroport tôt le matin, chauffeur à l'heure et véhicule propre.", name: "Philippe C.", initials: "PC", role: "Cadre, Vaulx-en-Velin" },
    { text: "Service régulier pour aller à l'ENTPE. Toujours satisfait.", name: "Éric L.", initials: "EL", role: "Ingénieur, Vaulx-en-Velin" },
  ], [
    { question: "Combien coûte un taxi Vaulx-en-Velin – Part-Dieu ?", answer: "Le trajet dure environ 15 minutes et coûte entre 15 et 22 € selon l'heure et la circulation." },
    { question: "Peut-on réserver un taxi pour l'aéroport Saint-Exupéry depuis Vaulx-en-Velin ?", answer: "Oui, comptez 35-50 € et environ 25-35 minutes de trajet. Réservation à l'avance recommandée." },
  ], 12, "10 min"),

  // ─── PACA ──────────────────────────────

  city("La Seyne-sur-Mer", "la-seyne-sur-mer", 43.1010, 5.8790, 65000, [
    "Port de La Seyne-sur-Mer", "Fort Balaguier", "Corniche de Tamaris",
    "Chantiers navals (patrimoine)", "Plage des Sablettes", "Parc de la Navale",
    "Centre hospitalier intercommunal Toulon-La Seyne", "Gare SNCF La Seyne-Six-Fours",
    "Marché du centre-ville", "Institut Michel Pacha", "Tour Royale (proche)",
    "Église Notre-Dame-de-Bon-Voyage", "Centre commercial Espace Coupiane",
    "Pont du Las", "Jardin de la Ville",
  ], [
    "Centre-ville", "Les Sablettes", "Tamaris", "Mar Vivo", "Berthe",
    "La Rouve", "Balaguier", "Saint-Élme", "Fabrégas",
    "Les Mouissèques", "Pin Rolland",
  ], [
    { from: "La Seyne", to: "Toulon Centre", price: "15-22 €" },
    { from: "La Seyne", to: "Aéroport Toulon-Hyères", price: "35-45 €" },
    { from: "Centre", to: "Gare SNCF La Seyne", price: "6-10 €" },
    { from: "La Seyne", to: "Hôpital Font-Pré Toulon", price: "18-25 €" },
    { from: "Les Sablettes", to: "Centre-ville", price: "8-12 €" },
  ], ["toulon", "hyeres", "marseille", "aix-en-provence", "nice"], [
    { text: "Taxi toujours disponible pour aller à Toulon. Trajets rapides et agréables.", name: "Sylvie A.", initials: "SA", role: "Habitante, La Seyne" },
    { text: "Transfert aéroport parfait. Chauffeur ponctuel et sympathique.", name: "Michel P.", initials: "MP", role: "Voyageur, La Seyne" },
    { text: "Service fiable pour mes rendez-vous médicaux à l'hôpital.", name: "Geneviève D.", initials: "GD", role: "Retraitée, La Seyne" },
  ], [
    { question: "Combien coûte un taxi La Seyne – Toulon ?", answer: "Le trajet La Seyne-sur-Mer – Toulon centre dure 15-20 minutes et coûte environ 15-22 €." },
    { question: "Peut-on aller à l'aéroport de Toulon-Hyères en taxi depuis La Seyne ?", answer: "Oui, comptez 35-45 € pour environ 30-35 minutes de trajet. Réservation à l'avance possible 24h/24." },
    { question: "Y a-t-il des taxis pour les plages de Tamaris et Les Sablettes ?", answer: "Oui, nos chauffeurs desservent toutes les plages de La Seyne. Comptez 8-12 € depuis le centre-ville." },
  ], 14, "9 min"),

  city("Hyères", "hyeres", 43.1204, 6.1286, 56000, [
    "Aéroport Toulon-Hyères", "Port d'Hyères", "Vieille ville médiévale",
    "Îles d'Or (Porquerolles)", "Les Salins d'Hyères", "Parc Olbius-Riquier",
    "Tour des Templiers", "Villa Noailles", "Collégiale Saint-Paul",
    "Château d'Hyères", "Centre hospitalier d'Hyères", "Presqu'île de Giens",
    "Plage de l'Almanarre", "Salin des Pesquiers", "Casino des Palmiers",
  ], [
    "Centre historique", "Giens", "L'Ayguade", "Les Salins", "La Capte",
    "Le Port", "La Bayorre", "Costebelle", "Les Borrels",
    "Sauvebonne", "La Garde (limitrophe)",
  ], [
    { from: "Centre", to: "Aéroport Toulon-Hyères", price: "10-15 €" },
    { from: "Hyères", to: "Toulon Centre", price: "25-35 €" },
    { from: "Hyères", to: "Port de la Tour Fondue (Porquerolles)", price: "18-25 €" },
    { from: "Centre", to: "Presqu'île de Giens", price: "15-22 €" },
    { from: "Hyères", to: "Gare SNCF Hyères", price: "6-10 €" },
  ], ["toulon", "la-seyne-sur-mer", "frejus", "marseille", "aix-en-provence"], [
    { text: "Taxi parfait pour rejoindre le port de la Tour Fondue et prendre le bateau pour Porquerolles.", name: "Isabelle V.", initials: "IV", role: "Touriste, Hyères" },
    { text: "Service aéroport rapide et fiable. Idéal pour mes déplacements professionnels.", name: "Laurent M.", initials: "LM", role: "Commercial, Hyères" },
    { text: "Chauffeur très aimable pour découvrir Giens et les Salins. Belle balade.", name: "Françoise R.", initials: "FR", role: "Vacancière, Hyères" },
  ], [
    { question: "Combien coûte un taxi Hyères – Aéroport Toulon-Hyères ?", answer: "L'aéroport est à seulement 5 minutes du centre d'Hyères. Comptez 10-15 € pour le trajet." },
    { question: "Peut-on prendre un taxi pour aller à Porquerolles ?", answer: "Nos taxis vous conduisent au port de la Tour Fondue à Giens (départ des bateaux pour Porquerolles) pour 18-25 € depuis le centre d'Hyères." },
    { question: "Y a-t-il des taxis disponibles à l'aéroport de Toulon-Hyères ?", answer: "Oui, nos chauffeurs sont disponibles à l'aéroport 24h/24. Réservez à l'avance pour être sûr d'avoir un taxi à votre arrivée." },
  ], 13, "9 min"),

  city("Fréjus", "frejus", 43.4332, 6.7370, 54000, [
    "Arènes de Fréjus", "Base Nature François-Léotard", "Cathédrale Saint-Léonce",
    "Port-Fréjus", "Aqueduc romain", "Pagode Hông Hiên", "Parc Zoologique de Fréjus",
    "Théâtre romain", "Musée archéologique", "Centre hospitalier de Fréjus",
    "Plage de Fréjus", "Mosquée Missiri", "Quartier de la Gabelle",
    "Centre commercial Fréjus Grand Sud", "Malpasset (barrage historique)",
  ], [
    "Centre historique", "Fréjus-Plage", "Saint-Aygulf", "La Tour de Mare",
    "Villeneuve", "Les Adrets", "La Gabelle", "Le Capitou",
    "Caïs", "Port-Fréjus", "La Palud",
  ], [
    { from: "Centre", to: "Gare de Fréjus", price: "6-10 €" },
    { from: "Fréjus", to: "Saint-Raphaël Centre", price: "10-15 €" },
    { from: "Fréjus", to: "Aéroport Nice Côte d'Azur", price: "70-90 €" },
    { from: "Centre", to: "Base Nature", price: "8-12 €" },
    { from: "Fréjus", to: "Cannes", price: "45-60 €" },
  ], ["cannes", "nice", "antibes", "toulon", "hyeres"], [
    { text: "Taxi fiable pour mes allers-retours Fréjus – Saint-Raphaël. Prix raisonnable.", name: "Christophe N.", initials: "CN", role: "Habitant, Fréjus" },
    { text: "Transfert parfait vers l'aéroport de Nice. Chauffeur professionnel et ponctuel.", name: "Stéphanie B.", initials: "SB", role: "Voyageuse, Fréjus" },
    { text: "Taxi pour visiter le patrimoine romain de Fréjus avec mes parents. Très bien.", name: "Antoine K.", initials: "AK", role: "Touriste, Fréjus" },
  ], [
    { question: "Combien coûte un taxi Fréjus – Aéroport de Nice ?", answer: "Le trajet Fréjus – Aéroport Nice Côte d'Azur dure environ 50-60 minutes. Comptez 70-90 €." },
    { question: "Peut-on aller à Saint-Raphaël en taxi depuis Fréjus ?", answer: "Oui, Saint-Raphaël est à 5-10 minutes de Fréjus. Le trajet coûte 10-15 €." },
    { question: "Y a-t-il des taxis disponibles à Port-Fréjus ?", answer: "Oui, nos chauffeurs desservent Port-Fréjus et les plages. Réservez en ligne ou commandez en temps réel." },
  ], 12, "10 min"),

  city("Arles", "arles", 43.6767, 4.6278, 52000, [
    "Arènes d'Arles", "Fondation Luma", "Fondation Vincent Van Gogh",
    "Théâtre antique d'Arles", "Abbaye de Montmajour", "Musée Réattu",
    "Église Saint-Trophime", "Rencontres de la Photographie", "Musée de l'Arles antique",
    "Parc naturel de Camargue", "Hôpital Joseph-Imbert", "Gare SNCF d'Arles",
    "Place du Forum", "Thermes de Constantin", "Pont de Langlois",
  ], [
    "Centre historique", "Trinquetaille", "Barriol", "Griffeuille", "Trébon",
    "Pont de Crau", "Salin-de-Giraud", "Raphèle-les-Arles",
    "Mas-Thibert", "Moulès", "Fourques",
  ], [
    { from: "Centre", to: "Gare SNCF Arles", price: "6-10 €" },
    { from: "Arles", to: "Aéroport Marseille-Provence", price: "60-80 €" },
    { from: "Arles", to: "Avignon Centre", price: "35-45 €" },
    { from: "Centre", to: "Fondation Luma", price: "5-8 €" },
    { from: "Arles", to: "Saintes-Maries-de-la-Mer", price: "40-55 €" },
  ], ["avignon", "nimes", "montpellier", "aix-en-provence", "marseille"], [
    { text: "Taxi idéal pour visiter les Arènes et le patrimoine romain. Chauffeur passionné.", name: "Catherine W.", initials: "CW", role: "Touriste, Arles" },
    { text: "Transfert gare – hôtel rapide pendant les Rencontres de la Photo. Parfait.", name: "Jean-Marc S.", initials: "JS", role: "Photographe, Paris" },
    { text: "Mise à disposition pour la Camargue. Journée inoubliable grâce au chauffeur.", name: "Nathalie F.", initials: "NF", role: "Vacancière, Arles" },
  ], [
    { question: "Peut-on visiter la Camargue en taxi depuis Arles ?", answer: "Oui, nos chauffeurs proposent des mises à disposition pour découvrir la Camargue, les Saintes-Maries-de-la-Mer et les marais salants." },
    { question: "Combien coûte un taxi Arles – Aéroport Marseille-Provence ?", answer: "Le trajet dure environ 45-50 minutes. Comptez 60-80 € avec un tarif fixe annoncé à l'avance." },
    { question: "Y a-t-il des taxis pendant les Rencontres de la Photographie ?", answer: "Oui, nos chauffeurs sont disponibles pendant toute la durée des Rencontres d'Arles (juillet). Réservez à l'avance en haute saison." },
  ], 12, "10 min"),
];
...
const cityContent: Record<string, { introFr: string; introEn: string; descriptionFr: string; descriptionEn: string; metaDescriptionFr: string; metaDescriptionEn: string; heroSubtitleFr: string; heroSubtitleEn: string; whyUsFr: { title: string; desc: string }[]; whyUsEn: { title: string; desc: string }[] }> = {
  ...
  fontainebleau: {
    ...
    whyUsFr: [
      ...
      { title: "Service international", desc: "Chauffeurs anglophones pour les cadres Éditeur de calculateurs et de guides pratiques et les touristes du monde entier. Communication fluide en anglais, aide aux bagages." },
    ...
    whyUsEn: [
      ...
      { title: "International service", desc: "English-speaking drivers for Éditeur de calculateurs et de guides pratiques executives and tourists from around the world. Fluent English communication, luggage assistance." },
      { title: "Guaranteed fixed price", desc: "No meter, no surprises. Fare confirmed at booking, tolls included. Instant online quote." },
    ],
  },
  avon: {
    introFr: "Avon, commune jumelle de Fontainebleau en Seine-et-Marne, forme avec elle une agglomération de 37 000 habitants au cœur de la forêt domaniale. C'est à Avon que se situe la gare Fontainebleau-Avon (Transilien R), principale porte d'entrée ferroviaire de la zone, à 40-50 minutes de Paris Gare de Lyon. La ville s'étend de la lisière de la forêt domaniale de Fontainebleau — 25 000 hectares classés, haut lieu mondial de l'escalade de bloc — jusqu'aux rives du Loing. Cadre résidentiel prisé des familles et des cadres de l'Éditeur de calculateurs et de guides pratiques voisin, Avon accueille aussi le carmel historique où fut cachée la philosophe Édith Stein pendant la Seconde Guerre mondiale. Le marché d'Avon (mercredi et samedi matin, place de la Mairie) est l'un des plus animés du sud de la Seine-et-Marne. TaxiNeo connecte les résidents d'Avon avec des chauffeurs locaux pour les transferts vers Paris, Orly et CDG.",
    introEn: "Avon, Fontainebleau's twin town in Seine-et-Marne, forms a 37,000-resident urban area at the heart of the national forest. Fontainebleau-Avon station (Transilien R), the main rail gateway to the area, is located in Avon — 40-50 minutes from Paris Gare de Lyon. The town extends from the edge of the 25,000-hectare Fontainebleau national forest — a world-class bouldering destination — to the banks of the Loing river. A popular residential setting for families and Éditeur de calculateurs et de guides pratiques executives, Avon also houses the historic Carmel where philosopher Edith Stein was hidden during World War II. Avon's market (Wednesday and Saturday mornings) is one of the liveliest in southern Seine-et-Marne. TaxiNeo connects Avon residents with local drivers for transfers to Paris, Orly and CDG.",
  ...
  // ── Villes touristiques Auvergne ─────────────────────────────
  "la-bourboule": {
    introFr: "La Bourboule est une station thermale d'exception nichée à 850 mètres d'altitude dans la vallée de la Haute Dordogne, au cœur du Parc naturel régional des Volcans d'Auvergne. Fondée au XIXe siècle grâce à la découverte de ses eaux arsenicales — les plus riches d'Europe en arsenic naturel —, la ville est devenue une référence internationale pour le traitement des affections respiratoires et dermatologiques, notamment chez les enfants. Chaque année, des milliers de jeunes curistes viennent suivre des cures de trois semaines aux Thermes Choussy-Lépine, encadrées par des équipes médicales spécialisées. Au-delà du thermalisme, La Bourboule séduit par son architecture Belle Époque remarquablement préservée. Le casino, construit en 1891, témoigne de l'âge d'or de la station avec sa façade ornée et ses salons fastueux. Le Parc Fenestre, véritable poumon vert de la ville, offre ses allées ombragées, son kiosque à musique et ses jeux pour enfants le long de la Dordogne. Les amateurs de nature trouveront leur bonheur sur les sentiers menant à la Roche Vendeix, belvédère naturel offrant un panorama saisissant sur la vallée, ou vers le Puy Gros (1 793 m) pour des randonnées plus exigeantes. En hiver, le plateau de Charlannes se transforme en domaine skiable familial avec ses pistes de ski alpin et de ski de fond, accessible en quelques minutes depuis le centre-ville. TaxiNeo vous transporte vers tous ces sites avec des chauffeurs qui connaissent chaque lacet de ces routes de montagne, qu'il s'agisse d'un transfert depuis Clermont-Ferrand, d'une navette entre votre hébergement et les thermes, ou d'une excursion vers les sommets environnants.",
    introEn: "La Bourboule is an exceptional spa town nestled at 850 metres altitude in the Upper Dordogne valley, in the heart of the Auvergne Volcanoes Regional Nature Park. Founded in the 19th century following the discovery of its arsenical waters — the richest in natural arsenic in all of Europe — the town became an international reference for the treatment of respiratory and dermatological conditions, particularly in children. Every year, thousands of young patients come for three-week treatment programmes at the Choussy-Lépine Thermal Baths, supervised by specialised medical teams. Beyond its thermal heritage, La Bourboule captivates with its remarkably preserved Belle Époque architecture. The casino, built in 1891, stands as a testament to the resort's golden age with its ornate facade and sumptuous salons. Fenestre Park, the town's green lung, offers shaded pathways, a bandstand, and children's play areas alongside the Dordogne River. Nature enthusiasts will find plenty to explore on the trails leading to Roche Vendeix, a natural viewpoint providing a striking panorama of the valley, or towards Puy Gros (1,793 m) for more demanding hikes. In winter, the Charlannes plateau transforms into a family-friendly ski area with alpine and cross-country runs, accessible within minutes from the town centre. TaxiNeo transports you to all these destinations with drivers who know every hairpin bend of these mountain roads, whether you need a transfer from Clermont-Ferrand, a shuttle between your accommodation and the thermal baths, or an excursion to the surrounding peaks.",
    descriptionFr: "La Bourboule se situe à 55 minutes de Clermont-Ferrand par la D2089, une route sinueuse qui traverse le Parc des Volcans d'Auvergne et offre des paysages spectaculaires à chaque saison. L'absence de desserte ferroviaire directe et la complexité des routes de montagne rendent le taxi particulièrement précieux pour rejoindre cette station thermale. Nos chauffeurs TaxiNeo assurent des transferts quotidiens depuis Clermont-Ferrand, l'aéroport de Clermont-Ferrand Auvergne (Aulnat) et la gare SNCF de Clermont-Ferrand. En hiver, entre novembre et avril, tous nos véhicules sont équipés de pneus neige et de chaînes, indispensables sur les routes d'accès au plateau de Charlannes et aux cols du Sancy. Le service est spécialement pensé pour les curistes et leurs familles : nous proposons des véhicules spacieux pouvant accueillir bagages volumineux, poussettes et équipements médicaux. Pour les familles accompagnant un enfant en cure, nous assurons les navettes quotidiennes entre l'hébergement et les thermes, avec des horaires adaptés au planning des soins. Les week-ends, nos chauffeurs vous emmènent visiter les villages alentour — Le Mont-Dore, Orcival, Murol — ou découvrir les cascades et les lacs de montagne du massif du Sancy. La réservation à l'avance est recommandée en haute saison (février-mars pour le ski, juillet-août pour la randonnée), car la demande est forte et les taxis locaux peu nombreux. Avec TaxiNeo, vous bénéficiez d'un tarif annoncé à l'avance, sans surprise, et d'un chauffeur professionnel qui vous attend à l'heure convenue.",
    descriptionEn: "La Bourboule lies 55 minutes from Clermont-Ferrand via the D2089, a winding road that crosses the Auvergne Volcanoes Park and offers spectacular landscapes in every season. The lack of direct rail service and the complexity of mountain roads make taxis particularly valuable for reaching this spa resort. Our TaxiNeo drivers provide daily transfers from Clermont-Ferrand, Clermont-Ferrand Auvergne Airport (Aulnat), and Clermont-Ferrand SNCF station. In winter, between November and April, all our vehicles are fitted with snow tyres and chains, essential on the access roads to the Charlannes plateau and the Sancy mountain passes. The service is specially designed for spa patients and their families: we offer spacious vehicles that can accommodate bulky luggage, pushchairs, and medical equipment. For families accompanying a child receiving treatment, we provide daily shuttles between accommodation and the thermal baths, with schedules adapted to the treatment programme. On weekends, our drivers take you to visit surrounding villages — Le Mont-Dore, Orcival, Murol — or to discover the waterfalls and mountain lakes of the Sancy massif. Advance booking is recommended during peak season (February-March for skiing, July-August for hiking), as demand is high and local taxis are scarce. With TaxiNeo, you benefit from a fare quoted in advance with no surprises, and a professional driver waiting for you at the agreed time.",
    metaDescriptionFr: "Réservez votre taxi à La Bourboule : cure thermale enfants, eaux arsenicales, casino Belle Époque, ski à Charlannes. Transfert depuis Clermont en 55 min.",
    metaDescriptionEn: "Book your taxi in La Bourboule: children's thermal spa, unique arsenical waters, Belle Époque casino, Charlannes skiing. Transfers from Clermont, 55 min.",
    heroSubtitleFr: "Première station thermale d'Europe pour les enfants, La Bourboule vous accueille dans un écrin Belle Époque au cœur du Parc des Volcans d'Auvergne. Eaux arsenicales uniques, casino historique, ski familial à Charlannes et randonnées vers la Roche Vendeix. Transferts confortables depuis Clermont-Ferrand en 55 minutes, véhicules équipés montagne toute l'année.",
    heroSubtitleEn: "Europe's leading children's thermal resort, La Bourboule welcomes you in a Belle Époque setting in the heart of the Auvergne Volcanoes Park. Unique arsenical waters, historic casino, family skiing at Charlannes and hikes to Roche Vendeix. Comfortable transfers from Clermont-Ferrand in 55 minutes, mountain-equipped vehicles year-round.",
    whyUsFr: [
      { title: "Spécialiste transferts thermaux", desc: "Nos chauffeurs connaissent par cœur le rythme des cures à La Bourboule : arrivée le lundi, retour le samedi, navettes quotidiennes vers les thermes Choussy-Lépine. Véhicules spacieux pour les poussettes, bagages de cure et matériel médical. Nous adaptons nos horaires au planning des soins de votre enfant pour un séjour thermal serein et sans stress logistique." },
      { title: "Routes de montagne en toute saison", desc: "La D2089 vers La Bourboule serpente à travers le Parc des Volcans avec des passages à 1 000 mètres d'altitude. De novembre à avril, nos véhicules sont systématiquement équipés de pneus neige et de chaînes. Nos chauffeurs surveillent les alertes météo du Sancy et adaptent leur itinéraire en cas de verglas ou de chutes de neige. En été, ils empruntent les routes panoramiques pour un trajet agréable." },
      { title: "Excursions casino et patrimoine", desc: "Au-delà des thermes, nos chauffeurs vous font découvrir le patrimoine Belle Époque de La Bourboule : casino de 1891, Grands Thermes, Parc Fenestre. Mise à disposition pour des excursions d'une demi-journée vers la Roche Vendeix, le Puy Gros ou le plateau de Charlannes. Circuit combiné possible avec Le Mont-Dore et les cascades du Sancy pour une journée complète de découvertes." },
    ],
    whyUsEn: [
      { title: "Thermal transfer specialists", desc: "Our drivers know the rhythm of La Bourboule's spa seasons inside out: Monday arrivals, Saturday departures, daily shuttles to the Choussy-Lépine thermal baths. Spacious vehicles accommodate pushchairs, spa luggage, and medical equipment. We adapt our schedules to your child's treatment programme for a smooth, stress-free thermal stay with no logistical worries." },
      { title: "Mountain roads in every season", desc: "The D2089 to La Bourboule winds through the Volcanoes Park with passages at 1,000 metres altitude. From November to April, our vehicles are systematically fitted with snow tyres and chains. Our drivers monitor Sancy weather alerts and adjust their route in case of black ice or snowfall. In summer, they take panoramic roads to make the journey as pleasant as possible." },
      { title: "Casino & heritage excursions", desc: "Beyond the thermal baths, our drivers introduce you to La Bourboule's Belle Époque heritage: the 1891 casino, the Grand Thermes, Fenestre Park. Hourly hire available for half-day excursions to Roche Vendeix, Puy Gros, or the Charlannes plateau. Combined circuits with Le Mont-Dore and the Sancy waterfalls possible for a full day of exploration." },
    ],
  },
  "le-mont-dore": {
    introFr: "Le Mont-Dore est une station de ski et de thermalisme d'altitude implantée au pied du Puy de Sancy, point culminant du Massif central à 1 886 mètres. Cette petite ville de caractère, traversée par la Dordogne naissante, conjugue depuis le XIXe siècle les plaisirs de la montagne et les bienfaits des eaux thermales. Les Thermes du Mont-Dore, établissement néo-byzantin inauguré en 1891, accueillent chaque année des milliers de curistes pour des traitements des voies respiratoires dans un cadre architectural exceptionnel — fresques, mosaïques et colonnes de marbre ornent les salles de soins. En hiver, la station de ski du Mont-Dore propose 31 pistes sur 41 km, du débutant au skieur confirmé, avec un panorama unique sur les volcans d'Auvergne. Le funiculaire du Capucin, construit en 1898 et l'un des plus anciens de France, constitue une attraction à lui seul : il transporte les visiteurs sur 500 mètres jusqu'au Salon du Capucin, point de vue remarquable sur la vallée. En été, Le Mont-Dore se transforme en paradis de la randonnée. Le téléphérique du Sancy hisse les marcheurs à 1 800 mètres en quelques minutes, d'où le sommet se rejoint en 20 minutes à pied. Les cascades sont omniprésentes : la Grande Cascade (32 m), la Cascade de la Dore, la Cascade du Queureuilh jalonnent les sentiers forestiers. TaxiNeo vous accompagne dans la découverte de tous ces trésors, du transfert depuis Clermont-Ferrand à la navette vers les pistes, en passant par les excursions vers les lacs de montagne de Guéry et de Servières.",
    introEn: "Le Mont-Dore is a mountain ski and thermal resort nestled at the foot of the Puy de Sancy, the highest point of the Massif Central at 1,886 metres. This characterful small town, crossed by the nascent Dordogne River, has combined mountain pleasures with the benefits of thermal waters since the 19th century. The Mont-Dore Thermal Baths, a neo-Byzantine building inaugurated in 1891, welcome thousands of patients each year for respiratory treatments in an architecturally exceptional setting — frescoes, mosaics, and marble columns adorn the treatment rooms. In winter, the Mont-Dore ski resort offers 31 runs across 41 km, from beginner to expert, with unique panoramas over the Auvergne volcanoes. The Capucin funicular, built in 1898 and one of the oldest in France, is an attraction in its own right: it carries visitors 500 metres up to the Salon du Capucin, an outstanding viewpoint over the valley. In summer, Le Mont-Dore transforms into a hiking paradise. The Sancy cable car lifts walkers to 1,800 metres in just minutes, from where the summit is a 20-minute walk. Waterfalls are everywhere: the Grande Cascade (32 m), the Cascade de la Dore, and the Cascade du Queureuilh punctuate the forest trails. TaxiNeo accompanies you in discovering all these treasures, from the transfer from Clermont-Ferrand to shuttle services to the slopes, including excursions to the mountain lakes of Guéry and Servières.",
    descriptionFr: "Le Mont-Dore est à 50 km de Clermont-Ferrand, soit environ 45 minutes par la D2089 puis la D996 — un trajet montagnard qui traverse des paysages volcaniques grandioses mais qui peut se révéler délicat en hiver. C'est précisément dans ces conditions que le taxi prend tout son sens : plutôt que de risquer la conduite sur des routes enneigées et parfois verglacées, confiez votre trajet à nos chauffeurs TaxiNeo, formés à la conduite en montagne et équipés en conséquence. De novembre à avril, chaque véhicule de notre flotte dispose de pneus neige homologués et de chaînes, prêtes à être posées au premier flocon. En été, le taxi reste la solution la plus pratique pour les randonneurs qui souhaitent atteindre le pied du téléphérique du Sancy sans les tracas du stationnement — les parkings sont saturés en juillet-août. Nos chauffeurs assurent également des mises à disposition à la journée pour les amateurs de cascades et de lacs : circuit Grande Cascade, lac de Guéry, lac de Servières, avec attente sur place. Pour les curistes, nous organisons des transferts réguliers entre les hébergements et l'établissement thermal, en respectant les horaires de soins souvent matinaux. La desserte depuis l'aéroport de Clermont-Ferrand Auvergne (Aulnat) est assurée pour tous les vols, y compris les arrivées tardives. Les familles apprécient nos véhicules spacieux qui accueillent skis, bagages et enfants en toute sécurité. Réservez à l'avance sur TaxiNeo pour garantir votre transfert aux dates souhaitées.",
    descriptionEn: "Le Mont-Dore lies 50 km from Clermont-Ferrand, approximately 45 minutes via the D2089 then the D996 — a mountain journey through grandiose volcanic landscapes that can prove tricky in winter. This is precisely when a taxi makes all the difference: rather than risking driving on snowy and sometimes icy roads, entrust your journey to our TaxiNeo drivers, trained in mountain driving and equipped accordingly. From November to April, every vehicle in our fleet carries approved snow tyres and chains, ready to be fitted at the first snowflake. In summer, the taxi remains the most practical solution for hikers wanting to reach the foot of the Sancy cable car without the hassle of parking — car parks are completely full in July and August. Our drivers also offer full-day hire for waterfall and lake enthusiasts: Grande Cascade circuit, Lac de Guéry, Lac de Servières, with on-site waiting. For spa patients, we organise regular transfers between accommodation and the thermal establishment, respecting the often early-morning treatment schedules. Airport service from Clermont-Ferrand Auvergne Airport (Aulnat) is guaranteed for all flights, including late arrivals. Families appreciate our spacious vehicles that safely accommodate skis, luggage, and children. Book in advance on TaxiNeo to secure your transfer on your preferred dates.",
    metaDescriptionFr: "Taxi au Mont-Dore : sommet du Puy de Sancy, ski alpin, thermes historiques, funiculaire du Capucin. Réservez votre transfert depuis Clermont en 45 min.",
    metaDescriptionEn: "Taxi in Le Mont-Dore: Puy de Sancy summit, alpine skiing, historic thermal baths and Capucin funicular. Book your transfer from Clermont-Ferrand, 45 min.",
    heroSubtitleFr: "Au pied du Puy de Sancy, point culminant du Massif central à 1 886 m, Le Mont-Dore conjugue ski alpin sur 31 pistes, thermes historiques néo-byzantins et funiculaire du Capucin datant de 1898. Transferts sécurisés depuis Clermont-Ferrand en 45 minutes, véhicules équipés montagne, excursions cascades et lacs toute l'année.",
    heroSubtitleEn: "At the foot of the Puy de Sancy, the Massif Central's highest peak at 1,886 m, Le Mont-Dore combines alpine skiing across 31 runs, historic neo-Byzantine thermal baths, and the 1898 Capucin funicular. Secure transfers from Clermont-Ferrand in 45 minutes, mountain-equipped vehicles, waterfall and lake excursions year-round.",
    whyUsFr: [
      { title: "Experts des routes du Sancy", desc: "La D996 vers Le Mont-Dore franchit le col de la Croix-Morand à plus de 1 400 m d'altitude — un passage parfois fermé en hiver. Nos chauffeurs connaissent chaque virage, chaque itinéraire de substitution, et disposent d'informations météo en temps réel. Ils empruntent la D2089 puis bifurquent sur la D996 pour un trajet de 45 minutes optimisé, sûr en toute saison." },
      { title: "Navettes ski et funiculaire", desc: "En saison hivernale, nous assurons des rotations quotidiennes entre les hébergements du Mont-Dore et les remontées mécaniques. Notre service couvre aussi le funiculaire du Capucin : dépose au pied de la gare de départ, récupération au retour. Idéal pour les familles qui veulent profiter de la montagne sans gérer le stationnement et les routes verglacées." },
      { title: "Circuits cascades et sommets", desc: "En été, nos chauffeurs proposent des circuits sur mesure : Grande Cascade le matin, pique-nique au lac de Guéry à midi, téléphérique du Sancy l'après-midi. Mise à disposition à la demi-journée ou à la journée avec attente sur site. Chaque circuit est adaptable selon la météo et les envies, pour profiter pleinement du Massif du Sancy sans contrainte logistique." },
    ],
    whyUsEn: [
      { title: "Sancy road experts", desc: "The D996 to Le Mont-Dore crosses the Col de la Croix-Morand at over 1,400 m altitude — a pass that is sometimes closed in winter. Our drivers know every bend, every alternative route, and have real-time weather information. They take the D2089 then turn onto the D996 for an optimised 45-minute journey, safe in any season." },
      { title: "Ski & funicular shuttles", desc: "During the ski season, we run daily rotations between Mont-Dore accommodation and the ski lifts. Our service also covers the Capucin funicular: drop-off at the bottom station, pick-up on return. Perfect for families wanting to enjoy the mountain without dealing with parking and icy roads." },
      { title: "Waterfall & summit circuits", desc: "In summer, our drivers offer bespoke circuits: Grande Cascade in the morning, picnic at Lac de Guéry at noon, Sancy cable car in the afternoon. Half-day or full-day hire with on-site waiting. Each circuit is adaptable according to weather and preferences, allowing you to fully enjoy the Sancy Massif without any logistical constraints." },
    ],
  },
  murol: {
    introFr: "Murol est un village de caractère dont la silhouette est dominée par l'imposant château-forteresse du XIIe siècle qui trône sur un piton basaltique. Classé Monument Historique, le château de Murol est l'un des châteaux médiévaux les mieux conservés d'Auvergne et attire chaque été plus de 100 000 visiteurs grâce à ses spectacles de chevalerie vivante. Des troupes de comédiens en armure y reconstituent la vie quotidienne au Moyen Âge : joutes équestres, combats à l'épée, banquets médiévaux et scènes de la vie seigneuriale transportent petits et grands dans un voyage temporel saisissant. Le village lui-même mérite la flânerie avec ses ruelles pavées, ses maisons de pierre volcanique et son église Saint-Ferréol du XIIe siècle ornée de chapiteaux historiés. À moins de deux kilomètres, le lac Chambon déploie ses plages de sable volcanique noir et gris, uniques en France métropolitaine. Ce lac de 60 hectares, formé par un éboulement volcanique, offre une baignade surveillée en été, des activités nautiques variées — pédalo, canoë, stand-up paddle — et une promenade boisée faisant le tour du lac en environ deux heures. Murol est aussi un point de départ stratégique vers Super Besse (10 min) et le Puy de Sancy (20 min), ce qui en fait un camp de base idéal pour explorer le Massif du Sancy en toute saison. TaxiNeo vous transporte au cœur de cette Auvergne médiévale et volcanique, que ce soit pour un transfert depuis Clermont-Ferrand ou une navette entre le château, le lac et les stations de ski environnantes.",
    introEn: "Murol is a village of character whose skyline is dominated by the imposing 12th-century fortress castle perched on a basalt peak. Listed as a Historic Monument, Murol Castle is one of the best-preserved medieval castles in Auvergne and attracts over 100,000 visitors each summer through its living chivalry shows. Troupes of actors in armour re-enact daily life in the Middle Ages: jousting tournaments, sword fights, medieval banquets, and scenes of lordly life transport young and old alike on a gripping journey through time. The village itself is worth exploring, with its cobbled lanes, volcanic stone houses, and the 12th-century Church of Saint-Ferréol adorned with historiated capitals. Less than two kilometres away, Lac Chambon unfolds its beaches of black and grey volcanic sand, unique in mainland France. This 60-hectare lake, formed by a volcanic landslide, offers supervised swimming in summer, varied water sports — pedalo, canoeing, stand-up paddleboarding — and a wooded path circling the lake in approximately two hours. Murol is also a strategic starting point for Super Besse (10 min) and the Puy de Sancy (20 min), making it an ideal base camp for exploring the Sancy Massif in any season. TaxiNeo transports you to the heart of this medieval and volcanic Auvergne, whether for a transfer from Clermont-Ferrand or a shuttle between the castle, the lake, and the surrounding ski resorts.",
    descriptionFr: "Murol se situe à 40 km de Clermont-Ferrand, soit environ 40 minutes de route par la D996, une route agréable qui traverse les paysages vallonnés du Parc des Volcans d'Auvergne. Si le trajet est plaisant, le stationnement à Murol devient un véritable casse-tête en haute saison touristique : les parkings du château et des plages du lac Chambon sont rapidement saturés dès 10 heures du matin en juillet et août. Le taxi élimine totalement ce problème. Nos chauffeurs TaxiNeo vous déposent directement au pied du château ou à la plage de votre choix et reviennent vous chercher à l'heure convenue. Pour les familles — et Murol est par excellence une destination familiale —, ce service est particulièrement apprécié : plus besoin de porter parasols, glacières et jouets de plage sur des centaines de mètres depuis un parking éloigné. Nous proposons des navettes régulières entre le village de Murol, les plages du lac Chambon et le château, ainsi que des transferts vers Super Besse et le téléphérique du Sancy pour combiner plage et montagne dans la même journée. Nos chauffeurs peuvent également vous conduire à Beaune-le-Froid, petit hameau réputé pour son fromage Saint-Nectaire fermier, pour une halte gastronomique entre deux visites. Le service fonctionne de Pâques à la Toussaint avec une disponibilité renforcée en juillet-août. Transferts depuis l'aéroport de Clermont-Ferrand Auvergne disponibles sur réservation toute l'année.",
    descriptionEn: "Murol lies 40 km from Clermont-Ferrand, approximately 40 minutes by road via the D996, a pleasant route through the rolling landscapes of the Auvergne Volcanoes Park. While the drive is enjoyable, parking in Murol becomes a real headache during peak tourist season: the castle and Lac Chambon beach car parks fill up completely by 10 am in July and August. A taxi eliminates this problem entirely. Our TaxiNeo drivers drop you directly at the foot of the castle or at the beach of your choice and return to collect you at the agreed time. For families — and Murol is the quintessential family destination — this service is particularly appreciated: no more carrying parasols, cool boxes, and beach toys for hundreds of metres from a distant car park. We offer regular shuttles between Murol village, Lac Chambon beaches, and the castle, as well as transfers to Super Besse and the Sancy cable car to combine beach and mountain in the same day. Our drivers can also take you to Beaune-le-Froid, a small hamlet renowned for its farmhouse Saint-Nectaire cheese, for a gastronomic stop between visits. The service operates from Easter to All Saints' Day with reinforced availability in July and August. Transfers from Clermont-Ferrand Auvergne Airport are available by reservation year-round.",
    metaDescriptionFr: "Taxi à Murol : château médiéval du XIIe siècle, spectacles de chevaliers, plages du lac Chambon. Transferts familles depuis Clermont-Ferrand en 40 min.",
    metaDescriptionEn: "Taxi in Murol: 12th-century medieval castle with knight shows, Lac Chambon beaches. Family-friendly transfers from Clermont-Ferrand in 40 min. Book now.",
    heroSubtitleFr: "Dominé par sa forteresse médiévale du XIIe siècle où se jouent des spectacles de chevalerie vivante, Murol est la destination familiale incontournable d'Auvergne. Plages de sable volcanique sur le lac Chambon, porte d'entrée vers Super Besse et le Sancy. Transferts confortables depuis Clermont-Ferrand en 40 minutes, navettes château-lac en saison.",
    heroSubtitleEn: "Dominated by its 12th-century medieval fortress hosting live chivalry shows, Murol is Auvergne's essential family destination. Volcanic sand beaches on Lac Chambon, gateway to Super Besse and Sancy. Comfortable transfers from Clermont-Ferrand in 40 minutes, castle-lake shuttles in season.",
    whyUsFr: [
      { title: "Transfert château sans parking", desc: "Le parking du château de Murol est limité à 80 places et complet dès le matin en été. Nos chauffeurs vous déposent directement au pied du sentier d'accès au château et reviennent vous chercher après le spectacle de chevalerie. Fini le stress du stationnement : vous profitez de la visite sans contrainte, avec un chauffeur qui vous attend à l'heure convenue au point de rendez-vous." },
      { title: "Navettes plage lac Chambon", desc: "En été, nous assurons des rotations entre le village de Murol et les trois plages aménagées du lac Chambon. Dépose le matin avec vos affaires de plage, récupération en fin d'après-midi — ou navettes à la demande toute la journée. Idéal pour les familles avec jeunes enfants qui veulent profiter de la baignade surveillée et des pédalos sans les tracas logistiques." },
      { title: "Circuit médiéval et fromager", desc: "Nos chauffeurs proposent un circuit exclusif combinant le château de Murol, une dégustation de Saint-Nectaire fermier à Beaune-le-Froid et un déjeuner en ferme-auberge. Mise à disposition de 4 heures incluant les temps d'attente. Ce circuit gastronomique et patrimonial est notre excursion la plus demandée par les visiteurs séjournant dans la région du Sancy." },
    ],
    whyUsEn: [
      { title: "Castle transfer, no parking", desc: "Murol Castle's car park is limited to 80 spaces and fills up by morning in summer. Our drivers drop you directly at the foot of the castle access path and return to collect you after the chivalry show. No more parking stress: enjoy your visit without constraints, with a driver waiting for you at the agreed time and meeting point." },
      { title: "Lac Chambon beach shuttles", desc: "In summer, we run rotations between Murol village and the three managed beaches of Lac Chambon. Morning drop-off with your beach gear, late afternoon pick-up — or on-demand shuttles throughout the day. Perfect for families with young children who want to enjoy the supervised swimming and pedalos without logistical hassle." },
      { title: "Medieval & cheese circuit", desc: "Our drivers offer an exclusive circuit combining Murol Castle, a farmhouse Saint-Nectaire cheese tasting in Beaune-le-Froid, and a farm-inn lunch. Four-hour hire including waiting times. This gastronomic and heritage circuit is our most requested excursion among visitors staying in the Sancy region." },
    ],
  },
  "chambon-sur-lac": {
    introFr: "Chambon-sur-Lac est un village d'une tranquillité rare, lové sur la rive orientale du lac Chambon, vaste plan d'eau de 60 hectares né d'un effondrement volcanique il y a environ 8 500 ans. Ce lac, dont les eaux oscillent entre le bleu profond et le vert émeraude selon la lumière, constitue l'un des paysages les plus photogéniques du Massif central. Contrairement à la rive occidentale partagée avec Murol, plus touristique et animée, la rive de Chambon-sur-Lac offre une atmosphère paisible, presque contemplative, qui attire les visiteurs en quête de sérénité. Le village possède une charmante église romane du XIIe siècle, avec son clocher à peigne typiquement auvergnat, qui mérite une halte. Mais le trésor naturel de Chambon-sur-Lac se trouve à quelques minutes au sud : la réserve naturelle nationale de la Vallée de Chaudefour, classée depuis 1991, est un cirque glaciaire spectaculaire encadré de falaises volcaniques abritant une biodiversité exceptionnelle. Chamois, mouflons, faucons pèlerins et plus de 1 200 espèces végétales cohabitent dans cet amphithéâtre naturel. Les randonneurs y trouvent des sentiers pour tous les niveaux, du chemin de découverte balisé de 2 heures aux ascensions exigeantes vers le Puy de Cacadogne (1 783 m) ou la Crête de Coq (1 785 m). En été, les plages du lac Chambon offrent une baignade surveillée dans une eau agréablement tempérée par le sol volcanique, complétée par des activités nautiques douces. TaxiNeo est votre allié pour accéder à ce havre de paix, que ce soit depuis Clermont-Ferrand ou pour des navettes entre le lac, la réserve et les sommets environnants.",
    introEn: "Chambon-sur-Lac is a village of rare tranquility, nestled on the eastern shore of Lac Chambon, a vast 60-hectare body of water born from a volcanic collapse approximately 8,500 years ago. This lake, whose waters shift between deep blue and emerald green depending on the light, forms one of the most photogenic landscapes in the Massif Central. Unlike the western shore shared with the more touristy and lively Murol, Chambon-sur-Lac's shore offers a peaceful, almost contemplative atmosphere that attracts visitors seeking serenity. The village has a charming 12th-century Romanesque church, with its typically Auvergnat comb bell tower, well worth a stop. But Chambon-sur-Lac's natural treasure lies a few minutes to the south: the Chaudefour Valley National Nature Reserve, classified since 1991, is a spectacular glacial cirque framed by volcanic cliffs sheltering exceptional biodiversity. Chamois, mouflons, peregrine falcons, and over 1,200 plant species coexist in this natural amphitheatre. Hikers find trails for all levels, from a 2-hour marked discovery path to demanding ascents to the Puy de Cacadogne (1,783 m) or the Crête de Coq (1,785 m). In summer, Lac Chambon's beaches offer supervised swimming in water pleasantly warmed by the volcanic soil, complemented by gentle water sports. TaxiNeo is your ally for accessing this haven of peace, whether from Clermont-Ferrand or for shuttles between the lake, the nature reserve, and the surrounding peaks.",
    descriptionFr: "Chambon-sur-Lac se situe à 42 km de Clermont-Ferrand, soit environ 42 minutes par la D996 — une route qui, après Murol, s'enfonce dans une vallée de plus en plus préservée où la nature reprend ses droits. L'absence totale de transports en commun rend le taxi indispensable pour quiconque ne dispose pas de véhicule personnel. Cette réalité est d'autant plus marquée que les visiteurs de Chambon-sur-Lac sont souvent des randonneurs, des naturalistes ou des familles en quête de calme, pas nécessairement des conducteurs aguerris sur les petites routes de montagne. Nos chauffeurs TaxiNeo connaissent intimement la géographie locale : ils savent quel parking utiliser pour la réserve de Chaudefour selon l'affluence, quelle plage du lac est la moins fréquentée le matin, et quel sentier est accessible après une pluie d'orage. Pour les randonneurs, nous proposons un service précieux : dépose au départ d'un sentier et récupération à un autre point, évitant ainsi les fastidieuses boucles de retour au parking. La réserve naturelle de Chaudefour, accessible par une petite route depuis Chambon-sur-Lac, voit son parking complet dès 9 heures en été — le taxi résout ce problème. Nous assurons également les transferts depuis Clermont-Ferrand et l'aéroport pour les visiteurs arrivant de loin, ainsi que des navettes vers Murol (5 min), Le Mont-Dore (20 min) et Super Besse (15 min). Le village étant un séjour de ressourcement, nos chauffeurs adoptent une conduite calme et prévenante, à l'image de l'atmosphère de Chambon-sur-Lac.",
    descriptionEn: "Chambon-sur-Lac lies 42 km from Clermont-Ferrand, approximately 42 minutes via the D996 — a road that, beyond Murol, winds into an increasingly unspoilt valley where nature reigns supreme. The complete absence of public transport makes taxis essential for anyone without their own vehicle. This reality is all the more relevant as Chambon-sur-Lac visitors are often hikers, naturalists, or families seeking peace, not necessarily experienced drivers on narrow mountain roads. Our TaxiNeo drivers know the local geography intimately: they know which car park to use for the Chaudefour reserve depending on crowds, which lake beach is least busy in the morning, and which trail is accessible after a thunderstorm. For hikers, we offer an invaluable service: drop-off at one trailhead and pick-up at another, eliminating tedious loop returns to the car park. The Chaudefour nature reserve, accessible by a small road from Chambon-sur-Lac, sees its car park full by 9 am in summer — the taxi solves this problem. We also provide transfers from Clermont-Ferrand and the airport for visitors arriving from afar, as well as shuttles to Murol (5 min), Le Mont-Dore (20 min), and Super Besse (15 min). As the village is a place for rejuvenation, our drivers adopt a calm and considerate driving style, in keeping with the atmosphere of Chambon-sur-Lac.",
    metaDescriptionFr: "Taxi à Chambon-sur-Lac : lac volcanique, réserve naturelle de la vallée de Chaudefour, randonnées Sancy. Transferts depuis Clermont-Ferrand en 42 minutes.",
    metaDescriptionEn: "Taxi in Chambon-sur-Lac: volcanic lake, Chaudefour Valley nature reserve, Sancy hiking trails. Peaceful transfers from Clermont-Ferrand in 42 min. Book now.",
    heroSubtitleFr: "Havre de sérénité sur les rives du lac Chambon, Chambon-sur-Lac est la porte d'entrée de la réserve naturelle de Chaudefour, cirque glaciaire d'une biodiversité exceptionnelle. Lac volcanique aux eaux émeraude, randonnées vers les crêtes du Sancy et plages paisibles. Transferts depuis Clermont-Ferrand en 42 minutes, navettes randonnée sur mesure.",
    heroSubtitleEn: "A haven of serenity on the shores of Lac Chambon, Chambon-sur-Lac is the gateway to the Chaudefour nature reserve, a glacial cirque of exceptional biodiversity. Volcanic lake with emerald waters, hikes to the Sancy ridges and peaceful beaches. Transfers from Clermont-Ferrand in 42 minutes, bespoke hiking shuttles.",
    whyUsFr: [
      { title: "Navettes réserve de Chaudefour", desc: "Le parking de la Vallée de Chaudefour est complet dès 9h en été. Nos chauffeurs vous déposent à l'entrée de la réserve naturelle et reviennent vous chercher à la sortie de votre randonnée. Ce service porte-à-porte vous libère du stress du stationnement et vous permet de profiter pleinement de ce cirque glaciaire classé, peuplé de chamois, mouflons et faucons pèlerins." },
      { title: "Service point-à-point randonnée", desc: "Pour les randonneurs traversants, nous proposons un service unique : dépose au parking de Chaudefour le matin, récupération au col de la Croix-Saint-Robert ou au Mont-Dore en fin de journée. Plus besoin de faire une boucle pour retrouver votre voiture. Nos chauffeurs connaissent les temps de marche et s'adaptent à votre rythme pour un rendez-vous fiable." },
      { title: "Sérénité et cadre préservé", desc: "Chambon-sur-Lac n'est pas une station touristique bruyante : c'est un village authentique où le temps ralentit. Nos chauffeurs respectent cette atmosphère avec une conduite douce et discrète. Transferts depuis Clermont-Ferrand sans précipitation, conseils personnalisés sur les meilleures plages tranquilles du lac et les criques secrètes accessibles à pied." },
    ],
    whyUsEn: [
      { title: "Chaudefour reserve shuttles", desc: "The Chaudefour Valley car park is full by 9 am in summer. Our drivers drop you at the nature reserve entrance and return to collect you at the end of your hike. This door-to-door service frees you from parking stress and allows you to fully enjoy this classified glacial cirque, home to chamois, mouflons, and peregrine falcons." },
      { title: "Point-to-point hiking service", desc: "For through-hikers, we offer a unique service: drop-off at the Chaudefour car park in the morning, pick-up at the Col de la Croix-Saint-Robert or Le Mont-Dore at the end of the day. No more looping back to find your car. Our drivers know the walking times and adapt to your pace for a reliable meeting point." },
      { title: "Serenity and unspoilt setting", desc: "Chambon-sur-Lac is not a noisy tourist resort: it is an authentic village where time slows down. Our drivers respect this atmosphere with smooth, discreet driving. Unhurried transfers from Clermont-Ferrand, personalised advice on the best quiet lake beaches, and secret coves accessible on foot." },
    ],
  },
  aydat: {
    introFr: "Aydat est une commune privilégiée du Puy-de-Dôme qui abrite le plus grand lac naturel d'Auvergne : 65 hectares de plan d'eau formé il y a 8 600 ans lorsqu'une coulée de lave du Puy de la Vache a barré le cours de la Veyre. Cette origine volcanique donne au lac d'Aydat un caractère unique — ses rives mêlent prairies verdoyantes, plages aménagées et petites criques boisées, le tout dans un cadre montagnard accessible à seulement 25 km de Clermont-Ferrand. Cette proximité fait du lac d'Aydat la destination nature de prédilection des Clermontois : le week-end ensoleillé, des milliers de familles convergent vers ses plages pour la baignade (surveillée de mi-juin à mi-septembre), le kayak, le pédalo, le stand-up paddle et la pêche. La base nautique d'Aydat, labellisée France Station Nautique, propose des cours et des locations pour tous les niveaux. Mais Aydat ne se résume pas à son lac. Le Puy de la Vache et le Puy de Lassolas, volcans jumeaux situés au sud de la commune, offrent l'une des randonnées les plus spectaculaires de la Chaîne des Puys : en 45 minutes de marche facile, on atteint les cratères éventrés d'où la lave s'est écoulée jusqu'au lac. Le panorama à 360 degrés embrasse l'ensemble de la Chaîne des Puys, classée au patrimoine mondial de l'UNESCO, et par temps clair, le Puy de Sancy au sud. L'église romane d'Aydat, sobre et élégante, témoigne d'un passé médiéval discret mais authentique. TaxiNeo vous transporte vers tous ces trésors avec la rapidité et le confort d'un service de taxi professionnel.",
    introEn: "Aydat is a privileged commune in the Puy-de-Dôme department that is home to the largest natural lake in Auvergne: 65 hectares of water formed 8,600 years ago when a lava flow from the Puy de la Vache blocked the course of the Veyre River. This volcanic origin gives Lac d'Aydat a unique character — its shores blend green meadows, managed beaches, and small wooded coves, all in a mountain setting just 25 km from Clermont-Ferrand. This proximity makes Lac d'Aydat the go-to nature destination for locals: on sunny weekends, thousands of families converge on its beaches for swimming (supervised from mid-June to mid-September), kayaking, pedalo, stand-up paddleboarding, and fishing. The Aydat water sports centre, awarded the France Station Nautique label, offers courses and equipment hire for all levels. But Aydat is more than its lake. The Puy de la Vache and Puy de Lassolas, twin volcanoes located south of the commune, offer one of the most spectacular hikes on the Chaîne des Puys: in 45 minutes of easy walking, you reach the breached craters from which lava flowed all the way to the lake. The 360-degree panorama encompasses the entire Chaîne des Puys, a UNESCO World Heritage Site, and on clear days, the Puy de Sancy to the south. The Romanesque church of Aydat, sober and elegant, bears witness to a discreet but authentic medieval past. TaxiNeo transports you to all these treasures with the speed and comfort of a professional taxi service.",
    descriptionFr: "Aydat est à 25 minutes de Clermont-Ferrand par la D2089, l'une des routes les plus empruntées du département en été. Et c'est précisément là que le bât blesse : les week-ends de juillet et août, la route d'accès au lac d'Aydat est saturée et les parkings débordent. Trouver une place de stationnement à proximité de la plage relève du parcours du combattant. Le taxi TaxiNeo transforme cette galère en moment de détente : nos chauffeurs vous déposent directement à la plage principale ou à la base nautique, et vous n'avez plus qu'à profiter de l'eau. Service de récupération en fin de journée à l'heure de votre choix. Pour les familles clermontoises sans voiture, le taxi vers Aydat est la solution idéale : en 25 minutes, vous passez de la ville au lac sans les contraintes du transport en commun (inexistant sur cette ligne le week-end). Nos chauffeurs proposent également des mises à disposition pour combiner lac et volcans dans la même journée : matinée baignade, déjeuner au bord de l'eau, puis transfert vers le parking du Puy de la Vache pour la randonnée de l'après-midi. Les amateurs de pêche apprécient nos transferts matinaux (dès 5h) vers les rives les plus poissonneuses, loin des plages. En soirée d'été, le lac d'Aydat accueille des concerts et des feux d'artifice — nous assurons le retour vers Clermont en toute sécurité, même tard dans la nuit. Réservation en ligne recommandée les week-ends d'été.",
    descriptionEn: "Aydat is 25 minutes from Clermont-Ferrand via the D2089, one of the most heavily used roads in the department during summer. And therein lies the problem: on July and August weekends, the access road to Lac d'Aydat is saturated and car parks overflow. Finding a parking space near the beach becomes an ordeal. A TaxiNeo taxi transforms this frustration into relaxation: our drivers drop you directly at the main beach or the water sports centre, and all you have to do is enjoy the water. End-of-day pick-up service at the time of your choice. For Clermont families without a car, a taxi to Aydat is the perfect solution: in 25 minutes, you go from city to lake without the constraints of public transport (non-existent on this route at weekends). Our drivers also offer full-day hire to combine lake and volcanoes: morning swimming, lakeside lunch, then transfer to the Puy de la Vache car park for the afternoon hike. Fishing enthusiasts appreciate our early-morning transfers (from 5 am) to the best fishing shores, away from the beaches. On summer evenings, Lac d'Aydat hosts concerts and firework displays — we provide safe transport back to Clermont, even late at night. Online booking is recommended for summer weekends.",
    metaDescriptionFr: "Taxi à Aydat, plus grand lac naturel d'Auvergne : volcan Puy de la Vache, sports nautiques, plage surveillée. À 25 min de Clermont. Réservez en ligne.",
    metaDescriptionEn: "Taxi in Aydat, home to Auvergne's largest natural lake: Puy de la Vache volcano, water sports, supervised beach. Only 25 min from Clermont. Book online.",
    heroSubtitleFr: "Plus grand lac naturel d'Auvergne avec 65 hectares d'eau née d'une coulée de lave volcanique, Aydat est le poumon vert des Clermontois à seulement 25 minutes de la ville. Plage surveillée, base nautique labellisée, kayak, pédalo, et randonnées vers les cratères jumeaux du Puy de la Vache et du Puy de Lassolas sur la Chaîne des Puys UNESCO.",
    heroSubtitleEn: "Auvergne's largest natural lake spanning 65 hectares of water born from a volcanic lava flow, Aydat is the green lung of Clermont locals just 25 minutes from the city. Supervised beach, certified water sports centre, kayaking, pedalo, and hikes to the twin craters of Puy de la Vache and Puy de Lassolas on the UNESCO Chaîne des Puys.",
    whyUsFr: [
      { title: "Échapper aux bouchons du lac", desc: "Les week-ends d'été, la D2089 vers Aydat est embouteillée et les parkings sont complets avant 11h. Nos chauffeurs connaissent les itinéraires alternatifs par Ceyrat et Saint-Saturnin qui évitent les ralentissements. Ils vous déposent directement à la plage principale, à la base nautique ou aux criques plus secrètes de la rive nord. Retour à l'heure convenue, sans stress et sans amende de stationnement." },
      { title: "Excursion lac et volcans combinée", desc: "Notre circuit signature Aydat combine matinée au lac (baignade, kayak) et après-midi aux volcans (Puy de la Vache et Puy de Lassolas). Le chauffeur vous transfère du lac au parking des volcans en 10 minutes, attend pendant votre randonnée de 1h30, puis vous ramène à Clermont. Une journée complète de nature sans voiture, idéale pour les familles ou les groupes d'amis en visite." },
      { title: "Transferts soirées et événements", desc: "Le lac d'Aydat accueille des concerts, des marchés nocturnes et un feu d'artifice du 14 juillet mémorable. Nos chauffeurs assurent les transferts aller-retour pour ces événements estivaux, y compris les retours tardifs après minuit. Vous profitez de la soirée sans vous soucier de la conduite de nuit sur les routes de campagne. Réservation à l'avance recommandée pour le 14 juillet." },
    ],
    whyUsEn: [
      { title: "Escape the lake traffic jams", desc: "On summer weekends, the D2089 to Aydat is gridlocked and car parks are full before 11 am. Our drivers know alternative routes via Ceyrat and Saint-Saturnin that bypass the congestion. They drop you directly at the main beach, the water sports centre, or the more secluded coves on the north shore. Pick-up at the agreed time, stress-free and without a parking fine." },
      { title: "Combined lake & volcano excursion", desc: "Our signature Aydat circuit combines a morning at the lake (swimming, kayaking) and an afternoon at the volcanoes (Puy de la Vache and Puy de Lassolas). The driver transfers you from the lake to the volcano car park in 10 minutes, waits during your 1.5-hour hike, then takes you back to Clermont. A full day of nature without a car, ideal for families or visiting groups of friends." },
      { title: "Evening & event transfers", desc: "Lac d'Aydat hosts concerts, night markets, and a memorable Bastille Day fireworks display. Our drivers provide round-trip transfers for these summer events, including late returns after midnight. You enjoy the evening without worrying about driving at night on country roads. Advance booking recommended for Bastille Day." },
    ],
  },
  orcival: {
    introFr: "Orcival est un petit village d'à peine 250 âmes, blotti au fond d'une vallée verdoyante du Parc naturel régional des Volcans d'Auvergne, dont la renommée dépasse largement les frontières de la région grâce à un joyau architectural exceptionnel : la basilique Notre-Dame d'Orcival. Édifiée au XIIe siècle dans le plus pur style roman auvergnat, cette église est considérée par les historiens de l'art comme l'un des cinq chefs-d'œuvre majeurs de l'art roman en Auvergne, aux côtés de Notre-Dame-du-Port à Clermont-Ferrand, Saint-Austremoine d'Issoire, Notre-Dame de Saint-Nectaire et Saint-Saturnin. Sa Vierge en majesté, statue reliquaire en bois recouvert d'argent datant du XIIe siècle, attire depuis huit siècles des pèlerins venus de toute la France et d'Europe. Le jeudi de l'Ascension, une procession aux flambeaux rassemble des milliers de fidèles dans les ruelles du village — un spectacle saisissant de dévotion populaire. À un kilomètre du bourg, le château de Cordès dévoile ses jardins à la française dessinés par André Le Nôtre, le paysagiste de Versailles, dans un cadre montagnard inattendu. Plus haut encore, le lac de Servières, lac de cratère niché à 1 200 mètres d'altitude, offre un paysage de bout du monde avec ses eaux sombres et profondes cernées de forêts de sapins. Interdit à la baignade pour préserver son écosystème fragile, il est un paradis pour les promeneurs contemplatifs et les photographes. TaxiNeo vous ouvre les portes de ce patrimoine remarquable avec des transferts depuis Clermont-Ferrand et des circuits patrimoine personnalisés.",
    introEn: "Orcival is a tiny village of barely 250 souls, tucked away in a green valley of the Auvergne Volcanoes Regional Nature Park, whose renown extends far beyond the region's borders thanks to an exceptional architectural gem: the Notre-Dame d'Orcival basilica. Built in the 12th century in the purest Auvergnat Romanesque style, this church is considered by art historians as one of the five major masterpieces of Romanesque art in Auvergne, alongside Notre-Dame-du-Port in Clermont-Ferrand, Saint-Austremoine in Issoire, Notre-Dame in Saint-Nectaire, and Saint-Saturnin. Its Virgin in Majesty, a reliquary statue in wood covered with silver dating from the 12th century, has attracted pilgrims from across France and Europe for eight centuries. On Ascension Thursday, a torchlight procession gathers thousands of faithful in the village lanes — a striking display of popular devotion. One kilometre from the village centre, the Chateau de Cordes reveals its formal French gardens designed by Andre Le Notre, the landscaper of Versailles, in an unexpected mountain setting. Higher still, Lac de Servieres, a crater lake nestled at 1,200 metres altitude, offers an end-of-the-world landscape with its dark, deep waters ringed by fir forests. Swimming is forbidden to preserve its fragile ecosystem, making it a paradise for contemplative walkers and photographers. TaxiNeo opens the doors to this remarkable heritage with transfers from Clermont-Ferrand and personalised heritage circuits.",
    descriptionFr: "Orcival se situe à 30 km de Clermont-Ferrand, soit 30 minutes par la D941, une route qui s'élève progressivement à travers les forêts de hêtres et de sapins du Parc des Volcans. Ce village est un détour que peu de touristes regrettent, mais que beaucoup peinent à rejoindre faute de transport en commun — aucun bus ne dessert Orcival. Le taxi est donc le seul moyen de transport pratique pour les visiteurs sans voiture, et c'est une réalité que nos chauffeurs TaxiNeo connaissent bien. Nous assurons des transferts quotidiens depuis Clermont-Ferrand, l'aéroport et la gare, avec un service particulièrement sollicité lors des pèlerinages (Ascension, 15 août) et des journées du patrimoine en septembre. Nos chauffeurs ne sont pas de simples conducteurs : ils connaissent l'histoire de la basilique, les horaires des offices et des visites guidées, les jours d'ouverture du château de Cordès (limités au printemps et à l'été) et les meilleures heures pour photographier le lac de Servières sans contre-jour. Pour les amateurs d'art roman, nous proposons un circuit patrimoine d'une journée reliant les cinq églises romanes majeures d'Auvergne : départ d'Orcival, puis Saint-Nectaire, Issoire, Saint-Saturnin et retour par Clermont-Ferrand — une immersion unique dans huit siècles d'architecture sacrée. Le lac de Servières, accessible par une petite route de montagne sinueuse, se mérite : nos chauffeurs vous y conduisent en toute sécurité et vous attendent au parking pendant votre promenade autour du lac (environ 1 heure). Réservation recommandée en mai et juin pour les pèlerinages.",
    descriptionEn: "Orcival lies 30 km from Clermont-Ferrand, a 30-minute drive via the D941, a road that rises gradually through the beech and fir forests of the Volcanoes Park. This village is a detour few tourists regret, but many struggle to reach due to the complete absence of public transport — no bus serves Orcival. A taxi is therefore the only practical means of transport for visitors without a car, a reality our TaxiNeo drivers know well. We provide daily transfers from Clermont-Ferrand, the airport, and the railway station, with particularly high demand during pilgrimages (Ascension, 15 August) and Heritage Days in September. Our drivers are more than mere chauffeurs: they know the history of the basilica, the schedules of services and guided tours, the opening days of the Chateau de Cordes (limited to spring and summer), and the best times to photograph Lac de Servieres without backlighting. For Romanesque art enthusiasts, we offer a full-day heritage circuit linking the five major Romanesque churches of Auvergne: departing from Orcival, then Saint-Nectaire, Issoire, Saint-Saturnin, and returning via Clermont-Ferrand — a unique immersion in eight centuries of sacred architecture. Lac de Servieres, accessible via a winding mountain road, is worth the effort: our drivers take you there safely and wait in the car park during your walk around the lake (approximately 1 hour). Booking recommended in May and June for pilgrimages.",
    metaDescriptionFr: "Taxi à Orcival : basilique romane, chef-d'œuvre de l'art auvergnat, château de Cordès, lac de Servières. Village du Parc des Volcans, 30 min de Clermont.",
    metaDescriptionEn: "Taxi in Orcival: Romanesque basilica masterpiece, Château de Cordès gardens, Lac de Servières. Volcanoes Park village, 30 min from Clermont. Book now.",
    heroSubtitleFr: "Écrin de l'un des cinq chefs-d'œuvre de l'art roman auvergnat, Orcival abrite une basilique du XIIe siècle et sa Vierge en majesté vénérée depuis huit cents ans. Château de Cordès aux jardins Le Nôtre, lac de cratère de Servières à 1 200 m. Transferts depuis Clermont-Ferrand en 30 minutes, circuits patrimoine roman sur mesure.",
    heroSubtitleEn: "Home to one of the five masterpieces of Auvergnat Romanesque art, Orcival houses a 12th-century basilica and its Virgin in Majesty venerated for eight hundred years. Chateau de Cordes with Le Notre gardens, Servieres crater lake at 1,200 m. Transfers from Clermont-Ferrand in 30 minutes, bespoke Romanesque heritage circuits.",
    whyUsFr: [
      { title: "Circuit cinq églises romanes", desc: "Orcival est le point de départ idéal du circuit des cinq églises romanes majeures d'Auvergne. Nos chauffeurs vous conduisent de la basilique Notre-Dame d'Orcival à Saint-Nectaire, Issoire (Saint-Austremoine), Saint-Saturnin et Notre-Dame-du-Port à Clermont-Ferrand. Mise à disposition à la journée avec temps d'arrêt à chaque site. Un voyage de huit siècles dans la pierre volcanique sculptée." },
      { title: "Château de Cordès et jardins", desc: "Le château de Cordès, à 1 km de la basilique, n'ouvre ses portes qu'au printemps et en été, certains jours seulement. Nos chauffeurs connaissent le calendrier d'ouverture et organisent votre visite en conséquence. Ils vous déposent à l'entrée du parc et vous attendent pendant votre promenade dans les jardins dessinés par Le Nôtre, incongrus et sublimes en pleine montagne auvergnate." },
      { title: "Lac de Servières contemplatif", desc: "Le lac de Servières est un lac de cratère d'altitude (1 200 m) accessible uniquement par une route étroite et sinueuse. Nos chauffeurs vous y conduisent en toute sécurité et patientent au parking pendant votre promenade (tour du lac en 1h). Ce lac préservé, interdit à la baignade, offre un silence et une beauté sauvage rares. Idéal pour les photographes et les amoureux de nature intacte." },
    ],
    whyUsEn: [
      { title: "Five Romanesque churches circuit", desc: "Orcival is the ideal starting point for the five major Romanesque churches circuit of Auvergne. Our drivers take you from Notre-Dame d'Orcival basilica to Saint-Nectaire, Issoire (Saint-Austremoine), Saint-Saturnin, and Notre-Dame-du-Port in Clermont-Ferrand. Full-day hire with stopping time at each site. A journey through eight centuries in sculpted volcanic stone." },
      { title: "Chateau de Cordes & gardens", desc: "The Chateau de Cordes, 1 km from the basilica, opens its doors only in spring and summer, on selected days only. Our drivers know the opening schedule and organise your visit accordingly. They drop you at the park entrance and wait during your stroll through the gardens designed by Le Notre, incongruous and sublime in the heart of the Auvergne mountains." },
      { title: "Contemplative Lac de Servieres", desc: "Lac de Servieres is a high-altitude crater lake (1,200 m) accessible only via a narrow, winding road. Our drivers take you there safely and wait in the car park during your walk (lake circuit approximately 1 hour). This preserved lake, where swimming is forbidden, offers rare silence and wild beauty. Perfect for photographers and lovers of untouched nature." },
    ],
  },
};
...
if (fblCity) {
  fblCity.i18n.fr.metaTitle = "Taxi Fontainebleau | Château, Forêt, Éditeur de calculateurs et de guides pratiques | Prix fixe 24h/24 | TaxiNeo";
  fblCity.i18n.fr.heroTitle = "Taxi à Fontainebleau";
  fblCity.i18n.en.metaTitle = "Taxi Fontainebleau | Palace, Forest, Éditeur de calculateurs et de guides pratiques | Fixed Price 24/7 | TaxiNeo";
