...
const cityContent: Record<string, { introFr: string; introEn: string; descriptionFr: string; descriptionEn: string; metaDescriptionFr: string; metaDescriptionEn: string; heroSubtitleFr: string; heroSubtitleEn: string; whyUsFr: { title: string; desc: string }[]; whyUsEn: { title: string; desc: string }[] }> = {
  paris: {
    ...
    metaDescriptionEn: "Taxi in Paris: flat-rate CDG from €56, Orly from €37. Book online 24/7, bus lane access, 20,000 licensed drivers. Reserve now.",
  ...
  marseille: {
    ...
    metaDescriptionFr: "Taxi à Marseille : transfert aéroport Provence, Vieux-Port, Calanques. Tarifs réglementés, chauffeurs locaux experts. Réservation immédiate 7j/7.",
    metaDescriptionEn: "Taxi in Marseille: Provence airport transfer, Vieux-Port, Calanques. Regulated fares, expert local drivers. Instant booking 7 days a week.",
  ...
  lyon: {
    ...
    metaDescriptionFr: "Taxi à Lyon : transfert Saint-Exupéry, Part-Dieu, Eurexpo. Prix fixe avant réservation, voies de bus, chauffeurs lyonnais. Réservez en 30 secondes.",
    metaDescriptionEn: "Taxi in Lyon: Saint-Exupéry transfer, Part-Dieu, Eurexpo. Fixed price before booking, bus lanes, Lyon drivers. Book in 30 seconds.",
  ...
  toulouse: {
    ...
    metaDescriptionFr: "Taxi à Toulouse : transfert aéroport Blagnac, Capitole, sites Airbus. Forfait garanti, chauffeurs disponibles 24h/24. Réservez votre course en ligne.",
    metaDescriptionEn: "Taxi in Toulouse: Blagnac airport transfer, Capitole, Airbus sites. Guaranteed flat rate, drivers available 24/7. Book your ride online.",
  ...
  nice: {
    ...
    metaDescriptionFr: "Taxi à Nice : transfert aéroport Côte d'Azur, Monaco, Cannes. Tarifs réglementés sans majoration estivale. Réservation en ligne, service 24h/24.",
    metaDescriptionEn: "Taxi in Nice: Côte d'Azur airport transfer, Monaco, Cannes. Regulated fares with no summer surcharge. Online booking, 24/7 service.",
  ...
  nantes: {
    ...
    metaDescriptionFr: "Taxi à Nantes : transfert aéroport Atlantique, gare TGV, Euronantes. Forfait compétitif, voies réservées tramway. Réservez votre taxi nantais.",
    metaDescriptionEn: "Taxi in Nantes: Atlantique airport transfer, TGV station, Euronantes. Competitive flat rate, tramway reserved lanes. Book your Nantes taxi.",
  ...
  montpellier: {
    ...
    metaDescriptionFr: "Taxi à Montpellier : aéroport Méditerranée, Écusson, plages de Palavas. Tarifs préfectoraux, chauffeurs disponibles 7j/7. Réservation instantanée.",
    metaDescriptionEn: "Taxi in Montpellier: Méditerranée airport, Écusson, Palavas beaches. Prefectural fares, drivers available 7/7. Instant booking.",
  ...
  strasbourg: {
    ...
    metaDescriptionFr: "Taxi à Strasbourg : aéroport Entzheim, Parlement européen, Petite France. Service trilingue FR/DE/EN, tarifs réglementés. Réservez en ligne.",
    metaDescriptionEn: "Taxi in Strasbourg: Entzheim airport, European Parliament, Petite France. Trilingual FR/DE/EN service, regulated fares. Book online.",
  ...
  bordeaux: {
    ...
    metaDescriptionFr: "Taxi à Bordeaux : gare Saint-Jean, aéroport Mérignac, Euratlantique. 2h04 de Paris en TGV. Tarifs réglementés, réservation 24h/24.",
    metaDescriptionEn: "Taxi in Bordeaux: Gare Saint-Jean, Mérignac airport, Euratlantique. 2h04 from Paris by TGV. Regulated fares, 24/7 booking.",
  ...
  lille: {
    ...
    metaDescriptionFr: "Taxi à Lille : gares Flandres et Europe, Eurostar, aéroport Lesquin. Forfait garanti 24h/24, même pendant la Braderie. Réservez maintenant.",
    metaDescriptionEn: "Taxi in Lille: Flandres & Europe stations, Eurostar, Lesquin airport. Guaranteed flat rate 24/7, even during the Braderie. Book now.",
  ...
  rennes: {
    ...
    metaDescriptionFr: "Taxi à Rennes : gare TGV, aéroport Saint-Jacques, technopole Atalante. 1h25 de Paris. Navettes campus et CHU. Réservez en ligne.",
    metaDescriptionEn: "Taxi in Rennes: TGV station, Saint-Jacques airport, Atalante tech park. 1h25 from Paris. Campus & hospital shuttles. Book online.",
  ...
  reims: {
    ...
    metaDescriptionFr: "Taxi à Reims : gare TGV Bezannes, cathédrale, caves de champagne. Forfait gare–centre compétitif. 45 min de Paris. Réservez maintenant.",
    metaDescriptionEn: "Taxi in Reims: Bezannes TGV station, cathedral, champagne cellars. Competitive station–centre flat rate. 45 min from Paris. Book now.",
  ...
  "saint-etienne": {
    ...
    metaDescriptionFr: "Taxi à Saint-Étienne : gare Châteaucreux, navette aéroport Lyon, Geoffroy-Guichard. Ville UNESCO du Design. Tarifs réglementés, réservation en ligne.",
    metaDescriptionEn: "Taxi in Saint-Étienne: Châteaucreux station, Lyon airport shuttle, Geoffroy-Guichard. UNESCO City of Design. Regulated fares, online booking.",
  ...
  "le-havre": {
    ...
    metaDescriptionFr: "Taxi au Havre : terminal croisières, ferry Angleterre, Étretat, Honfleur. Plus grand port de la Manche. Tarifs réglementés, réservation 7j/7.",
    metaDescriptionEn: "Taxi in Le Havre: cruise terminal, England ferry, Étretat, Honfleur. Largest Channel port. Regulated fares, booking 7 days a week.",
  ...
  toulon: {
    ...
    metaDescriptionFr: "Taxi à Toulon : aéroport Hyères, Arsenal, Porquerolles, Port-Cros. 1er port militaire de France. Service estival renforcé. Réservez en ligne.",
    metaDescriptionEn: "Taxi in Toulon: Hyères airport, Arsenal, Porquerolles, Port-Cros. France's main naval port. Enhanced summer service. Book online.",
  ...
  grenoble: {
    ...
    metaDescriptionFr: "Taxi à Grenoble : aéroport Isère, Alpe d'Huez, Deux Alpes, CHU. Véhicules équipés neige. Forfait aéroport disponible. Réservez 24h/24.",
    metaDescriptionEn: "Taxi in Grenoble: Isère airport, Alpe d'Huez, Deux Alpes, university hospital. Snow-equipped vehicles. Airport flat rate available. Book 24/7.",
  ...
  dijon: {
    ...
    metaDescriptionFr: "Taxi à Dijon : gare TGV, Cité de la Gastronomie, Route des Grands Crus. Capitale UNESCO de la Bourgogne. Tarifs réglementés. Réservez.",
    metaDescriptionEn: "Taxi in Dijon: TGV station, Cité de la Gastronomie, Route des Grands Crus. UNESCO Burgundy capital. Regulated fares. Book now.",
  ...
  angers: {
    ...
    metaDescriptionFr: "Taxi à Angers : gare Saint-Laud, aéroport Loire, CHU, châteaux de la Loire. 1h30 de Paris en TGV. Réservation en ligne instantanée.",
    metaDescriptionEn: "Taxi in Angers: Gare Saint-Laud, Loire airport, university hospital, Loire châteaux. 1h30 from Paris by TGV. Instant online booking.",
  ...
  nimes: {
    ...
    metaDescriptionFr: "Taxi à Nîmes : gare TGV Pont du Gard, Arènes, Maison Carrée. Transferts Pont du Gard et Cévennes. Tarifs réglementés. Réservez vite.",
    metaDescriptionEn: "Taxi in Nîmes: Pont du Gard TGV station, Arena, Maison Carrée. Pont du Gard & Cévennes transfers. Regulated fares. Book quickly.",
  ...
  villeurbanne: {
    ...
    metaDescriptionFr: "Taxi à Villeurbanne : campus La Doua, Part-Dieu, aéroport Saint-Exupéry. Même réseau que Lyon, tarifs réglementés. Réservation instantanée.",
    metaDescriptionEn: "Taxi in Villeurbanne: La Doua campus, Part-Dieu, Saint-Exupéry airport. Same network as Lyon, regulated fares. Instant booking.",
  ...
  "clermont-ferrand": {
    ...
    metaDescriptionFr: "Taxi à Clermont-Ferrand : aéroport Auvergne, Vulcania, Puy de Dôme. Berceau de Michelin, relief volcanique. Tarifs réglementés. Réservez.",
    metaDescriptionEn: "Taxi in Clermont-Ferrand: Auvergne airport, Vulcania, Puy de Dôme. Michelin's birthplace, volcanic terrain. Regulated fares. Book now.",
  ...
  "aix-en-provence": {
    ...
    metaDescriptionFr: "Taxi à Aix-en-Provence : gare TGV Arbois, aéroport Marseille-Provence, cours Mirabeau. Festival d'Aix en juillet. Réservez votre course.",
    metaDescriptionEn: "Taxi in Aix-en-Provence: Arbois TGV station, Marseille-Provence airport, Cours Mirabeau. Aix Festival in July. Book your ride.",
  ...
  "le-mans": {
    ...
    metaDescriptionFr: "Taxi au Mans : gare TGV, circuit 24 Heures, cité Plantagenêt. 54 min de Paris. Navettes circuit jour et nuit. Réservez maintenant.",
    metaDescriptionEn: "Taxi in Le Mans: TGV station, 24 Hours circuit, Plantagenêt city. 54 min from Paris. Circuit shuttles day & night. Book now.",
  ...
  brest: {
    ...
    metaDescriptionFr: "Taxi à Brest : aéroport Bretagne, port militaire, Océanopolis, presqu'île de Crozon. Pointe de la Bretagne. Réservation 7j/7.",
    metaDescriptionEn: "Taxi in Brest: Bretagne airport, naval port, Océanopolis, Crozon peninsula. Tip of Brittany. Booking 7 days a week.",
  ...
  tours: {
    ...
    metaDescriptionFr: "Taxi à Tours : gare TGV Saint-Pierre-des-Corps, Chenonceau, Chambord, Amboise. Circuits châteaux de la Loire. Tarifs réglementés. Réservez.",
    metaDescriptionEn: "Taxi in Tours: Saint-Pierre-des-Corps TGV station, Chenonceau, Chambord, Amboise. Loire château tours. Regulated fares. Book now.",
  ...
  amiens: {
    ...
    metaDescriptionFr: "Taxi à Amiens : gare SNCF, cathédrale UNESCO, baie de Somme. 1h10 de Paris. Navettes CHU et université. Réservation en ligne rapide.",
    metaDescriptionEn: "Taxi in Amiens: SNCF station, UNESCO cathedral, Somme Bay. 1h10 from Paris. Hospital & university shuttles. Quick online booking.",
  ...
  limoges: {
    ...
    metaDescriptionFr: "Taxi à Limoges : gare des Bénédictins, aéroport Bellegarde, CHU Dupuytren. Capitale de la porcelaine. Tarifs réglementés. Réservez en ligne.",
    metaDescriptionEn: "Taxi in Limoges: Bénédictins station, Bellegarde airport, Dupuytren hospital. Capital of porcelain. Regulated fares. Book online.",
  ...
  annecy: {
    ...
    metaDescriptionFr: "Taxi à Annecy : aéroport Genève, La Clusaz, Megève, lac d'Annecy. Venise des Alpes. Véhicules équipés neige. Réservez votre transfert.",
    metaDescriptionEn: "Taxi in Annecy: Geneva airport, La Clusaz, Megève, Lake Annecy. Venice of the Alps. Snow-equipped vehicles. Book your transfer.",
  ...
  perpignan: {
    ...
    metaDescriptionFr: "Taxi à Perpignan : gare TGV, aéroport Rivesaltes, Collioure, frontière espagnole. Capitale du Roussillon. Service bilingue. Réservez vite.",
    metaDescriptionEn: "Taxi in Perpignan: TGV station, Rivesaltes airport, Collioure, Spanish border. Capital of Roussillon. Bilingual service. Book quickly.",
  ...
  besancon: {
    ...
    metaDescriptionFr: "Taxi à Besançon : gare TGV Franche-Comté, Citadelle Vauban UNESCO, Métabief. Capitale de l'horlogerie. Tarifs réglementés. Réservez.",
    metaDescriptionEn: "Taxi in Besançon: Franche-Comté TGV station, Vauban Citadel UNESCO, Métabief. Watchmaking capital. Regulated fares. Book now.",
  ...
  metz: {
    ...
    metaDescriptionFr: "Taxi à Metz : gare TGV, Centre Pompidou-Metz, aéroport Lorraine, Luxembourg. Carrefour franco-luxembourgeois. Réservation en ligne 24h/24.",
    metaDescriptionEn: "Taxi in Metz: TGV station, Centre Pompidou-Metz, Lorraine airport, Luxembourg. Franco-Luxembourgish crossroads. Online booking 24/7.",
  ...
  orleans: {
    ...
    metaDescriptionFr: "Taxi à Orléans : gare des Aubrais, cathédrale, Chambord, Cheverny. Cité johannique, 1h10 de Paris. Tarifs réglementés. Réservez en ligne.",
    metaDescriptionEn: "Taxi in Orléans: Les Aubrais station, cathedral, Chambord, Cheverny. Joan of Arc's city, 1h10 from Paris. Regulated fares. Book online.",
  ...
  rouen: {
    ...
    metaDescriptionFr: "Taxi à Rouen : gare Rive-Droite, port maritime, plages normandes. Capitale de la Normandie, 1h15 de Paris. Réservation immédiate.",
    metaDescriptionEn: "Taxi in Rouen: Rive-Droite station, maritime port, Normandy beaches. Capital of Normandy, 1h15 from Paris. Instant booking.",
  ...
  mulhouse: {
    ...
    metaDescriptionFr: "Taxi à Mulhouse : EuroAirport Bâle-Mulhouse, Cité de l'Automobile, Cité du Train. Triangle trinational. Service multilingue. Réservez.",
    metaDescriptionEn: "Taxi in Mulhouse: EuroAirport Basel-Mulhouse, Cité de l'Automobile, Cité du Train. Trinational triangle. Multilingual service. Book now.",
  ...
  caen: {
    ...
    metaDescriptionFr: "Taxi à Caen : gare SNCF, ferry Ouistreham, Mémorial, plages du Débarquement. Capitale normande. Service en anglais. Réservez maintenant.",
    metaDescriptionEn: "Taxi in Caen: SNCF station, Ouistreham ferry, Memorial, D-Day beaches. Normandy's capital. English-speaking service. Book now.",
  ...
  nancy: {
    ...
    metaDescriptionFr: "Taxi à Nancy : gare TGV, Place Stanislas UNESCO, campus ARTEM, aéroport Lorraine. Joyau Art Nouveau, 1h30 de Paris. Réservez en ligne.",
    metaDescriptionEn: "Taxi in Nancy: TGV station, Place Stanislas UNESCO, ARTEM campus, Lorraine airport. Art Nouveau gem, 1h30 from Paris. Book online.",
  ...
  argenteuil: {
    ...
    metaDescriptionFr: "Taxi à Argenteuil : gare, La Défense, CDG, Orly. 3e commune d'Île-de-France, 15 min de Saint-Lazare. Tarifs franciliens réglementés. Réservez.",
    metaDescriptionEn: "Taxi in Argenteuil: station, La Défense, CDG, Orly. 3rd largest Île-de-France commune, 15 min from Saint-Lazare. Regulated fares. Book now.",
  ...
  avignon: {
    ...
    metaDescriptionFr: "Taxi à Avignon : gare TGV Courtine, Palais des Papes, Festival d'Avignon, Luberon. Cité des Papes. Service jour et nuit. Réservez.",
    metaDescriptionEn: "Taxi in Avignon: Courtine TGV station, Palais des Papes, Avignon Festival, Luberon. City of the Popes. Day & night service. Book now.",
  ...
  poitiers: {
    ...
    metaDescriptionFr: "Taxi à Poitiers : gare TGV, Futuroscope, CHU, Marais Poitevin. 2 millions de visiteurs/an au Futuroscope. Tarifs réglementés. Réservez.",
    metaDescriptionEn: "Taxi in Poitiers: TGV station, Futuroscope, university hospital, Marais Poitevin. 2M visitors/year at Futuroscope. Regulated fares. Book now.",
  ...
  dunkerque: {
    ...
    metaDescriptionFr: "Taxi à Dunkerque : port ferry Douvres, Malo-les-Bains, frontière belge. 3e port de France. Service bilingue FR/EN. Réservation immédiate.",
    metaDescriptionEn: "Taxi in Dunkirk: Dover ferry port, Malo-les-Bains, Belgian border. France's 3rd largest port. Bilingual FR/EN service. Instant booking.",
  ...
  versailles: {
    ...
    metaDescriptionFr: "Taxi à Versailles : Château, Trianon, gares Chantiers et Rive-Gauche. 15 millions de visiteurs/an. Forfait Paris–Versailles. Réservez.",
    metaDescriptionEn: "Taxi in Versailles: Palace, Trianon, Chantiers & Rive-Gauche stations. 15M visitors/year. Paris–Versailles flat rate. Book now.",
  ...
  pau: {
    ...
    metaDescriptionFr: "Taxi à Pau : aéroport Pyrénées, Gourette, Boulevard des Pyrénées, circuit auto. Capitale du Béarn. Véhicules équipés montagne. Réservez.",
    metaDescriptionEn: "Taxi in Pau: Pyrénées airport, Gourette, Boulevard des Pyrénées, racing circuit. Capital of Béarn. Mountain-equipped vehicles. Book now.",
  ...
  "la-rochelle": {
    ...
    metaDescriptionFr: "Taxi à La Rochelle : gare SNCF, aéroport, île de Ré, Vieux-Port. Perle de l'Atlantique. Service estival renforcé. Réservez en ligne.",
    metaDescriptionEn: "Taxi in La Rochelle: SNCF station, airport, Île de Ré, Vieux-Port. Pearl of the Atlantic. Enhanced summer service. Book online.",
  ...
  calais: {
    ...
    metaDescriptionFr: "Taxi à Calais : Eurostar Fréthun, terminal ferry, tunnel sous la Manche, Côte d'Opale. Porte de l'Europe. Service bilingue FR/EN. Réservez.",
    metaDescriptionEn: "Taxi in Calais: Eurostar Fréthun, ferry terminal, Channel Tunnel, Opal Coast. Gateway to Europe. Bilingual FR/EN service. Book now.",
  ...
  cannes: {
    ...
    metaDescriptionFr: "Taxi à Cannes : aéroport Nice, Palais des Festivals, Croisette, îles de Lérins. Tarifs réglementés même pendant le Festival. Réservez.",
    metaDescriptionEn: "Taxi in Cannes: Nice airport, Palais des Festivals, Croisette, Lérins Islands. Regulated fares even during the Festival. Book now.",
  ...
  antibes: {
    ...
    metaDescriptionFr: "Taxi à Antibes : aéroport Nice, Port Vauban, Cap d'Antibes, Juan-les-Pins. Plus grand port de plaisance d'Europe. Tarifs réglementés. Réservez.",
    metaDescriptionEn: "Taxi in Antibes: Nice airport, Port Vauban, Cap d'Antibes, Juan-les-Pins. Europe's largest marina. Regulated fares. Book now.",
  ...
  colmar: {
    ...
    metaDescriptionFr: "Taxi à Colmar : gare SNCF, EuroAirport, Route des Vins, marchés de Noël. Petite Venise alsacienne. Circuits vignobles. Réservez maintenant.",
    metaDescriptionEn: "Taxi in Colmar: SNCF station, EuroAirport, Wine Route, Christmas markets. Alsatian Petite Venise. Vineyard tours. Book now.",
  ...
  bayonne: {
    ...
    metaDescriptionFr: "Taxi à Bayonne : gare TGV, aéroport Biarritz, Biarritz, Saint-Jean-de-Luz, frontière espagnole. Capitale basque. Réservation 7j/7.",
    metaDescriptionEn: "Taxi in Bayonne: TGV station, Biarritz airport, Biarritz, Saint-Jean-de-Luz, Spanish border. Basque capital. Booking 7/7.",
  ...
  chambery: {
    ...
    metaDescriptionFr: "Taxi à Chambéry : aéroport Savoie, Courchevel, Méribel, Val Thorens, lac du Bourget. Porte des Alpes. 4x4 équipés neige. Réservez.",
    metaDescriptionEn: "Taxi in Chambéry: Savoie airport, Courchevel, Méribel, Val Thorens, Lac du Bourget. Gateway to the Alps. Snow-equipped 4x4s. Book now.",
  ...
  valence: {
    ...
    metaDescriptionFr: "Taxi à Valence : gare TGV, Montélimar, Vercors, Drôme provençale. Mi-chemin Paris–Marseille. Transfert gare–centre dès 20 €. Réservez.",
    metaDescriptionEn: "Taxi in Valence: TGV station, Montélimar, Vercors, Drôme Provençale. Halfway Paris–Marseille. Station–centre transfer from €20. Book now.",
