...
const t = {
  fr: {
    ...
    confirmTitle: "Demande de réservation en attente de confirmation",
    confirmBody: "Votre demande de réservation a bien été enregistrée. Elle doit maintenant être confirmée par un de nos chauffeurs à proximité. Vous recevrez un email de confirmation dès qu'un chauffeur aura accepté votre course.<br/><br/><strong style=\"color: #b45309;\">Important : tant que vous n'avez pas reçu un email de confirmation ou que vous n'êtes pas contacté(e) par notre chauffeur, votre réservation n'est pas confirmée.</strong>",
    confirmContact: "Votre demande est en cours de traitement. Un chauffeur à proximité vous contactera sous peu pour confirmer la course.",
    confirmYourDriver: "Chauffeur à proximité",
    confirmDriverMsg: "Ce chauffeur a reçu votre demande et reviendra vers vous rapidement. N'hésitez pas à le contacter pour toute question.",
  ...
  en: {
    ...
    confirmTitle: "Booking request awaiting confirmation",
    confirmBody: "Your booking request has been registered. It must now be confirmed by one of our nearby drivers. You will receive a confirmation email as soon as a driver accepts your ride.<br/><br/><strong style=\"color: #b45309;\">Important: until you receive a confirmation email or are contacted by our driver, your booking is not confirmed.</strong>",
    confirmContact: "Your request is being processed. A nearby driver will contact you shortly to confirm the ride.",
    confirmYourDriver: "Nearby driver",
    confirmDriverMsg: "This driver has received your request and will get back to you shortly. Feel free to contact them for any questions.",
