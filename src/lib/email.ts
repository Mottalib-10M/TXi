...
const t = {
  fr: {
    ...
    confirmBody: "Votre demande de réservation a bien été enregistrée. Elle doit maintenant être confirmée par un de nos chauffeurs à proximité. Vous recevrez un email de confirmation dès qu'un chauffeur aura accepté votre course.",
  ...
  en: {
    ...
    confirmBody: "Your booking request has been registered. It must now be confirmed by one of our nearby drivers. You will receive a confirmation email as soon as a driver accepts your ride.",
