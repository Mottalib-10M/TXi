...
const sujets = [
  ...
  { value: "aide", label: "Aide & support" },
  { value: "partenariat", label: "Partenariat chauffeur" },
...
const cards = [
  {
    ...
    desc: "Découvrez TaxiNoir Business en action avec une démonstration personnalisée.",
    sujet: "demo",
  },
  {
    icon: "solar:steering-wheel-linear",
    title: "Devenir chauffeur partenaire",
    desc: "Rejoignez notre réseau de chauffeurs professionnels et développez votre activité.",
    sujet: "partenariat",
  },
  {
    icon: "solar:chat-round-dots-linear",
    title: "Aide & support",
    desc: "Une question sur votre réservation ou votre compte ? Notre équipe vous répond.",
    sujet: "aide",
  },
];
...
const faqItems = [
  {
    q: "Comment s'inscrire en tant que chauffeur ?",
    a: "Rendez-vous sur notre page d'inscription, remplissez le formulaire avec vos informations professionnelles (carte professionnelle, assurance, véhicule) et notre équipe validera votre profil sous 48h.",
  },
  {
    q: "Comment sont calculés les tarifs ?",
    a: "Les tarifs sont basés sur la réglementation préfectorale en vigueur. Ils incluent la prise en charge, le prix au kilomètre et éventuellement les suppléments réglementaires (nuit, bagages, etc.).",
  },
  {
    q: "Comment annuler une réservation ?",
    a: "Vous pouvez annuler gratuitement jusqu'à 30 minutes avant l'heure prévue de prise en charge, directement depuis votre espace client ou en contactant notre support.",
  },
  {
    q: "Quel est le délai de réponse du support ?",
    a: "Notre équipe répond généralement sous 24h en jours ouvrés. Pour les urgences liées à une course en cours, utilisez le chat dans l'application pour une assistance immédiate.",
  },
];
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-neutral-500 font-light max-w-lg mx-auto">
              Choisissez un sujet ci-dessous ou remplissez directement le formulaire de contact.
            </p>
          </div>
            ...
            {success ? (
              <div className="max-w-xl mx-auto text-center py-16">
                ...
                <p className="text-sm text-neutral-500 font-light">
                  Nous avons bien reçu votre demande et vous recontacterons dans les plus brefs
                  délais.
                </p>
              </div>
            ) : (
