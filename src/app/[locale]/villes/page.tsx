  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24 pb-16">
        ...
        {/* SEO Content Block 3 - Types de courses */}
        <section className="py-16 md:py-20">
          <div className="max-w-7xl mx-auto px-6">
        ...
        <section className="bg-neutral-50 border-t border-b border-neutral-100 py-20 md:py-28">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              {[
                { step: "1", icon: "solar:map-point-linear", title: t("step1Title"), desc: t("step1Desc") },
                { step: "2", icon: "solar:route-linear", title: t("step2Title"), desc: t("step2Desc") },
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                { icon: "solar:clock-circle-linear", title: t("adv3Title"), desc: t("adv3Desc") },
                { icon: "solar:smartphone-linear", title: t("adv4Title"), desc: t("adv4Desc") },
              ].map((item, i) => (
                <div
                  key={item.title}
