...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t("metaTitle"),
      description: t("metaDescription"),
      url: `https://www.taxineo.fr/${locale}/solutions/mise-a-disposition`,
      siteName: "TaxiNeo",
      type: "website",
      images: [{ url: "https://www.taxineo.fr/opengraph-image", width: 1200, height: 630, alt: t("metaTitle") }],
    },
    alternates: {
      canonical: `https://www.taxineo.fr/${locale}/solutions/mise-a-disposition`,
      languages: {
        fr: "https://www.taxineo.fr/fr/solutions/mise-a-disposition",
        en: "https://www.taxineo.fr/en/solutions/mise-a-disposition",
      },
    },
  };
}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            {madCities.map((m) => {
              ...
              return (
                <Link
                  key={m.citySlug}
                  href={`/mise-a-disposition/${m.citySlug}`}
