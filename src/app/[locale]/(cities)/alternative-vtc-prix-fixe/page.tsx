...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "alternativeVtc" });
  ...
  return {
    ...
    openGraph: {
      title: t("metaTitle"),
      description: t("metaDescription"),
      url: `https://www.taxineo.fr/${locale}/alternative-vtc-prix-fixe`,
      siteName: "TaxiNeo",
      type: "article",
      images: [{ url: "https://www.taxineo.fr/opengraph-image", width: 1200, height: 630, alt: t("metaTitle") }],
    },
    alternates: {
      canonical: canonicalUrl(locale, "/alternative-vtc-prix-fixe"),
      languages: alternateUrls("/alternative-vtc-prix-fixe"),
    },
  };
}
...
export default async function AlternativeVtcPage() {
  const t = await getTranslations("alternativeVtc");
