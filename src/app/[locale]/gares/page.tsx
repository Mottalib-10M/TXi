  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          <nav className="text-sm text-neutral-500 font-light mb-6">
            <ol className="flex items-center gap-1.5">
              ...
              <li className="text-neutral-900 font-medium">{t("breadcrumbStation")}</li>
            </ol>
          </nav>
        ...
        {/* SEO Content Block 2 - Taxi vs VTC */}
        <section className="bg-neutral-50 border-t border-b border-neutral-100 py-16 md:py-20">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {[
                { icon: "solar:tag-price-linear", text: t("seoText2a") },
                { icon: "solar:map-point-wave-linear", text: t("seoText2b") },
                { icon: "solar:road-linear", text: t("seoText2c") },
                { icon: "solar:shield-check-linear", text: t("seoText2d") },
              ].map((item, i) => (
                <div
                  key={i}
        ...
        <section className="py-20 md:py-28">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              {[
                { step: "1", icon: "mdi:train", title: t("step1Title"), desc: t("step1Desc") },
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                { icon: "solar:map-point-wave-linear", title: t("adv4Title"), desc: t("adv4Desc") },
              ].map((item, i) => (
                <div
                  key={item.title}
