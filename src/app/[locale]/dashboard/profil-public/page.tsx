    ...
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white border border-neutral-200 rounded-2xl p-5">
          ...
          <h3 className="text-sm font-medium mb-1">{t("addPhoto")}</h3>
        ...
        <div className="bg-white border border-neutral-200 rounded-2xl p-5">
          ...
          <h3 className="text-sm font-medium mb-1">{t("writeBio")}</h3>
          <p className="text-xs text-neutral-500 font-light leading-relaxed">
            {t("writeBioDesc")}
          </p>
        </div>
        <div className="bg-white border border-neutral-200 rounded-2xl p-5">
          ...
          <h3 className="text-sm font-medium mb-1">{t("preciseHours")}</h3>
          <p className="text-xs text-neutral-500 font-light leading-relaxed">
            {t("preciseHoursDesc")}
          </p>
        </div>
