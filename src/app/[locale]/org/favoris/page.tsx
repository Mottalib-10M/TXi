  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-8">
        ...
        <p className="text-sm text-neutral-500 mt-1">{t("favoritesSubtitle")}</p>
      </div>

      {/* Search */}
      <div className="bg-white rounded-2xl border border-neutral-200 p-5 mb-6">
        <h2 className="font-medium mb-3">{t("addDriver")}</h2>
      ...
      <div className="bg-white rounded-2xl border border-neutral-200">
        <div className="p-5 border-b border-neutral-100">
          <h2 className="font-medium">{t("yourFavorites", { count: favorites.length })}</h2>
        </div>
        {favorites.length === 0 ? (
