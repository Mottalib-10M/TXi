...
import type { MadTestimonial } from "@/data/mad-content-templates";
import { getTranslations } from "next-intl/server";

export async function MadTestimonials({ testimonials, cityName }: { testimonials: MadTestimonial[]; cityName: string }) {
