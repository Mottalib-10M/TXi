...
export async function MadBreadcrumb({ cityName }: { cityName: string }) {
    ...
    <>
      <BreadcrumbJsonLd
        crumbs={[
          ...
          { name: t("breadcrumbMad"), item: "https://www.taxineo.fr/solutions/mise-a-disposition" },
      ...
      <nav className="text-sm text-neutral-500 font-light mb-6" aria-label={t("breadcrumbLabel")}>
        <ol className="flex items-center gap-1.5 flex-wrap">
          ...
          <li>
            <Link href="/solutions/mise-a-disposition" className="hover:text-neutral-900 transition-colors">{t("breadcrumbMad")}</Link>
          </li>
          <li aria-hidden="true">/</li>
