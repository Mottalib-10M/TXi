...
export async function ArComparison({ content, autorouteName }: { content: ArGeneratedContent; autorouteName: string }) {
    ...
    <section className="py-20 md:py-28">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16 fade-up">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">{t("comparisonTitle", { autorouteName })}</h2>
        </div>
