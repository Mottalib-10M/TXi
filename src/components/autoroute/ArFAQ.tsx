...
import type { ArFAQ as ArFAQType } from "@/data/autoroute-content-templates";

export function ArFAQ({ autorouteName, faq }: { autorouteName: string; faq: ArFAQType[] }) {
