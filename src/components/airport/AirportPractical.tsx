...
export function AirportPractical({ airport }: { airport: Airport }) {
  return (
            ...
            <div className="bg-neutral-950 rounded-3xl p-8 relative overflow-hidden">
              ...
              <div className="relative space-y-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs text-neutral-500 font-light">{airport.iata}</span>
                </div>
                <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-3 h-3 bg-green-500 rounded-full" />
                    <div>
                      <p className="text-xs text-neutral-500">Vol détecté</p>
                      <p className="text-sm text-white font-medium">Atterrissage dans 15 min</p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4">
                    ...
                    <p className="text-xl font-semibold text-white mt-1">{airport.transferPrice}</p>
                  </div>
                  <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4">
                    <p className="text-xs text-neutral-500">Temps</p>
                    <p className="text-xl font-semibold text-white mt-1">{airport.transferTime}</p>
                  </div>
                </div>
              </div>
            </div>
