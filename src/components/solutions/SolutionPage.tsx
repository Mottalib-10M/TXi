        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="md:max-w-xl fade-up">
              ...
              <Link
                href={`/inscription?type=${signupType}`}
              ...
              <div className="bg-white border border-neutral-200 rounded-3xl p-6 shadow-xl shadow-black/5 max-w-sm mx-auto">
                <div className="flex items-center gap-4 mb-5">
                  <div className="w-14 h-14 rounded-full bg-neutral-100 flex items-center justify-center">
                    <Icon icon={icon} className="text-neutral-400 text-2xl" />
                  </div>
                  <div>
                ...
                <div className="space-y-3 mb-5">
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="text-neutral-600 font-light">{t("mockupDestination")}</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm">
                    <Icon icon="solar:clock-circle-linear" className="text-neutral-400" />
                    <span className="text-neutral-600 font-light">{t("mockupTime")}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 text-sm bg-neutral-50 rounded-lg px-3 py-2">
                  ...
                  <span className="text-neutral-600 font-light">{t("mockupDriver")}</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="relative space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4">
                      ...
                      <p className="text-xl font-semibold text-white mt-1">4 850 &euro;</p>
