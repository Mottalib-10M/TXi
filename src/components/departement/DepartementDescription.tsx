...
export async function DepartementDescription({ dept }: { dept: Departement }) {
  ...
  const advantages = [
    ...
    { icon: "solar:map-linear", title: t("advCoverage"), desc: t("advCoverageDesc", { name: dept.name }) },
